defmodule CA.Mitre do
  ...
  Resource Development (Розробка ресурсів)
  Initial Access (Початковий доступ)
  Execution (Виконання)
  Persistence (Закріплення)
  Privilege Escalation (Підвищення привілеїв)
  Defense Evasion (Обхід захисту)
  Credential Access (Доступ до облікових даних)
  Discovery (Розвідка в мережі)
  Lateral Movement (Бічне переміщення)
  Collection (Збір даних)
  Command and Control (Управління та контроль)
  Exfiltration (Ексфільтрація)
  Impact (Вплив - наприклад, Ransomware)
  ...
  def enterprise_matrix do
    %{
      reconnaissance: %{
        ...
        techniques: [
          ...
          %{
            ...
            desc: "Збір даних про співробітників (імена, email)."
          },
      ...
      resource_development: %{
        ...
        desc:
          "Створення, купівля або крадіжка ресурсів, необхідних для атаки (домени, інфраструктура).",
        techniques: [
          %{id: "T1583", name: "Acquire Infrastructure", desc: "Оренда VPS, реєстрація доменів."},
          %{
            id: "T1588",
            name: "Obtain Capabilities",
            desc: "Придбання експлойтів, малварі або сертифікатів."
          },
          %{
            id: "T1608",
            name: "Stage Capabilities",
            desc: "Розміщення шкідливого ПЗ на ресурсах (Watering Hole)."
          }
        ]
      },
      initial_access: %{
        ...
        techniques: [
          ...
          %{
            ...
            desc: "Експлуатація вразливостей публічних сервісів."
          },
          %{id: "T1566", name: "Phishing", desc: "Фішинг (Spear Phishing, Attachment, Link)."},
          %{
            id: "T1078",
            name: "Valid Accounts",
            desc: "Використання дійсних облікових записів (в т.ч. дефолтних)."
          }
        ]
      },
      execution: %{
        ...
        techniques: [
          %{
            ...
            desc: "PowerShell, Bash, CMD, Python, AppleScript."
          },
          %{
            id: "T1203",
            name: "Exploitation for Client Execution",
            desc: "Експлуатація клієнтського ПЗ (Office, Browser)."
          },
          %{
            id: "T1053",
            name: "Scheduled Task/Job",
            desc: "Використання Cron або Windows Task Scheduler."
          },
      ...
      persistence: %{
        ...
        techniques: [
          %{
            ...
            desc: "Ключі реєстру Run/RunOnce, Startup папки."
          },
          %{
            id: "T1543",
            name: "Create or Modify System Process",
            desc: "Створення системних служб (Services, Daemons)."
          },
          %{
            id: "T1546",
            name: "Event Triggered Execution",
            desc: "WMI Event Subscriptions, IFEO."
          },
          %{
            id: "T1505",
            name: "Server Software Component",
            desc: "Встановлення веб-шеллів (Web Shell)."
          }
        ]
      },
      privilege_escalation: %{
        ...
        techniques: [
          %{
            ...
            desc: "Обхід UAC, SUID/SGID, sudo caching."
          },
          %{
            id: "T1134",
            name: "Access Token Manipulation",
            desc: "Маніпуляція маркерами (Token Stealing)."
          },
          %{
            id: "T1068",
            name: "Exploitation for Privilege Escalation",
            desc: "Експлуатація вразливостей ОС або ядра."
          },
      ...
      defense_evasion: %{
        ...
        techniques: [
          %{
            ...
            desc: "Деобфускація коду під час виконання."
          },
          %{
            id: "T1070",
            name: "Indicator Removal on Host",
            desc: "Очищення журналів (Event Logs), видалення файлів."
          },
          %{
            id: "T1036",
            name: "Masquerading",
            desc: "Маскування під легітимні системні процеси (напр., svchost.exe)."
          },
          %{
            id: "T1055",
            name: "Process Injection",
            desc: "Ін'єкція коду у легітимні процеси (DLL Injection, Process Hollowing)."
          },
          %{
            id: "T1218",
            name: "System Binary Proxy Execution",
            desc: "Використання LOLBins (rundll32.exe, mshta.exe)."
          }
        ]
      },
      credential_access: %{
        ...
        techniques: [
          %{
            id: "T1110",
            name: "Brute Force",
            desc: "Перебір паролів (Credential Stuffing, Password Spraying)."
          },
          %{
            id: "T1003",
            name: "OS Credential Dumping",
            desc: "Екстракція з LSASS, SAM, /etc/shadow."
          },
          %{
            id: "T1558",
            name: "Steal or Forge Kerberos Tickets",
            desc: "Golden/Silver Ticket, Kerberoasting."
          },
      ...
      discovery: %{
        ...
        techniques: [
          %{
            ...
            desc: "Збір списків локальних або доменних користувачів."
          },
          %{
            id: "T1046",
            name: "Network Service Scanning",
            desc: "Сканування відкритих портів у внутрішній мережі."
          },
          %{
            id: "T1082",
            name: "System Information Discovery",
            desc: "Отримання даних про версію ОС, архітектуру."
          },
          %{
            id: "T1016",
            name: "System Network Configuration Discovery",
            desc: "Збір даних про IP, маршрутизацію, DNS."
          }
        ]
      },
      lateral_movement: %{
        ...
        techniques: [
          %{
            ...
            desc: "Експлуатація вразливостей у віддалених сервісах (SMB, RDP)."
          },
          %{
            id: "T1550",
          ...
          %{
            ...
            desc: "Використання легітимних RDP, SSH, VNC, WinRM."
          }
        ]
      },
      collection: %{
        ...
        techniques: [
          %{
            ...
            desc: "Архівація та шифрування даних перед викраденням."
          },
          %{
            id: "T1119",
            name: "Automated Collection",
            desc: "Автоматизований пошук файлів за розширеннями."
          },
          %{
            id: "T1114",
            name: "Email Collection",
            desc: "Збір електронних листів з локальних клієнтів або Exchange сервісу."
          },
      ...
      command_and_control: %{
        ...
        techniques: [
          %{
            ...
            desc: "Комунікація через веб-протоколи (HTTP/HTTPS, DNS)."
          },
          %{
            id: "T1573",
            name: "Encrypted Channel",
            desc: "Шифрування трафіку C2 для уникнення IDS."
          },
          %{
            id: "T1090",
            name: "Proxy",
            desc: "Використання проксі-серверів для приховування IP."
          },
          %{
            id: "T1105",
            name: "Ingress Tool Transfer",
            desc: "Завантаження додаткових інструментів з C2 сервера."
          }
        ]
      },
      exfiltration: %{
        ...
        techniques: [
          %{
            ...
            desc: "Передача даних через існуючий канал управління."
          },
          %{
            id: "T1567",
            name: "Exfiltration Over Web Service",
            desc: "Вивантаження даних у хмарні сховища (Google Drive, Dropbox)."
          },
          %{
            id: "T1048",
            name: "Exfiltration Over Alternative Protocol",
            desc: "Використання інших протоколів (ICMP, DNS tunneling)."
          }
        ]
      },
      impact: %{
        ...
        techniques: [
          %{
            ...
            desc: "Незворотне видалення або затирання даних."
          },
          %{
            id: "T1486",
            name: "Data Encrypted for Impact",
            desc: "Шифрування файлів для вимагання викупу (Ransomware)."
          },
          %{
            id: "T1490",
            name: "Inhibit System Recovery",
            desc: "Видалення тіньових копій (vssadmin), вимкнення відновлення."
          },
          %{
            id: "T1498",
            name: "Network Denial of Service",
            desc: "DDoS атаки для виведення систем з ладу."
          }
        ]
      }
    }
