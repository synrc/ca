defmodule CA.L1.Base97 do
  def groups do
    [
      ...
      {
        "АУДИТ ВИКОРИСТАННЯ ПРИВІЛЕЙОВАНИХ ФУНКЦІЙ (AC-6(9)) (AC-6)",
        [
      ...
      {
        "АВТОРИЗОВАНЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ – БІЛИЙ СПИСОК (CM-7(5)) (CM-7)",
        [
        CA.SPE.oid(:"id-spe-cm-7-5")
        ]
      },
      {
        "ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ (CM-8)",
        [
      ...
      {
        "РОЗТАШУВАННЯ ІНФОРМАЦІЇ (CM-12)",
        [
        CA.SPE.oid(:"id-spe-cm-12")
        ]
      },
      {
        "КОНФІГУРАЦІЯ СИСТЕМ ТА КОМПОНЕНТІВ ДЛЯ СФЕР З ВИСОКИМ РИЗИКОМ (CM-2(7)) (CM-2)",
        [
      ...
      {
        "УПРАВЛІННЯ ТА ЗБЕРЕЖЕННЯ ІНФОРМАЦІЇ (SI-12)",
        [
      ...
      {
        "ПРАВИЛА ПОВЕДІНКИ (PL-4)",
        [
        CA.SPE.oid(:"id-spe-pl-4")
        ]
      },
      {:category, "ПРИДБАННЯ СИСТЕМ ТА ПОСЛУГ (SA)"},
      {
        "БЕЗПЕКА ТА ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ (SA-8)",
        [
        CA.SPE.oid(:"id-spe-sa-8")
        ]
      },
      {
        "КОМПОНЕНТИ СИСТЕМИ, ЩО НЕ ПІДТРИМУЮТЬСЯ (SA-22)",
        [
        CA.SPE.oid(:"id-spe-sa-22")
        ]
      },
      {
        "ЗОВНІШНІ ПОСЛУГИ ДЛЯ СИСТЕМИ (SA-9)",
        [
        CA.SPE.oid(:"id-spe-sa-9")
        ]
      },
      {:category, "УПРАВЛІННЯ РИЗИКАМИ В ЛАНЦЮГУ ПОСТАЧАННЯ (SR)"},
      {
        "ПЛАН УПРАВЛІННЯ РИЗИКАМИ ЛАНЦЮГА ПОСТАЧАННЯ (SR-2)",
        [
        CA.SPE.oid(:"id-spe-sr-2")
        ]
      },
      {
        "СТРАТЕГІЇ ПРИДБАННЯ, ІНСТРУМЕНТИ І МЕТОДИ (SR-5)",
        [
        CA.SPE.oid(:"id-spe-sr-5")
        ]
      },
      {
        "КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ (SR-3)",
        [
