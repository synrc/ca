defmodule CA.L3.Supreme do
  @moduledoc """
  Level 3: CA.L3.Supreme Security Profile
  """
  ...
  def system_name, do: "Верховний Суд"
  ...
  %{
    ...
    subcontrols: [
      %{
        id: "CP-2",
        name: "ПЛАН ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ (CP-2)",
        text: "",
        parameters: [
          {:cp_2_a_01,
      ...
      %{
        id: "CP-10",
        name: "ВІДНОВЛЕННЯ ТА ВІДТВОРЕННЯ СИСТЕМИ (CP-10)",
        text: "KVS забезпечує механізми швидкого відновлення з резервних копій (`kvs:restore/1`), дозволяючи адміністраторам відновити працездатність вузла з гарантією логічної цілісності журналу транзакцій.",
  ...
  %{
    ...
    subcontrols: [
      ...
      %{
        id: "SC-6",
        name: "ДОСТУПНІСТЬ РЕСУРСІВ (SC-6)",
        text: "Забезпечити захист доступності ресурсів, виділивши [Призначення: визначені організацією ресурси], по [Вибір (один або кілька); пріоритет; квоти; [Призначення: визначені організацією заходи з безпеки]].",
        parameters: [
          {:sc_6_01,
