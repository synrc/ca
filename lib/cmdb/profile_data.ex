...
""",
  ...
  def spec(:"id-spe-ac-6-3") do
    %{
      ...
      parameters: [
        {:ac_6_3_odp_01,
         "Визначено привілейовані команди для яких дозволяється мережевий доступ",
         [type: :string, default: nil]},
        {:ac_6_3_odp_02,
  ...
  def spec(:"id-spe-ac-20-4") do
    %{
      ...
      parameters: [
        {:ac_20_4_odp,
         "Визначано мережеві носії інформації , які можуть мати доступ до мережі",
         [type: :string, default: nil]},
        {:ac_20_4_01,
  ...
  def spec(:"id-spe-at-1") do
    %{
      ...
      parameters: [
        ...
        {:at_1_odp_03,
         "Вибрано одне або декілька з наступних ЗНАЧЕНЬ ПАРАМЕТРІВ: {рівень організації; рівень місії/бізнес-процесу; рівень системи}",
         [type: :list, default: ["рівень організації", "рівень місії/бізнес-процесу", "рівень системи"]]},
        {:at_1_odp_04,
        ...
        {:at_1_a_03,
         ...
         [type: :string, default: nil]},
        {:at_1_a_04,
         "Процедури поширюються на <AT-01_ODP[02] персонал або ролі>",
         [type: :string, default: nil]},
        {:at_1_a_01_a_01,
    ...
    %{
      ...
      parameters: [
        ...
        {:at_3_a_02_02,
         ...
         [type: :string, default: nil]},
        {:at_3_b_01,
         "Оновлюється вміст навчання на основі ролей з <AT-03_ODP[04] частотою>",
         [type: :string, default: nil]},
        {:at_3_b_02,
         "Оновлюється вміст навчання на основі ролей після <AT-03_ODP[05] подій>",
         [type: :string, default: nil]},
        {:at_3_c,
...
""",
  ...
  def spec(:"id-spe-sa-5-1") do
    %{
      ...
      title: "СИСТЕМНА ДОКУМЕНТАЦІЯ - ФУНКЦІОНАЛЬНІ ВЛАСТИВОСТІ ЗАХОДІВ БЕЗПЕКИ (SA-5(1)) [Вилучено]",
      parameters: []
    }
  end
  ...
  def spec(:"id-spe-si-7-4") do
    %{
      ...
      title: "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ – ПАКУВАННЯ З ІНДИКАЦІЄЮ ОЗНАК ЇЇ НЕСАНКЦІОНОВАНОГО РОЗКРИТТЯ (SI-7(4)) [Вилучено]",
      parameters: []
    }
  end
