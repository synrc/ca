...
""",
  ...
  def spec(:"id-spe-ac-24-2") do
    %{
      ...
      parameters: [
        {:ac_24_2_odp_01,
         "Визначено атрибути безпеки, які не охоплюють ідентифікацію користувача або процесу",
         [type: :string, default: nil]},
        {:ac_24_2_01,
         "Ухвалення рішень щодо управління доступом здійснюються на основі <AC-24(02)_ODP[01] атрибутів безпеки>",
         [type: :string, default: nil]}
      ]
    }
  end
