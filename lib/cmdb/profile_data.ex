...
""",
      ...
      parameters: [
        ...
        {:sa_1_odp_08,
         ...
         [type: :integer, default: 30]},
        {:sa_1_a_01,
         "Розроблена та задокументована політика придбання систем і послуг",
         [type: :integer, default: 30]},
        {:sa_1_a_02,
...
""",
      ...
      parameters: [
        ...
        {:sa_3_b_2,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:sa_3_c_1,
         "Визначені особи, які виконують функції та обов'язки з інформаційної безпеки",
         [type: :list, default: ["admin", "security_officer"]]},
        {:sa_3_c_2,
         "Визначені особи з функціями та обов'язками, пов'язаними з приватністю",
         [type: :list, default: ["admin", "security_officer"]]},
        {:sa_3_d_1,
