defmodule CA.HW do
  ...
  def inventory do
    %{
      ...
      kzi: [
        %{id: "HW-KZI-01", name: "Апаратні криптомодулі (HSM / Гряда)", controls: ["PE", "MP", "SC", "IA"]},
        %{id: "HW-KZI-02", name: "Захищені носії ключової інформації (е-Токени, Смарт-карти)", controls: ["MP", "PE", "IA"]}
      ],
      network: [
        %{id: "HW-NET-01", name: "Маршрутизатори та комутатори ядра", controls: ["SC", "CM", "PE"]},
        %{id: "HW-NET-02", name: "Міжмережеві екрани (Firewalls, IDS/IPS)", controls: ["SC", "AU", "CM"]}
      ],
      endpoints: [
        %{id: "HW-END-01", name: "Робочі станції операторів / адміністраторів", controls: ["PE", "AC", "SI"]},
