defmodule CA.CP do
  ...
  def lookup({1, 2, 804, 3, 1, 2, 4}),
    do: "Цільовий профіль безпеки вищих спеціалізованих судів (Level 3)"
  ...
  def lookup({1, 2, 804, 3, 1, 2, 5, 1}),
    do:
      "Цільовий профіль безпеки місцевих судів (місцеві загальні, господарські, окружні, адміністративні) судів (Level 4)"

  def lookup({1, 2, 804, 3, 1, 2, 5, 2}),
    do: "Цільовий профіль безпек апеляційних судів судів (Level 4)"

  def lookup({1, 2, 804, 3, 1, 2, 6}),
    do: "Цільовий профіль безпеки органів та установ в системі правосуддя (Level 3)"

  def lookup({1, 2, 804, 3, 1, 2, 6, 1}), do: "ДСА (Level 4)"
  def lookup({1, 2, 804, 3, 1, 2, 6, 2}), do: "ТУ ДСА, допоміжні установи (Level 4)"

  def lookup({1, 2, 804, 3, 1, 2, 6, 3}),
    do: "Рада суддів України - орган суддівського самоврядуванння (Level 4)"
