defmodule CA.Profile.Data do
  ...
  control :"id-spe-ac-4-25" do
    ...
    param(:ac_4_25_odp_02, "Визначено політику очищення даних", type: :string, default: nil)
  end
  ...
  control :"id-spe-au-6" do
    ...
    param(:au_6_b, "Звіт аудиту відправляється персоналу або ролям", type: :list, default: [])
  ...
  control :"id-spe-au-10-2" do
    ...
    param(:au_10_2_b, "Виконуються дії у разі помилки перевірки", type: :string, default: nil)
  ...
  control :"id-spe-au-10-4" do
    ...
    param(:au_10_4_b, "Дії виконуються у випадку помилки перевірки", type: :string, default: nil)
  ...
  control :"id-spe-ca-3" do
    ...
    param(:ca_3_c, "Угоди переглядаються та оновлюються частота", type: :string, default: nil)
  ...
  control :"id-spe-ca-6" do
    ...
    param(:ca_6_e, "Акредитації оновлюються частота", type: :string, default: nil)
  ...
  control :"id-spe-cm-5-5" do
    ...
    param(:cm_5_5_b_01, "Переглядаються частота>", type: :string, default: nil)
    ...
    param(:cm_5_5_odp_01, "Визначено частоту перегляду повноважень", type: :string, default: nil)
  ...
  control :"id-spe-cm-9" do
    ...
    param(:cm_9_a_01, "План управління конфігурацією описує ролі", type: :list, default: [])
  ...
  control :"id-spe-cm-11" do
    ...
    param(:cm_11_c, "Дотримання політик контролюється частота", type: :string, default: nil)
  ...
  control :"id-spe-cp-4" do
    ...
    param(:cp_4_c, "За необхідності ініціюються коригувальні дії", type: :string, default: nil)
  ...
  control :"id-spe-ia-5-18" do
    ...
    param(:ia_5_18_b, "Паролі захищені за допомогою елементи керування", type: :list, default: [])
  ...
  control :"id-spe-ia-12" do
    ...
    param(:ia_12_c_01, "Збираються докази ідентичності особи", type: :string, default: nil)
    param(:ia_12_c_02, "Затверджуються докази ідентичності особи", type: :string, default: nil)
    param(:ia_12_c_03, "Перевіряються докази ідентичності особи", type: :string, default: nil)
  end
  ...
  control :"id-spe-ir-9" do
    ...
    param(:ir_9_g, "Дії виконуються у відповідь на витік інформації", type: :string, default: nil)
    ...
    param(:ir_9_odp_03, "Визначені дії, які необхідно виконати", type: :string, default: nil)
  end
  ...
  control :"id-spe-pm-5" do
    ...
    param(:pm_5_odp, "Визначена періодичність організацї", type: :string, default: nil)
  end
  ...
  control :"id-spe-pm-26" do
    ...
    param(:pm_26_odp_03, "Визначено часовий отримання скарг", type: :string, default: nil)
  ...
  control :"id-spe-pm-31" do
    ...
    param(:pm_31_odp_02, "Визначено періодичність моніторингу", type: :string, default: nil)
  ...
  control :"id-spe-pt-2" do
    ...
    param(:pt_2_odp_02, "Визначено тип обробки персональних даних", type: :list, default: [])
  ...
  control :"id-spe-ra-3" do
    ...
    param(:ra_3_odp_03, "Визначено періодичність оцінювання ризику", type: :string, default: nil)
  ...
  control :"id-spe-si-21" do
    ...
    param(:si_21_odp_02, "Визначені частоти, інформацію", type: :string, default: nil)
  end
