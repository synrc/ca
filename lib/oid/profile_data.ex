defmodule CA.Profile.Data do
  ...
  def spec(:"id-spe-at-3-1") do
    %{
      ...
      description: "",
      title:
        "ЗАБЕЗПЕЧУЄТЬСЯ ПІДВИЩЕННЯМ КВАЛІФІКАЦІЇ В ГАЛУЗІ ЗАЙНЯТОСТІ ТА ФУНКЦІОНУВАННЯ ЗАХОДІВ ЗАХИСТУ РОБОЧОГО СЕРЕДОВИЩА З (AT-3(1))",
      parameters: [
        {:at_3_1_01,
  ...
  def spec(:"id-spe-ca-6-1") do
    %{
      ...
      parameters: [
        {:ca_6_1_01, "Для системи впроваджено спільний процес акредитації",
         [type: :string, default: nil]},
        {:ca_6_1_02,
  ...
  def spec(:"id-spe-cm-3-8") do
    %{
      ...
      parameters: [
        {:cm_3_8_01, "Зміни конфігурації системи запобігають або обмежують за обставин",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-cm-7-3") do
    %{
      ...
      parameters: [
        {:cm_7_3_01, "Вимоги до реєстрації дотримано", [type: :string, default: nil]},
  ...
  def spec(:"id-spe-cp-8-5") do
    %{
      ...
      parameters: [
        {:cp_8_5_01, "Тестування надання альтернативних комунікаційних послуг з частотою",
         [type: :integer, default: 30]},
        {:cp_8_5_odp,
  ...
  def spec(:"id-spe-ia-2-13") do
    %{
      ...
      parameters: [
        {:ia_2_13_01, "Механізми зовнішньої автентифікації застосовано за умов",
         [type: :string, default: "автоматизований засіб моніторингу"]},
  ...
  def spec(:"id-spe-ia-4-8") do
    %{
      ...
      parameters: [
        {:ia_4_8_01, "Створено попарні псевдонімні ідентифікатори", [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-5-9") do
    %{
      ...
      parameters: [
        {:ia_5_9_01, "Зовнішні організації використовуються для об'єднання автентифікаторів",
         [type: :string, default: nil]},
        {:ia_5_9_odp,
  ...
  def spec(:"id-spe-ia-8-5") do
    %{
      ...
      parameters: [
        {:ia_8_5_01, "Приймаються облікові дані або дані PKI, які відповідають політика",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
  ...
  def spec(:"id-spe-mp-6-1") do
    %{
      ...
      parameters: [
        {:mp_6_1_01, "Переглядаються заходи з очищення та утилізації носіїв інформації",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-mp-6-7") do
    %{
      ...
      parameters: [
        {:mp_6_7_01, "Здійснюється подвійна авторизація для очищення носії інформації",
         [type: :string, default: nil]},
        {:mp_6_7_odp,
  ...
  def spec(:"id-spe-mp-7-2") do
    %{
      ...
      parameters: [
        {:mp_7_2_01, "Ідентифіковано стійкі до очищення носії інформації",
         [type: :string, default: nil]},
        {:mp_7_2_02,
  ...
  def spec(:"id-spe-mp-8-1") do
    %{
      ...
      parameters: [
        {:mp_8_1_01, "Документуються дії зі зниження категорії безпеки носіїв інформації",
         [type: :list, default: ["login", "logout", "failed_attempt"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-at-2-2") do
    %{
      ...
      title:
        "НАВЧАННЯ З ПІДВИЩЕННЯ ОБІЗНАНОСТІ | НАВЧАННЯ ЩОДО РОЗПІЗНАВАННЯ ВНУТРІШНЬОЇ ЗАГРОЗИ",
      parameters: [
        {:at_2_2_01,
    ...
    %{
      ...
      parameters: [
        ...
        {:pe_3_c,
         ...
         [type: :string, default: nil]},
        {:pe_3_d_01, "Відвідувачів супроводжують", [type: :string, default: nil]},
        {:pe_3_d_02, "Активність відвідувачів контролюється умови", [type: :list, default: []]},
        {:pe_3_e_01, "Ключі захищені", [type: :string, default: nil]},
        {:pe_3_e_02, "Коди доступу захищені", [type: :string, default: nil]},
        {:pe_3_e_03, "Інші пристрої фізичного доступу захищені", [type: :string, default: nil]},
        {:pe_3_f, "Пристрої фізичного доступу інвентаризуються частота",
         [type: :string, default: "щорічно"]},
        {:pe_3_g_01,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:pe_3_odp_01, "Визначено точки входу та виходу в об'єкт, в якому знаходиться система",
         [type: :string, default: nil]},
        {:pe_3_odp_02,
        ...
        {:pe_3_odp_06,
         ...
         [type: :list, default: []]},
        {:pe_3_odp_07, "Визначені пристрої фізичного доступу, що підлягають інвентаризації",
         [type: :string, default: nil]},
        {:pe_3_odp_08, "Визначено частоту проведення інвентаризації пристроїв фізичного доступу",
         [type: :integer, default: 30]},
        {:pe_3_odp_09, "Визначено частоту, з якою потрібно змінювати коди доступу",
         [type: :integer, default: 30]},
        {:pe_3_odp_10, "Визначено частоту, з якою потрібно змінювати ключі",
         [type: :integer, default: 30]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        {:pe_6_a,
         ...
         [type: :string, default: nil]},
        {:pe_6_b_01, "Переглядаються журнали фізичного доступу частота",
         [type: :string, default: "щорічно"]},
        {:pe_6_b_02, "Журнали фізичного доступу переглядаються при виникненні подій",
         [type: :string, default: nil]},
        {:pe_6_c_01,
        ...
        {:pe_6_c_02,
         ...
         [type: :string, default: nil]},
        {:pe_6_odp_01, "Визначено частоту перегляду журналів фізичного доступу",
         [type: :integer, default: 30]},
        {:pe_6_odp_02,
