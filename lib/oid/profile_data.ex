defmodule CA.Profile.Data do
  ...
  control :"id-spe-ac-2-3" do
    ...
    param(:ac_2_3_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДЕАКТИВАЦІЯ ОБЛІКОВИХ ЗАПИСІВ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-2-4" do
    ...
    param(:ac_2_4_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДІЇ ПРИ АВТОМАТИЗОВАНОМУ АУДИТІ",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )

    param(:ac_2_4_02, "Модифікація облікового запису автоматично аудитується",
      type: :string,
      default: nil
    )

    param(:ac_2_4_03, "Активація облікового запису автоматично аудитується",
      type: :string,
      default: nil
    )

    param(:ac_2_4_04, "Деактивація облікового запису автоматично аудитується",
      type: :string,
      default: nil
    )

    param(:ac_2_4_05, "Видалення облікового запису автоматично аудитується",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-2-5" do
  ...
  control :"id-spe-ac-2-6" do
    ...
    param(:ac_2_6_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДИНАМІЧНЕ УПРАВЛІННЯ ПРИВІЛЕЯМИ",
      type: :string,
      default: nil
    )

    param(:ac_2_6_odp, "Визначено можливості динамічного управління привілеями",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-2-7" do
    ...
    param(:ac_2_7_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - СХЕМИ, ЗАСНОВАНІ НА РОЛЯХ",
      type: :string,
      default: nil
    )

    param(:ac_2_7_b, "Проводиться моніторинг призначення привілейованих ролей або атрибутів",
      type: :string,
      default: nil
    )

    param(:ac_2_7_c, "Відстежуються зміни ролей або атрибутів", type: :string, default: nil)
  ...
  control :"id-spe-ac-2-8" do
    ...
    param(:ac_2_8_02, "Облікові записи системи активуються динамічно",
      type: :string,
      default: nil
    )

    param(:ac_2_8_03, "Облікові записи системи активуються динамічно",
      type: :string,
      default: nil
    )

    param(:ac_2_8_04, "Облікові записи системи деактивуються динамічно",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-2-9" do
    ...
    param(:ac_2_9_odp, "Визначено умови створення спільних та групових облікових записів",
      type: :list,
      default: []
    )
  end

  control :"id-spe-ac-2-10" do
    title(
  ...
  control :"id-spe-ac-3-3" do
    ...
    param(:ac_3_3_odp_03, "Визначені суб'єкти, яким явно надаються привілеї",
      type: :string,
      default: nil
    )

    param(:ac_3_3_odp_04, "Визначено привілеї, які мають бути прямо надані суб'єктам",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-3-4" do
  ...
  control :"id-spe-ac-3-7" do
    ...
    param(:ac_3_7_odp_01, "Визначено ролі, на яких базується управління доступом",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ac-3-8" do
    ...
    param(:ac_3_8_odp, "Визначено правила, що регулюють терміни скасування дозволів на доступ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  end

  control :"id-spe-ac-3-9" do
    ...
    param(:ac_3_9_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - КЕРОВАНА ПЕРЕДАЧА (ПУБЛІКАЦІЯ) ІНФОРМАЦІЇ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-3-11" do
    ...
    param(:ac_3_11_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - ОБМЕЖЕННЯ ДОСТУПУ ДО СПЕЦІАЛЬНОЇ ІНФОРМАЦІЇ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-3-12" do
    ...
    param(:ac_3_12_c, "Зміни доступу після первинної інсталяції програми схвалено. для",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-3-13" do
    ...
    param(:ac_3_13_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - УПРАВЛІННЯ ДОСТУПОМ НА ОСНОВІ АТРИБУТІВ",
      type: :string,
      default: nil
    )
    ...
    param(:ac_3_13_3, "Доступ контролюється на основі атрибутів", type: :string, default: nil)

    param(:ac_3_13_odp, "Визначено атрибути для визначення прав доступу",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  end

  control :"id-spe-ac-3-14" do
  ...
  control :"id-spe-ac-3-15" do
    ...
    param(:ac_3_15_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - ДИСКРЕЦІЙНИЙ ТА ОБОВʼЯЗКОВИЙ ДОСТУП",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-4-1" do
    ...
    param(:ac_4_1_odp_05, "Визначено джерела об'єктів, які будуть пов'язані з атрибутами безпеки",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-4-5" do
    ...
    param(:ac_4_5_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ВБУДОВУВАННЯ ТИПІВ ДАНИХ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-4-9" do
    ...
    param(:ac_4_9_01, "Перевірка персоналом використовуються для інформаційних потоків за умов",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ac-4-12" do
    ...
    param(:ac_4_12_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ІДЕНТИФІКАТОРИ ТИПУ ДАНИХ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-4-15" do
    ...
    param(:ac_4_15_odp_01, "Визначено несанкціоновану інформацію, яку потрібно виявляти",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-4-21" do
    ...
    param(:ac_4_21_odp_03, "Визначено необхідні поділи за типами інформації",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-4-22" do
  ...
  control :"id-spe-ac-4-24" do
    ...
    param(:ac_4_24_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ НОРМАЛІЗОВАНИЙ ФОРМАТ ПОТОКАМИ - ВНУТРІШНІЙ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-4-25" do
    ...
    param(:ac_4_25_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ОЧИЩЕННЯ ДАНИХ",
      type: :string,
      default: nil
    )
    ...
    param(:ac_4_25_odp_02, "Визначено політику очищення даних",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  end

  control :"id-spe-ac-4-26" do
  ...
  control :"id-spe-ac-4-29" do
    ...
    param(:ac_4_29_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ХАНІЗМІВ ОРКЕСТРОВКИ ПОТОКАМИ - ФІЛЬТР МЕ-",
      type: :string,
      default: nil
    )
    ...
    param(:ac_4_29_odp, "Визначено політику щодо дій з фільтрації контенту",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  end

  control :"id-spe-ac-4-30" do
    title(
  ...
  control :"id-spe-ac-5" do
    ...
    param(:ac_5_01, "РОЗМЕЖУВАННЯ ОБОВ'ЯЗКІВ", type: :string, default: nil)
  ...
  control :"id-spe-ac-6-1" do
    title("МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - АВТОРИЗОВАНИЙ ДОСТУП ДО ФУНКЦІЙ БЕЗПЕКИ (AC-6(1))")
    desc("")

    param(:ac_6_1_01, "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - АВТОРИЗОВАНИЙ ДОСТУП ДО ФУНКЦІЙ БЕЗПЕКИ",
      type: :string,
      default: nil
    )
    ...
    param(:ac_6_1_b, "Авторизовано доступ для осіб та ролей до інформації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-6-2" do
    ...
    param(:ac_6_2_odp, "Визначені функції безпеки або інформація, що стосується безпеки",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-6-4" do
  ...
  control :"id-spe-ac-6-5" do
    ...
    param(:ac_6_5_01, "Привілейовані облікові записи в системі обмежено персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ac-6-7" do
    ...
    param(:ac_6_7_01, "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - ПЕРЕГЛЯД ПОВНОВАЖЕНЬ КОРИСТУВАЧА",
      type: :string,
      default: nil
    )
    ...
    param(:ac_6_7_odp_02, "Визначено ролі або класи користувачів, яким призначено повноваження ",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-ac-6-8" do
  ...
  control :"id-spe-ac-6-9" do
    title("МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - АУДИТ ВИКОРИСТАННЯ ПРИВІЛЕЙОВАНИХ ФУНКЦІЙ (AC-6(9))")
    desc("Реєструвати виконання привілейованих функцій.")

    param(:ac_6_9_01, "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - АУДИТ ВИКОРИСТАННЯ ПРИВІЛЕЙОВАНИХ ФУНКЦІЙ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-6-10" do
    title(
  ...
  control :"id-spe-ac-7" do
    ...
    param(:ac_7_odp_05, "Визначено алгоритм затримки наступного запиту на вхід (якщо вибрано)",
      type: :string,
      default: "AES-256-GCM"
    )
  ...
  control :"id-spe-ac-7-4" do
    ...
    param(:ac_7_4_01, "НЕВДАЛІ СПРОБИ ВХОДУ В СИСТЕМУ - ВИКОРИСТАННЯ АЛЬТЕРНАТИВНОГО ФАКТОРА",
      type: :integer,
      default: 3
    )
  ...
  control :"id-spe-ac-9-4" do
    ...
    param(:ac_9_4_odp, "Визначено додаткову інформацію, про яку слід повідомити користувача",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-10" do
  ...
  control :"id-spe-ac-12" do
    ...
    param(:ac_12_01, "Сеанс користувача автоматично завершується після виконання умов або подій",
      type: :string,
      default: nil
    )

    param(:ac_12_odp, "Визначено умови або події, що вимагають припинення сеансу",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-ac-12-1" do
  ...
  control :"id-spe-ac-14" do
    ...
    param(:ac_14_01, "ДОЗВОЛЕНІ ДІЇ БЕЗ ІДЕНТИФІКАЦІЇ АБО АВТЕНТИФІКАЦІЇ",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-ac-15" do
    title("АВТОМАТИЗОВАНЕ МАРКУВАННЯ (AC-15)")
    desc("")

    param(:ac_15_01, "АВТОМАТИЗОВАНЕ МАРКУВАННЯ [Вилучено: включено до MP-03]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-16" do
    ...
    param(:ac_16_odp_03, "Визначено значення атрибутів безпеки для типів атрибутів безпеки",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-16-1" do
    title("АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ДИНАМІЧНЕ ПОВ’ЯЗАННЯ АТРИБУТІВ (AC-16(1))")
    desc("")

    param(:ac_16_1_01, "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ДИНАМІЧНЕ ПОВ’ЯЗАННЯ АТРИБУТІВ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-ac-16-3" do
    ...
    param(
      :ac_16_3_01,
      "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ПІДТРИМКА СИСТЕМОЮ ПОВ’ЯЗАННЯ АТРИБУТІВ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:ac_16_3_02, "Підтримується зв'язок та цілісність атрибутів безпеки з об'єктами",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-16-6" do
    ...
    param(:ac_16_6_odp_01, "Визначено атрибути безпеки, які будуть пов'язані з суб'єктами",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:ac_16_6_odp_02, "Визначено атрибути безпеки, які будуть пов'язані з об'єктами",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
    ...
    param(:ac_16_6_odp_05, "Визначені суб'єкти, які будуть пов'язані з атрибутами безпеки",
      type: :string,
      default: nil
    )

    param(:ac_16_6_odp_06, "Визначені об'єкти, які будуть пов'язані з атрибутами безпеки",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-16-7" do
    ...
    param(:ac_16_7_01, "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ПОСЛІДОВНА ІНТЕРПРЕТАЦІЯ АТРИБУТІВ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-ac-17-1" do
    title("ВІДДАЛЕНИЙ ДОСТУП - АВТОМАТИЗОВАНИЙ МОНІТОРИНГ ТА УПРАВЛІННЯ (AC-17(1))")
    desc("")

    param(:ac_17_1_01, "ВІДДАЛЕНИЙ ДОСТУП - АВТОМАТИЗОВАНИЙ МОНІТОРИНГ ТА УПРАВЛІННЯ",
      type: :string,
      default: nil
    )

    param(:ac_17_1_02, "Проводиться управління методами віддаленого доступу",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-17-2" do
    title(
  ...
  control :"id-spe-ac-17-4" do
    title("ВІДДАЛЕНИЙ ДОСТУП - ПРИВІЛЕЙОВАНІ КОМАНДИ ТА ДОСТУП (AC-17(4))")
    desc("")

    param(:ac_17_4_01, "ВІДДАЛЕНИЙ ДОСТУП - ПРИВІЛЕЙОВАНІ КОМАНДИ ТА ДОСТУП",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-17-10" do
    title("ВІДДАЛЕНИЙ ДОСТУП - (10) АВТЕНТИФІКАЦІЯ ВІДДАЛЕНИХ КОМАНД (AC-17(10))")
    desc("")

    param(:ac_17_10_01, "Визначені механізми атентифіку- ють визначені віддалені команди",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  ...
  control :"id-spe-ac-18" do
    ...
    param(:ac_18_a_03, "Встановлено доступу", type: :string, default: nil)
  ...
  control :"id-spe-ac-18-1" do
    title("БЕЗДРОТОВИЙ ДОСТУП - АВТЕНТИФІКАЦІЯ ТА ШИФРУВАННЯ (AC-18(1))")
    desc("")

    param(:ac_18_1_02, "Бездротовий доступ до системи захищений за допомогою шифрування",
      type: :string,
      default: "AES-256-GCM"
    )
  end

  control :"id-spe-ac-18-2" do
  ...
  control :"id-spe-ac-19" do
    ...
    param(:ac_19_b, "Авторизовано підключення мобільних пристроїв до систем організації",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-19-1" do
    title(
  ...
  control :"id-spe-ac-20" do
    ...
    param(:ac_20_odp_04, "Визначено типи зовнішніх систем, заборонених до використання",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-20-1" do
    title("ВИКОРИСТАННЯ ЗОВНІШНІХ СИСТЕМ - ОБМЕЖЕННЯ НА АВТОРИЗОВАНЕ ВИКОРИСТАННЯ (AC-20(1))")
    desc("")

    param(:ac_20_1_01, "ВИКОРИСТАННЯ ЗОВНІШНІХ СИСТЕМ - ОБМЕЖЕННЯ НА АВТОРИЗОВАНЕ ВИКОРИСТАННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ac-21-2" do
    ...
    param(:ac_21_2_odp, "Визначено обмеження щодо обміну інформацією",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-22" do
  ...
  control :"id-spe-ac-23" do
    ...
    param(:ac_23_odp_01, "Визначено техніки виявлення та попередження витоку даних",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )

    param(:ac_23_odp_02, "Визначено об'єкти зберігання даних", type: :string, default: nil)
  end

  control :"id-spe-ac-24" do
  ...
  control :"id-spe-ac-24-1" do
    ...
    param(:ac_24_1_odp_03, "Визначено системи, які забезпечують рішень щодо управління доступом",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ac-24-2" do
    title(
  ...
  control :"id-spe-at-1" do
    ...
    param(:at_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ПІДВИЩЕННЯ ОБІЗНАНОСТІ ТА НАВЧАННЯ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  end

  control :"id-spe-at-2" do
  ...
  control :"id-spe-at-3" do
    ...
    param(:at_3_b_01, "Оновлюється вміст навчання на основі ролей з частотою",
      type: :integer,
      default: 30
    )

    param(:at_3_b_02, "Оновлюється вміст навчання на основі ролей після подій",
      type: :string,
      default: nil
    )
    ...
    param(:at_3_odp_01, "Визначено ролі та обов'язки для тренінгів з безпеки на основі ролей",
      type: :list,
      default: ["admin", "security_officer"]
    )
    ...
    param(:at_3_odp_04, "Визначено частоту оновлення змісту навчання на основі ролей",
      type: :integer,
      default: 30
    )
  ...
  control :"id-spe-at-4" do
    ...
    param(:at_4_b, "Індивідуальні записи про навчання зберігаються протягом період часу",
      type: :integer,
      default: 30
    )

    param(:at_4_odp, "Визначено період зберігання індивідуальних записів про навчання",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-at-5" do
    title("КОНТАКТИ З ГРУПАМИ БЕЗПЕКИ ТА АСОЦІАЦІЯМИ (AT-5)")
    desc("")

    param(:at_5_01, "КОНТАКТИ З ГРУПАМИ БЕЗПЕКИ ТА АСОЦІАЦІЯМИ Вилучено: включено в PM-15",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-at-6" do
  ...
  control :"id-spe-au-1" do
    ...
    param(:au_1_a_01, "Розроблено та задокументовано політику аудиту та підзвітності",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:au_1_a_02, "Політика аудиту та підзвітності доведена до персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-au-2" do
    ...
    param(:au_2_c_02, "Зазначені типи подій реєструються 02_ODP[03] частота або ситуація>; <AU-",
      type: :string,
      default: "щорічно"
    )
    ...
    param(:au_2_odp_04, "Частота перегляду та оновлення типів подій, обраних для журналювання",
      type: :string,
      default: "щорічно"
    )
  end

  control :"id-spe-au-2-1" do
  ...
  control :"id-spe-au-2-2" do
    title("ПОДІЇ АУДИТУ - ВИБІР ПОДІЇ АУДИТУ ЗА КОМПОНЕНТАМИ (AU-2(2))")
    desc("")
  end

  control :"id-spe-au-2-3" do
    title("ПОДІЇ АУДИТУ - ПЕРЕГЛЯД ТА ОНОВЛЕННЯ (AU-2(3))")
    desc("")

    param(:au_2_3_01, "ПОДІЇ АУДИТУ - ПЕРЕГЛЯД ТА ОНОВЛЕННЯ [Вилучено: Включено в АU-02]",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-au-2-4" do
    title("ПОДІЇ АУДИТУ - ПРИВІЛЕЙОВАНІ ФУНКЦІЇ (AU-2(4))")
    desc("")

    param(:au_2_4_01, "ПОДІЇ АУДИТУ - ПРИВІЛЕЙОВАНІ ФУНКЦІЇ [Вилучено: Включено в AC-06(09)]",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-au-3" do
    ...
    param(:au_3_a, "Записи аудиту містять інформацію, яка встановлює який тип події стався",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )

    param(:au_3_b, "Записи аудиту містять інформацію, яка встановлює коли подія сталася",
      type: :string,
      default: nil
    )

    param(:au_3_c, "Записи аудиту містять інформацію, яка встановлює де відбулася подія",
      type: :string,
      default: nil
    )

    param(:au_3_d, "Записи аудиту містять інформацію, яка встановлює джерело події",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )

    param(:au_3_e, "Записи аудиту містять інформацію, яка встановлює наслідки події",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-au-3-1" do
    ...
    param(:au_3_1_odp, "Визначено додаткову інформацію, яка має бути включена до записів аудиту",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-3-2" do
    title(
  ...
  control :"id-spe-au-3-3" do
    ...
    param(:au_3_3_odp, "Визначаються елементи, визначені конфіденційності; в оцінці ризику",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-4" do
    ...
    param(:au_4_01, "Розподілено ємність для зберігання записів аудиту відповідно до вимог",
      type: :string,
      default: nil
    )

    param(:au_4_odp, "Визначено вимоги до зберігання записів аудиту", type: :string, default: nil)
  end

  control :"id-spe-au-4-1" do
  ...
  control :"id-spe-au-5" do
    ...
    param(:au_5_b, "Додаткові дії виконуються у разі збою процесу обробки даних аудиту",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-au-5-2" do
    ...
    param(:au_5_2_odp_03, "Визначено події, пов’язані зі збоями та помилками аудиту",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-au-5-3" do
    title(
  ...
  control :"id-spe-au-5-4" do
    ...
    param(:au_5_4_01, "РЕАГУВАННЯ НА ВІДМОВИ ОБРОБКИ ДАНИХ АУДИТУ - ВИМКНЕННЯ У РАЗІ ВІДМОВИ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-5-5" do
    title(
  ...
  control :"id-spe-au-6" do
    ...
    param(:au_6_01, "ОГЛЯД, АНАЛІЗ І ЗВІТНІСТЬ АУДИТУ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )
    ...
    param(:au_6_b, "Звіт аудиту відправляється персоналу або ролям",
      type: :list,
      default: ["admin", "security_officer"]
    )
    ...
    param(:au_6_odp_02, "Визначена неналежна або незвична діяльність",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-au-6-5" do
    ...
    param(:au_6_5_01, "ОГЛЯД, АНАЛІЗ І ЗВІТНІСТЬ АУДИТУ - ІНТЕГРОВАНИЙ АНАЛІЗ ЗАПИСІВ АУДИТУ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-au-6-7" do
    ...
    param(:au_6_7_01, "ОГЛЯД, АНАЛІЗ І ЗВІТНІСТЬ АУДИТУ - ДОЗВОЛЕНІ ДІЇ",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-au-8" do
    ...
    param(:au_8_odp, "Визначено деталізацію вимірювання часу для часових позначок записів аудиту",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-au-8-1" do
  ...
  control :"id-spe-au-9" do
    ...
    param(:au_9_01, "ЗАХИСТ ІНФОРМАЦІЇ АУДИТУ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-au-9-2" do
    ...
    param(:au_9_2_odp, "Визначено частоту з якою необхідно зберігати записи аудиту",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-au-9-3" do
  ...
  control :"id-spe-au-9-4" do
    ...
    param(:au_9_4_odp, "Визначено підмножину привілейованих користувачів",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-9-5" do
  ...
  control :"id-spe-au-10" do
    ...
    param(:au_10_odp, "Визначено дії, на які поширюється принцип неспростовності",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-au-10-1" do
  ...
  control :"id-spe-au-10-2" do
    ...
    param(:au_10_2_b, "Виконуються дії у разі помилки перевірки",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-au-10-4" do
    ...
    param(
      :au_10_4_01,
      "НЕСПРОСТОВНІСТЬ - ВАЛІДАЦІЯ ЗВ'ЯЗКУ ІДЕНТИЧНОСТІ ПЕРЕГЛЯ- ДАЧА ІНФОРМАЦІЇ",
      type: :string,
      default: nil
    )
    ...
    param(:au_10_4_b, "Дії виконуються у випадку помилки перевірки",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
    ...
    param(:au_10_4_odp_02, "Визначено дії, які мають бути виконані у випадку помилки перевірки",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-au-10-5" do
    title("НЕСПРОСТОВНІСТЬ - ЦИФРОВІ ПІДПИСИ (AU-10(5))")
    desc("")

    param(:au_10_5_01, "НЕСПРОСТОВНІСТЬ - ЦИФРОВІ ПІДПИСИ [Вилучено: Включено до SI-07]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-11" do
  ...
  control :"id-spe-au-12-3" do
    ...
    param(:au_12_3_odp_02, "Визначено компоненти системи, на яких має виконуватися аудит",
      type: :string,
      default: nil
    )

    param(:au_12_3_odp_03, "Визначено критерії вибору подій", type: :list, default: [])

    param(:au_12_3_odp_04, "Визначено часові пороги, в яких мають змінюватися аудит",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-au-12-4" do
  ...
  control :"id-spe-au-13" do
    ...
    param(:au_13_b_02, "Додаткові дії вживаються, якщо виявлено розголошення інформації",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-au-13-2" do
    ...
    param(
      :au_13_2_01,
      "МОНІТОРИНГ РОЗКРИТТЯ ІНФОРМАЦІЇ - ОГЛЯД САЙТІВ, ЩО ПІДЛЯГАЮТЬ МОНІТОРИНГУ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-au-15" do
    title("АЛЬТЕРНАТИВНА МОЖЛИВІСТЬ АУДИТУ (AU-15)")
    desc("")

    param(:au_15_01, "АЛЬТЕРНАТИВНА МОЖЛИВІСТЬ АУДИТУ [Вилучено: Включено до AU-05(05)]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-16" do
  ...
  control :"id-spe-au-16-2" do
    ...
    param(:au_16_2_odp_02, "Визначено міжорганізаційну угоду про розподіл",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-au-16-3" do
  ...
  control :"id-spe-ca-1" do
    ...
    param(:ca_1_01, "ПОЛІТИКА І ПРОЦЕДУРИ ОЦІНЮВАННЯ, АКРЕДИТАЦІЯ ТА МОНІТОРИНГ БЕЗПЕКИ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-ca-3" do
    ...
    param(:ca_3_b_02, "Вимоги до безпеки задокументовані як частина кожної угоди про обмін",
      type: :integer,
      default: 30
    )
    ...
    param(:ca_3_b_04, "Заходи захисту задокументовані як частина кожної угоди про обмін",
      type: :integer,
      default: 30
    )
    ...
    param(:ca_3_c, "Угоди переглядаються та оновлюються частота",
      type: :string,
      default: "щорічно"
    )
    ...
    param(:ca_3_odp_03, "Визначено частоту, з якою необхідно переглядати та оновлювати угоди",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-ca-3-1" do
  ...
  control :"id-spe-ca-4" do
    title("СЕРТИФІКАЦІЯ БЕЗПЕКИ (CA-4)")
    desc("")

    param(:ca_4_01, "СЕРТИФІКАЦІЯ БЕЗПЕКИ [Вилучено: Включено до CA-02]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ca-5" do
  ...
  control :"id-spe-ca-6" do
    ...
    param(:ca_6_e, "Акредитації оновлюються частота", type: :string, default: "щорічно")

    param(:ca_6_odp, "Визначено частоту, з якою потрібно оновлювати акредитації",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-ca-6-1" do
    title("АКРЕДИТАЦІЯ - СПІЛЬНА АКРЕДИТАЦІЯ - ОДНА І ТА САМА ОРГАНІЗАЦІЯ (CA-6(1))")
    desc("")

    param(:ca_6_1_01, "АКРЕДИТАЦІЯ - СПІЛЬНА АКРЕДИТАЦІЯ - ОДНА І ТА САМА ОРГАНІЗАЦІЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ca-6-2" do
    ...
    param(:ca_6_2_01, "Для системи впроваджено спільний процес акредитації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ca-7" do
    ...
    param(:ca_7_odp_01, "Визначено метрики системного рівня, які підлягають моніторингу",
      type: :string,
      default: nil
    )

    param(:ca_7_odp_02, "Визначено частоту, з якою слід моніторити ефективність заходів захисту",
      type: :integer,
      default: 30
    )

    param(:ca_7_odp_03, "Визначено частоту, з якою слід оцінювати ефективність заходів захисту",
      type: :integer,
      default: 30
    )
    ...
    param(:ca_7_odp_05, "Визначено частоту, з якою повідомляється про стан безпеки системи",
      type: :integer,
      default: 30
    )
  ...
  control :"id-spe-ca-7-2" do
    title("БЕЗПЕРЕРВНИЙ МОНІТОРИНГ - ВИДИ ОЦІНОК (CA-7(2))")
    desc("")

    param(:ca_7_2_01, "БЕЗПЕРЕРВНИЙ МОНІТОРИНГ - ВИДИ ОЦІНОК [Вилучено: Включено до CA-02]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ca-7-3" do
  ...
  control :"id-spe-ca-7-4" do
    ...
    param(:ca_7_4_a, "Моніторинг ефективності включено до моніторингу ризиків",
      type: :string,
      default: nil
    )

    param(:ca_7_4_b, "Моніторинг відповідності включено до моніторингу ризиків",
      type: :string,
      default: nil
    )

    param(:ca_7_4_c, "Моніторинг змін включений до моніторингу ризиків",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ca-7-5" do
    ...
    param(:ca_7_5_01, "Дії використовуються для перевірки того, що політики встановлено",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
    ...
    param(:ca_7_5_odp_01, "Визначені дії для підтвердження того, що політики встановлені",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-ca-8" do
    ...
    param(:ca_8_01, "Проводиться тестування на проникнення з частотою у системі",
      type: :integer,
      default: 30
    )

    param(:ca_8_odp_01, "Визначено частоту з якою проводить тестування на проникнення",
      type: :integer,
      default: 30
    )

    param(:ca_8_odp_02, "Визначено систему у якій проводить тестування на проникнення",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ca-8-1" do
  ...
  control :"id-spe-ca-8-3" do
    ...
    param(:ca_8_3_01, "ТЕСТУВАННЯ НА ПРОНИКНЕННЯ - МОЖЛИВОСТІ ПЕРЕВІРКИ НА ПРОНИКНЕННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ca-9" do
    ...
    param(:ca_9_01, "ВНУТРІШНІ З’ЄДНАННЯ СИСТЕМИ", type: :string, default: nil)

    param(:ca_9_a, "Внутрішні підключення компонентів системи до системи є авторизовані",
      type: :string,
      default: nil
    )
    ...
    param(:ca_9_b_02, "Для кожного внутрішнього з'єднання задокументовані вимоги безпеки",
      type: :string,
      default: nil
    )
    ...
    param(:ca_9_c, "Внутрішні з'єднання системи розриваються після виконання умов",
      type: :string,
      default: nil
    )

    param(:ca_9_d, "Переглядається подальша потреба у кожному внутрішньому з'єднанні частота",
      type: :string,
      default: "щорічно"
    )
    ...
    param(:ca_9_odp_02, "Визначено умови, за яких необхідно розірвати внутрішні підключення",
      type: :list,
      default: []
    )
  ...
  control :"id-spe-cm-1" do
    ...
    param(:cm_1_a_01, "Розроблено та задокументовано політику управління конфігурацією",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:cm_1_a_02, "Політика управління конфігурацією поширюється на персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-cm-2" do
    ...
    param(:cm_2_a_01, "Розроблено та задокументовано поточні базові налаштування системи",
      type: :string,
      default: nil
    )
    ...
    param(:cm_2_b_01, "Переглядаються та оновлюються базові налаштування системи частота",
      type: :string,
      default: "щорічно"
    )

    param(:cm_2_b_02, "Переглядаються та оновлюються базові налаштування системи після подій",
      type: :string,
      default: nil
    )
    ...
    param(:cm_2_odp_01, "Визначено частоту налаштувань; перегляду та оновлення базових",
      type: :integer,
      default: 30
    )
  ...
  control :"id-spe-cm-2-1" do
    title("БАЗОВА КОНФІГУРАЦІЯ - ПЕРЕГЛЯД ТА ОНОВЛЕННЯ (CM-2(1))")
    desc("")

    param(:cm_2_1_01, "БАЗОВА КОНФІГУРАЦІЯ - ПЕРЕГЛЯД ТА ОНОВЛЕННЯ [Вилучено: Включено до CM-02]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-2-2" do
    ...
    param(
      :cm_2_2_01,
      "БАЗОВА КОНФІГУРАЦІЯ - АВТОМАТИЗАЦІЯ ПІДТРИМКИ ЗАДЛЯ ТОЧНОСТІ ТА ВЖИВАНОСТІ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-3" do
    ...
    param(:cm_3_c, "Рішення про зміну конфігурації системи документуються",
      type: :string,
      default: nil
    )

    param(:cm_3_d, "Впроваджуються схвалені зміни до конфігурації в систему",
      type: :string,
      default: nil
    )
    ...
    param(:cm_3_f_01, "Здійснюється моніторинг конфігурації системи", type: :string, default: nil)

    param(:cm_3_f_02, "Здійснюється аналіз дій, пов'язаних зі змінами конфігурації системи",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-3-2" do
    title(
      "УПРАВЛІННЯ ЗМІНАМИ КОНФІГУРАЦІЇ - ТЕСТУВАННЯ, ВАЛІДАЦІЯ ТА ДОКУМЕНТУВАННЯ ЗМІН (CM-3(2))"
    )

    desc("Тестувати, перевіряти та документувати зміни в системі до повної їх реалізації.")

    param(:cm_3_2_01, "Зміни в системі тестуються перед повним впровадженням змін",
      type: :string,
      default: nil
    )

    param(:cm_3_2_02, "Зміни в системі перевіряються перед повним впровадженням змін",
      type: :string,
      default: nil
    )

    param(:cm_3_2_03, "Зміни в системі документуються перед повним впровадженням змін",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-3-3" do
  ...
  control :"id-spe-cm-3-5" do
    ...
    param(:cm_3_5_odp, "Визначено реагування безпеки, які мають бути застосовані автоматично",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-3-6" do
    title(
    ...
    param(:cm_3_6_odp, "Визначено заходи захисту", type: :string, default: nil)
  end

  control :"id-spe-cm-3-7" do
    ...
    param(:cm_3_7_odp_01, "Визначено частоту, з якою необхідно переглядати зміни",
      type: :integer,
      default: 30
    )

    param(:cm_3_7_odp_02, "Визначено обставини, за яких зміни мають бути переглянуті",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-3-8" do
    title(
    ...
    param(:cm_3_8_odp, "Визначено обставини, за яких зміни мають бути запобіжені або обмежені",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-4" do
  ...
  control :"id-spe-cm-4-1" do
    ...
    param(:cm_4_1_02, "Зміни в системі аналізуються на предмет впливу на безпеку через недоліки",
      type: :string,
      default: nil
    )
    ...
    param(:cm_4_1_04, "Зміни в системі аналізуються на предмет впливу на безпеку через слабкості",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-5" do
    ...
    param(:cm_5_02, "Затверджені фізичні обмеження доступу, пов'язані зі змінами в системі",
      type: :string,
      default: nil
    )

    param(:cm_5_03, "Застосовуються фізичні обмеження доступу, пов'язані зі змінами в системі",
      type: :string,
      default: nil
    )
    ...
    param(:cm_5_05, "Затверджені логічні обмеження доступу, пов'язані зі змінами в системі",
      type: :string,
      default: nil
    )

    param(:cm_5_06, "Застосовуються логічні обмеження доступу, пов'язані зі змінами в системі",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-5-1" do
    title("ОБМЕЖЕННЯ ДОСТУПУ ДО ЗМІНИ - АУДИТ І ЗДІЙСНЕННЯ АВТОМАТИЧНОГО ДОСТУПУ (CM-5(1))")
    desc("")

    param(:cm_5_1_01, "ОБМЕЖЕННЯ ДОСТУПУ ДО ЗМІНИ - АУДИТ І ЗДІЙСНЕННЯ АВТОМАТИЧНОГО ДОСТУПУ",
      type: :string,
      default: nil
    )
    ...
    param(:cm_5_1_b, "Автоматично формуються записи аудиту для виконаних дій",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-5-4" do
    ...
    param(:cm_5_4_02, "Запроваджено подвійну авторизацію для внесення змін до інформації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-5-5" do
    ...
    param(:cm_5_5_b_01, "Переглядаються частота>", type: :string, default: "щорічно")

    param(:cm_5_5_b_02, "Переоцінюються повноваження частота; повноваження <CM-05(05)_ODP[01]",
      type: :string,
      default: "щорічно"
    )

    param(:cm_5_5_odp_01, "Визначено частоту перегляду повноважень", type: :integer, default: 30)

    param(:cm_5_5_odp_02, "Визначено частоту переоцінення повноважень",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-cm-5-6" do
  ...
  control :"id-spe-cm-6" do
    ...
    param(:cm_6_b, "Реалізовано установки конфігурації, задокументовані в CM-06a",
      type: :string,
      default: nil
    )
    ...
    param(:cm_6_odp_03, "Визначені експлуатаційні вимоги, що вимагають затвердження відхилень",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-6-1" do
    title(
    ...
    param(:cm_6_1_odp_02, "Визначено автоматизовані механізми налаштуваннями конфігурації",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
    ...
    param(:cm_6_1_odp_04, "Визначено автоматизовані налаштувань конфігурації",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-6-2" do
    ...
    param(:cm_6_2_01, "НАЛАШТУВАННЯ КОНФІГУРАЦІЇ САНКЦІОНОВАНІ ЗМІНИ - РЕАГУВАННЯ НА НЕ-",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-6-4" do
  ...
  control :"id-spe-cm-7" do
    ...
    param(:cm_7_a, "Система налаштована на забезпечення лише основні функції системи ",
      type: :string,
      default: nil
    )

    param(:cm_7_b_01, "Використання функцій заборонено або обмежено", type: :string, default: nil)
    param(:cm_7_b_02, "Використання порти заборонено або обмежено", type: :string, default: nil)

    param(:cm_7_b_03, "Використання протоколи заборонено або обмежено",
      type: :string,
      default: "TLS 1.3"
    )

    param(:cm_7_b_04, "Використання програмне забезпечення заборонено або обмежено",
      type: :string,
      default: nil
    )

    param(:cm_7_b_05, "Використання служби заборонено або обмежено", type: :string, default: nil)

    param(:cm_7_odp_01, "Визначено основні функції системи, необхідні для виконання місії",
      type: :string,
      default: nil
    )

    param(:cm_7_odp_02, "Визначено функції, які необхідно заборонити або обмежити",
      type: :string,
      default: nil
    )

    param(:cm_7_odp_03, "Визначено системні порти, які необхідно заборонити або обмежити",
      type: :string,
      default: nil
    )
    ...
    param(:cm_7_odp_06, "Визначено служби, які необхідно заборонити або обмежити",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-7-1" do
    title("МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ПЕРІОДИЧНИЙ ПЕРЕГЛЯД (CM-7(1))")
    desc("")

    param(:cm_7_1_01, "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ПЕРІОДИЧНИЙ ПЕРЕГЛЯД",
      type: :integer,
      default: 30
    )
    ...
    param(:cm_7_1_b_01, "Функції, які вважаються непотрібними та/або незахищеними, вимкнено",
      type: :string,
      default: nil
    )

    param(:cm_7_1_b_02, "Порти, які вважаються непотрібними та/або незахищеними, вимкнено",
      type: :string,
      default: nil
    )

    param(:cm_7_1_b_03, "Протоколи, які вважаються непотрібними та/або незахищеними, вимкнено",
      type: :string,
      default: "TLS 1.3"
    )

    param(:cm_7_1_b_04, "Послуги, які вважаються непотрібними та/або незахищеними, вимкнено",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-7-2" do
    ...
    param(:cm_7_2_01, "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ЗАБОРОНА ВИКОНАННЯ ПРОГРАМИ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-7-3" do
    ...
    param(:cm_7_3_01, "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ВІДПОВІДНІСТЬ РЕЄСТРАЦІЇ",
      type: :string,
      default: nil
    )

    param(:cm_7_3_odp, "Визначено вимоги до реєстрації функцій, портів, протоколів та сервісів",
      type: :string,
      default: "TLS 1.3"
    )
  end

  control :"id-spe-cm-7-4" do
    title(
    ...
    param(:cm_7_4_a, "Визначено програмне забезпечення", type: :string, default: nil)
    ...
    param(:cm_7_4_c, "Переглядається та оновлюється список неавторизованих програм частота",
      type: :list,
      default: []
    )
  ...
  control :"id-spe-cm-7-5" do
    ...
    param(:cm_7_5_a, "Визначено програмне забезпечення", type: :string, default: nil)
    ...
    param(:cm_7_5_c, "Переглядається та оновлюється список авторизованих програм частота",
      type: :list,
      default: []
    )
    ...
    param(:cm_7_5_odp_02, "Визначено частоту перегляду та оновлення списку авторизованих програм",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-cm-7-6" do
    title(
  ...
  control :"id-spe-cm-7-9" do
    ...
    param(:cm_7_9_a, "Ідентифіковано апаратні компоненти", type: :string, default: nil)
  ...
  control :"id-spe-cm-8" do
    ...
    param(:cm_8_b, "Переглядається та оновлюється опис компонентів системи частота",
      type: :string,
      default: "щорічно"
    )
    ...
    param(:cm_8_odp_02, "Визначено частоту перегляду та оновлення опису компонентів системи",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-cm-8-1" do
    title(
  ...
  control :"id-spe-cm-8-4" do
    title("ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ - ІНФОРМАЦІЯ ПРО ПІДЗВІТНІСТЬ (CM-8(4))")
    desc("")

    param(:cm_8_4_01, "ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ - ІНФОРМАЦІЯ ПРО ПІДЗВІТНІСТЬ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-8-8" do
    ...
    param(:cm_8_8_odp, "Визначено автоматизовані механізми відстеження компонентів",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  end

  control :"id-spe-cm-8-9" do
    title("ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ - ПРИЗНАЧЕННЯ КОМПОНЕНТІВ СИСТЕМАМ (CM-8(9))")
    desc("")

    param(:cm_8_9_01, "ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ - ПРИЗНАЧЕННЯ КОМПОНЕНТІВ СИСТЕМАМ",
      type: :string,
      default: nil
    )

    param(:cm_8_9_a, "Компоненти системи призначаються системі", type: :string, default: nil)

    param(:cm_8_9_b, "Отримано підтвердження призначення компонента від персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:cm_8_9_odp, "Визначено персонал або ролі, від яких слід отримувати підтвердження",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-cm-9" do
    ...
    param(:cm_9_01, "Розроблено та задокументовано план управління конфігурацією системи",
      type: :string,
      default: nil
    )

    param(:cm_9_a_01, "План управління конфігурацією описує ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:cm_9_a_02, "План управління конфігурацією описує відповідальність",
      type: :string,
      default: nil
    )
    ...
    param(:cm_9_c_01, "План управління конфігурацією визначає елементи конфігурації системи",
      type: :string,
      default: nil
    )
    ...
    param(:cm_9_e_02, "План управління конфігурацією захищений від несанкціонованої модифікації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-11" do
    ...
    param(:cm_11_c, "Дотримання політик контролюється частота",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-cm-12" do
    title("РОЗТАШУВАННЯ ІНФОРМАЦІЇ (CM-12)")
    desc("")

    param(:cm_12_a_01, "Місцезнаходження інформація визначено та задокументовано",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cm-12-1" do
    ...
    param(:cm_12_1_odp_01, "Інформація визначена за типом", type: :string, default: nil)

    param(:cm_12_1_odp_02, "Визначено компоненти системи, де знаходиться інформація",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-13" do
    title("ВІДОБРАЖЕННЯ ДІЙ ДАНИХ (CM-13)")
    desc("")

    param(:cm_13_01, "Розроблено та задокументовано карту дій з даними системи",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cm-14" do
  ...
  control :"id-spe-cp-1" do
    title("ПОЛІТИКА ТА ПРОЦЕДУРИ ПЛАНУВАННЯ БЕЗПЕРЕРВНОЇ РОБОТИ (CP-1)")
    desc("")

    param(:cp_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ПЛАНУВАННЯ БЕЗПЕРЕРВНОЇ РОБОТИ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-cp-2" do
    title("ПЛАН ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ (CP-2)")
    desc("")

    param(:cp_2_01, "ПЛАН ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cp-4" do
    ...
    param(:cp_4_a_02, "Тести використовуються для визначення ефективності плану",
      type: :string,
      default: nil
    )

    param(:cp_4_a_03, "Тести використовуються для визначення готовності до виконання плану",
      type: :string,
      default: nil
    )
    ...
    param(:cp_4_c, "За необхідності ініціюються коригувальні дії",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  ...
  control :"id-spe-cp-6" do
    title("АЛЬТЕРНАТИВНЕ МІСЦЕ ЗБЕРІГАННЯ (CP-6)")
    desc("")

    param(:cp_6_01, "АЛЬТЕРНАТИВНЕ МІСЦЕ ЗБЕРІГАННЯ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )

    param(:cp_6_a_01, "Створено альтернативне місце зберігання", type: :string, default: nil)
  ...
  control :"id-spe-cp-6-3" do
    ...
    param(:cp_6_3_02, "В загальних рисах окреслено дії щодо пом'якшення наслідків",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-cp-7" do
    ...
    param(:cp_7_odp_01, "Визначені операції системи для основних завдань і функцій",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cp-7-2" do
    ...
    param(:cp_7_2_02, "Окреслено чіткі заходи щодо пом'якшення наслідків",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cp-7-3" do
  ...
  control :"id-spe-cp-8-5" do
    title("КОМУНІКАЦІЙНІ ПОСЛУГИ - ТЕСТУВАННЯ АЛЬТЕРНАТИВНИХ КОМУНІКАЦІЙНИХ ПОСЛУГ (CP-8(5))")
    desc("")

    param(:cp_8_5_01, "КОМУНІКАЦІЙНІ ПОСЛУГИ - ТЕСТУВАННЯ АЛЬТЕРНАТИВНИХ КОМУНІКАЦІЙНИХ ПОСЛУГ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cp-9" do
    title("РЕЗЕРВНЕ КОПІЮВАННЯ (CP-9)")
    desc("")

    param(:cp_9_01, "РЕЗЕРВНЕ КОПІЮВАННЯ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )
    ...
    param(:cp_9_d_01, "Конфіденційність резервних копій інформації захищена",
      type: :string,
      default: nil
    )

    param(:cp_9_d_02, "Цілісність резервних копій інформації захищена",
      type: :string,
      default: nil
    )

    param(:cp_9_d_03, "Доступність резервних копій інформації захищена",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-cp-12" do
    title("БЕЗПЕЧНИЙ РЕЖИМ (CP-12)")
    desc("")

    param(:cp_12_01, "При виявлені умови, вводиться безпечний режим роботи з обмеженням",
      type: :list,
      default: []
    )

    param(:cp_12_odp_01, "Визначено умови, за яких організація вводить безпечний режим роботи",
      type: :list,
      default: []
    )

    param(:cp_12_odp_02, "Визначено обмеження в безпечному режимі роботи",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-cp-13" do
    ...
    param(:cp_13_odp_01, "Визначені альтернативні або додаткові механізми безпеки",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )

    param(:cp_13_odp_02, "Визначені функції безпеки", type: :string, default: nil)
  end

  control :"id-spe-ia-1" do
    title("Політика та процедури ідентифікації та автентифікації (IA-1)")
    desc("")

    param(:ia_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ІДЕНТИФІКАЦІЇ ТА АВТЕНТИФІКАЦІЇ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:ia_1_a_01, "Розроблено та задокументовано політику ідентифікації та автентифікації",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:ia_1_a_02, "Політика ідентифікації та автентифікації поширюється на персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ia-2-13" do
    ...
    param(:ia_2_13_odp_01, "Визначено механізми зовнішньої автентифікації",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  ...
  control :"id-spe-ia-3-3" do
    title("ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ ПРИСТРОЇВ - ДИНАМІЧНИЙ РОЗПОДІЛ АДРЕСИ (IA-3(3))")
    desc("")

    param(:ia_3_3_01, "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ ПРИСТРОЇВ - ДИНАМІЧНИЙ РОЗПОДІЛ АДРЕСИ",
      type: :string,
      default: nil
    )
    ...
    param(:ia_3_3_b, "Інформація про оренду перевіряється, коли її призначено пристрою",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ia-4-4" do
    ...
    param(:ia_4_4_odp, "Визначено ознаку, що ідентифікує індивідуальний статус",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ia-4-5" do
  ...
  control :"id-spe-ia-4-6" do
    title("УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - КРОС-ОРГАНІЗАЦІЙНЕ УПРАВЛІННЯ (IA-4(6))")
    desc("")

    param(:ia_4_6_01, "УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - КРОС-ОРГАНІЗАЦІЙНЕ УПРАВЛІННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ia-4-8" do
    title("УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - ПОПАРНІ ПСЕВДОНІМНІ ІДЕНТИФІКАТОРИ (IA-4(8))")
    desc("")

    param(:ia_4_8_01, "УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - ПОПАРНІ ПСЕВДОНІМНІ ІДЕНТИФІКАТОРИ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ia-4-9" do
    title("УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - ПОПАРНІ ПСЕВДОНІМНІ ІДЕНТИФІКАТОРИ (IA-4(9))")
    desc("")

    param(:ia_4_9_01, "УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - ПОПАРНІ ПСЕВДОНІМНІ ІДЕНТИФІКАТОРИ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ia-5-1" do
    title("УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ ПАРОЛЯ (IA-5(1))")
    desc("")

    param(:ia_5_1_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ ПАРОЛЯ",
      type: :string,
      default: nil
    )
    ...
    param(:ia_5_1_odp_02, "Визначено склад та правила складності автентифікатора",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  end

  control :"id-spe-ia-5-2" do
    title("УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ ВІДКРИТОГО КЛЮЧА (IA-5(2))")
    desc("")

    param(:ia_5_2_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ ВІДКРИТОГО КЛЮЧА",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ia-5-3" do
    title(
  ...
  control :"id-spe-ia-5-9" do
    title("УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - УПРАВЛІННЯ ОБ’ЄДНАННЯМ АВТЕНТИФІКАТОРІВ (IA-5(9))")
    desc("")

    param(:ia_5_9_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - УПРАВЛІННЯ ОБ’ЄДНАННЯМ АВТЕНТИФІКАТОРІВ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ia-5-12" do
    ...
    param(:ia_5_12_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - ЕФЕКТИВНІСТЬ БІОМЕТРИЧНОЇ АВТЕНТИФІКАЦІЇ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ia-5-16" do
    ...
    param(:ia_5_16_odp_03, "Визначено зареєстрований орган, який приймає автентифікатори",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ia-5-18" do
    title("УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - МЕНЕДЖЕР ПАРОЛІВ (IA-5(18))")
    desc("")

    param(:ia_5_18_a, "Менеджери паролів використовуються для створення та керування паролями",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:ia_5_18_b, "Паролі захищені за допомогою елементи керування",
      type: :list,
      default: ["admin", "security_officer"]
    )
    ...
    param(:ia_5_18_odp_02, "Визначено елементи керування для захисту паролів",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-ia-7" do
  ...
  control :"id-spe-ia-8-5" do
    ...
    param(:ia_8_5_02, "Підтверджуються облікові дані або дані PKI, які відповідають політика",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-ia-11" do
    ...
    param(:ia_11_odp, "Визначено обставини або ситуації, що вимагають повторної автен- тифікації",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ia-12" do
    title("ПЕРЕВІРКА СПРАВЖНОСТІ (ІДЕНТИЧНОСТІ) (IA-12)")
    desc("")
    param(:ia_12_01, "ПЕРЕВІРКА СПРАВЖНОСТІ (ІДЕНТИЧНОСТІ)", type: :string, default: nil)
    ...
    param(:ia_12_b, "Встановлені ідентифікатори користувачів унікальні для особи",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:ia_12_c_01, "Збираються докази ідентичності особи",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:ia_12_c_02, "Затверджуються докази ідентичності особи",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:ia_12_c_03, "Перевіряються докази ідентичності особи",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-ia-12-1" do
  ...
  control :"id-spe-ia-12-2" do
    title("ПЕРЕВІРКА СПРАВЖНОСТІ (ІДЕНТИЧНОСТІ) - ПОСВІДЧЕННЯ ОСОБИ (IA-12(2))")
    desc("")

    param(:ia_12_2_01, "Документи, що посвідчують особу пред’являються до реєстраційного органу",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-ia-12-4" do
  ...
  control :"id-spe-ir-1" do
    title("Політика та процедури реагування на інциденти (IR-1)")
    desc("")

    param(:ir_1_a_01, "Розроблено та задокументовано політику реагування на інциденти",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:ir_1_a_02, "Політика реагування на інциденти поширюється серед персоналу або ролей",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ir-2-1" do
    title("НАВЧАННЯ З РЕАГУВАННЯ НА ІНЦИДЕНТИ - МОДЕЛЮВАННЯ ПОДІЙ (IR-2(1))")
    desc("")

    param(:ir_2_1_01, "НАВЧАННЯ З РЕАГУВАННЯ НА ІНЦИДЕНТИ - МОДЕЛЮВАННЯ ПОДІЙ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ir-2-3" do
  ...
  control :"id-spe-ir-3-3" do
    title("ПЕРЕВІРКА РЕАГУВАНЬ НА ІНЦИДЕНТИ - ПОСТІЙНЕ ПОКРАЩЕННЯ (IR-3(3))")
    desc("")

    param(:ir_3_3_01, "ПЕРЕВІРКА РЕАГУВАНЬ НА ІНЦИДЕНТИ - ПОСТІЙНЕ ПОКРАЩЕННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ir-4" do
    title("Обробка інциденту (IR-4)")
    desc("")

    param(:ir_4_a_02, "Впроваджено можливість обробки інцидентів безпеки включно з виявленням",
      type: :string,
      default: nil
    )

    param(:ir_4_a_03, "Впроваджено можливість обробки інцидентів безпеки включно з аналізом",
      type: :string,
      default: nil
    )

    param(:ir_4_a_04, "Впроваджено можливість обробки інцидентів безпеки включно з локалізацією",
      type: :string,
      default: nil
    )

    param(:ir_4_a_05, "Впроваджено можливість обробки інцидентів безпеки включно з ліквідацією",
      type: :string,
      default: nil
    )

    param(:ir_4_a_06, "Впроваджено можливість обробки інцидентів безпеки включно з відновленням",
      type: :string,
      default: nil
    )
    ...
    param(:ir_4_c_02, "Зміни, що випливають відповідним чином", type: :string, default: nil)
  ...
  control :"id-spe-ir-4-2" do
    ...
    param(:ir_4_2_odp_01, "Визначено типи динамічної реконфігурації для компонентів системи",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ir-4-3" do
    title("ОБРОБКА ІНЦИДЕНТУ - БЕЗПЕРЕРВНІСТЬ ОПЕРАЦІЙ (IR-4(3))")
    desc("")
    param(:ir_4_3_01, "Ідентифіковано класи інцидентів", type: :string, default: nil)
  ...
  control :"id-spe-ir-4-9" do
    title("ОБРОБКА ІНЦИДЕНТУ - ЗДАТНІСТЬ ДИНАМІЧНОГО РЕАГУВАННЯ (IR-4(9))")
    desc("")

    param(:ir_4_9_01, "ОБРОБКА ІНЦИДЕНТУ - ЗДАТНІСТЬ ДИНАМІЧНОГО РЕАГУВАННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ir-4-11" do
    title("ОБРОБКА ІНЦИДЕНТУ - ІНТЕГРОВАНА ГРУПА РЕАГУВАННЯ НА ІНЦЕДЕНТИ (IR-4(11))")
    desc("")

    param(:ir_4_11_01, "Створена та підтримується інтегрована група реагування на інциденти",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ir-4-12" do
    title("ОБРОБКА ІНЦИДЕНТУ - ЗЛОВМИСНИЙ КОД ТА КРИМІНАЛІСТИЧНИЙ АНАЛІЗ (IR-4(12))")
    desc("")

    param(:ir_4_12_01, "Шкідливий код, що залишився в системі, аналізується після інциденту",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ir-4-14" do
    title("ОБРОБКА ІНЦИДЕНТУ - ЦЕНТР БЕЗПЕКИ (IR-4(14))")
    desc("")
    param(:ir_4_14_01, "Створено оперативний центр безпеки", type: :string, default: nil)
    param(:ir_4_14_02, "Підтримується оперативний центр безпеки", type: :string, default: nil)
  end

  control :"id-spe-ir-4-15" do
    title("ОБРОБКА ІНЦИДЕНТУ - ЗВʼЯЗКИ З ГРОМАДКІСТЮ ТА ВІДНОВЛЕННЯ РЕПУТАЦІЇ (IR-4(15))")
    desc("")

    param(:ir_4_15_01, "ОБРОБКА ІНЦИДЕНТУ - ЗВʼЯЗКИ З ГРОМАДКІСТЮ ТА ВІДНОВЛЕННЯ РЕПУТАЦІЇ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ir-5" do
    title("Моніторинг інциденту (IR-5)")
    desc("")
    param(:ir_5_01, "Відстежуються інциденти безпеки та приватності", type: :string, default: nil)
  ...
  control :"id-spe-ir-5-1" do
    ...
    param(:ir_5_1_odp_01, "Визначено автоматизовані механізми відстеження інцидентів",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )

    param(:ir_5_1_odp_02, "Визначено автоматизовані механізми збору інформації про інциденти",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )

    param(:ir_5_1_odp_03, "Визначено автоматизовані механізми аналізу інформації про інциденти",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  end

  control :"id-spe-ir-6" do
    ...
    param(:ir_6_b, "Інформацію про інцидент повідомляється органам", type: :string, default: nil)
    ...
    param(:ir_6_odp_02, "Визначені органи, до яких слід повідомляти інформацію про інцидент",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ir-6-1" do
    title("ЗВІТНІСТЬ ПРО ІНЦИДЕНТИ - АВТОМАТИЧНЕ ЗВІТУВАННЯ (IR-6(1))")
    desc("")

    param(:ir_6_1_01, "Використовуються автоматичні механізми звітування про інциденти",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )

    param(:ir_6_1_odp, "Визначені автоматичні механізми звітування про інциденти",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  end

  control :"id-spe-ir-6-3" do
  ...
  control :"id-spe-ir-8" do
    ...
    param(:ir_8_e_01, "План реагування на інциденти захищений від несанкціонованого розкриття",
      type: :string,
      default: nil
    )

    param(:ir_8_e_02, "План реагування на інциденти захищений від несанкціонованої модифікації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ir-8-1" do
    title("ПЛАН РЕАГУВАННЯ НА ІНЦИДЕНТИ - ОБРОБКА ПЕРСОНАЛЬНИХ ДАНИХ (IR-8(1))")
    desc("")

    param(:ir_8_1_01, "ПЛАН РЕАГУВАННЯ НА ІНЦИДЕНТИ - ОБРОБКА ПЕРСОНАЛЬНИХ ДАНИХ",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ir-9" do
    ...
    param(:ir_9_d, "Ізоляцюється система або компонент системи де відбувся витік інформації",
      type: :string,
      default: nil
    )
    ...
    param(:ir_9_g, "Дії виконуються у відповідь на витік інформації",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
    ...
    param(:ir_9_odp_03, "Визначені дії, які необхідно виконати",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-ir-9-1" do
  ...
  control :"id-spe-ir-9-2" do
    title("РЕАГУВАННЯ НА ВИТІК ІНФОРМАЦІЇ - ТРЕНУВАННЯ (IR-9(2))")
    desc("")

    param(:ir_9_2_01, "Забезпечено навчання з реагування на витік інформації частота",
      type: :string,
      default: "щорічно"
    )

    param(:ir_9_2_odp, "Визначено частоту навчання з реагування на витік інформації",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-ir-9-3" do
  ...
  control :"id-spe-ma-1" do
    ...
    param(:ma_1_a_01, "Розроблено та задокументовано політику технічного обслуговування",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:ma_1_a_02, "Політика технічного обслуговування поширюється на персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ma-2-1" do
    title("КОНТРОЛЬОВАНЕ ОБСЛУГОВУВАННЯ - ЗМІСТ ЗАПИСУ (MA-2(1))")
    desc("")

    param(:ma_2_1_01, "КОНТРОЛЬОВАНЕ ОБСЛУГОВУВАННЯ - ЗМІСТ ЗАПИСУ [Вилучено: Включено до МА-02]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ma-2-2" do
    title("КОНТРОЛЬОВАНЕ ОБСЛУГОВУВАННЯ - АВТОМАТИЗОВАНА ТЕХНІЧНА ДІЯЛЬНІСТЬ (MA-2(2))")
    desc("")

    param(:ma_2_2_01, "КОНТРОЛЬОВАНЕ ОБСЛУГОВУВАННЯ - АВТОМАТИЗОВАНА ТЕХНІЧНА ДІЯЛЬНІСТЬ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ma-3" do
    ...
    param(:ma_3_a_01, "Використання засобів технічного обслуговування затверджено",
      type: :string,
      default: nil
    )

    param(:ma_3_a_02, "Використання засобів технічного обслуговування контролюється",
      type: :string,
      default: nil
    )

    param(:ma_3_a_03, "Використання засобів технічного обслуговування відстажуються",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ma-3-3" do
    ...
    param(
      :ma_3_3_01,
      "ІНСТРУМЕНТИ ДЛЯ ОБСЛУГОВУВАННЯ - ЗАПОБІГАННЯ НЕСАНКЦІОНОВАНОМУ ПЕРЕМІЩЕННЮ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ma-4" do
    title("ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ (MA-4)")
    desc("")

    param(:ma_4_a_01, "Впроваджено віддалені дії з обслуговування та діагностики",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )

    param(:ma_4_a_02, "Відстежуються віддалені дії з обслуговування та діагностики",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
    ...
    param(:ma_4_d, "Ведеться облік віддалених дій з обслуговування та діагностики",
      type: :string,
      default: nil
    )

    param(:ma_4_e_01, "Сесія припиняється, коли завершено віддалене обслуговування",
      type: :string,
      default: nil
    )

    param(:ma_4_e_02, "Мережеве з’єднання припиняється, коли завершено віддалене обслуговування",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ma-4-1" do
    title("ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - АУДИТ ТА ОГЛЯД (MA-4(1))")
    desc("")

    param(:ma_4_1_a_01, "Події аудиту журналюються для віддалених сеансів обслуговування",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )

    param(:ma_4_1_a_02, "Події аудиту журналюються для віддалених сеансів діагностики",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )

    param(:ma_4_1_b_01, "Здійснюється огляд записів про сеанси віддаленого обслуговування",
      type: :string,
      default: nil
    )

    param(:ma_4_1_b_02, "Здійснюється огляд записів про сеанси віддаленої діагностики",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ma-4-3" do
    title("ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - ПОРІВНЯЛЬНА БЕЗПЕКА І ОЧИЩЕННЯ (MA-4(3))")
    desc("")

    param(:ma_4_3_01, "ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - ПОРІВНЯЛЬНА БЕЗПЕКА І ОЧИЩЕННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ma-4-5" do
    title("ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - СХВАЛЕННЯ ТА ПОВІДОМЛЕННЯ (MA-4(5))")
    desc("")

    param(:ma_4_5_01, "ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - СХВАЛЕННЯ ТА ПОВІДОМЛЕННЯ",
      type: :string,
      default: nil
    )

    param(:ma_4_5_a, "Схвалення кожного віддаленого сеансу обслуговування від персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ma-5" do
    ...
    param(:ma_5_a_01, "Запроваджено процес авторизації технічного персоналу",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-mp-1" do
    ...
    param(:mp_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ЩОДО ЗАХИСТУ НОСІЇВ ІНФОРМАЦІЇ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:mp_1_a_01, "Розроблено та задокументовано політику захисту носіїв інформації",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )

    param(:mp_1_a_02, "Політика захисту носіїв інформації поширюється на персонал або ролі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-mp-2" do
    ...
    param(:mp_2_01, "Доступ до типів цифрових носіїв інформації обмежено для персоналу або ролей",
      type: :list,
      default: ["admin", "security_officer"]
    )
    ...
    param(:mp_2_odp_01, "Визначено типи цифрових носіїв інформації, доступ до яких обмежено",
      type: :string,
      default: nil
    )
    ...
    param(:mp_2_odp_03, "Визначено типи нецифрових носіїв інформації, доступ до яких обмежено",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-3" do
    ...
    param(:mp_3_01, "МАРКУВАННЯ НОСІЇВ ІНФОРМАЦІЇ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )
    ...
    param(:mp_3_b, "Типи носіїв інформації залишаються в межах контрольованих зон",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-4" do
    ...
    param(:mp_4_a_01, "Типи цифрових носіїв контролюються фізично", type: :string, default: nil)
    param(:mp_4_a_02, "Типи нецифрових носіїв контролюються фізично", type: :string, default: nil)

    param(:mp_4_a_03, "Типи цифрових носіїв безпечно зберігаються в контрольованих зонах",
      type: :string,
      default: nil
    )

    param(:mp_4_a_04, "Типи нецифрових носіїв безпечно зберігаються в контрольованих зонах",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-6-1" do
    ...
    param(:mp_6_1_02, "Затверджуються заходи з очищення та утилізації носіїв інформації",
      type: :string,
      default: nil
    )

    param(:mp_6_1_03, "Відстежуються заходи з очищення та утилізації носіїв інформації",
      type: :string,
      default: nil
    )

    param(:mp_6_1_04, "Документуються заходи з очищення та утилізації носіїв інформації",
      type: :string,
      default: nil
    )

    param(:mp_6_1_05, "Перевіряються заходи з очищення та утилізації носіїв інформації",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-mp-6-2" do
    ...
    param(:mp_6_2_odp_02, "Визначено частоту, з якою потрібно перевіряти процедури очищення",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-mp-6-3" do
    ...
    param(:mp_6_3_odp, "Визначено умови, які вимагають очищення зовнішніх носіїв інформації",
      type: :list,
      default: []
    )
  end

  control :"id-spe-mp-6-4" do
  ...
  control :"id-spe-mp-6-7" do
    title("ЗНИЩЕННЯ ІНФОРМАЦІЇ НА НОСІЯХ ІНФОРМАЦІЇ - ПОДВІЙНА АВТОРИЗАЦІЯ (MP-6(7))")
    desc("")

    param(:mp_6_7_01, "ЗНИЩЕННЯ ІНФОРМАЦІЇ НА НОСІЯХ ІНФОРМАЦІЇ - ПОДВІЙНА АВТОРИЗАЦІЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-6-8" do
    ...
    param(:mp_6_8_odp_02, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРІВ: {віддалено; за умов }",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-7" do
    ...
    param(:mp_7_01, "ВИКОРИСТАННЯ НОСІЇВ ІНФОРМАЦІЇ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )
    ...
    param(:mp_7_odp_02, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРА: {обмежити; заборонити}",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-8" do
    ...
    param(:mp_8_a_01, "Встановлено безпеки носіїв інформаці; процес зниження категорії",
      type: :string,
      default: nil
    )
    ...
    param(:mp_8_odp_01, "Визначено процес зниження категорії безпеки носіїв інформації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-mp-8-1" do
    title("ЗНИЖЕННЯ КАТЕГОРІЇ БЕЗПЕКИ НОСІЇВ ІНФОРМАЦІЇ - ДОКУМЕНТУВАННЯ ПРОЦЕСУ (MP-8(1))")
    desc("")

    param(:mp_8_1_01, "ЗНИЖЕННЯ КАТЕГОРІЇ БЕЗПЕКИ НОСІЇВ ІНФОРМАЦІЇ - ДОКУМЕНТУВАННЯ ПРОЦЕСУ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-mp-8-2" do
  ...
  control :"id-spe-pe-2" do
    ...
    param(:pe_2_b, "Для доступу до об'єкта надаються повноваження", type: :string, default: nil)
  ...
  control :"id-spe-pe-3-5" do
    title("Керування фізичним доступом — Захист від злому (PE-3(5))")
    desc("")

    param(:pe_3_5_odp_01, "Визначено заходи захисту від фізичної підробки або підміни",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pe-6-2" do
    title(
      "Моніторинг фізичного доступу — Автоматичні розпізнавання вторгнень і відповідна реакція (PE-6(2))"
    )

    desc("")
    param(:pe_6_2_01, "Розпізнаються класи або типи вторгнень", type: :string, default: nil)

    param(:pe_6_2_02, "Реакції ініціюються за допомогою автоматизованих механізмів",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pe-21" do
    ...
    param(:pe_21_odp_01, "Визначено заходи захисту від пошкодження електромагнітними імпульсами",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pl-4" do
    ...
    param(:pl_4_01, "ПРАВИЛА ПОВЕДІНКИ ТА ПОСТАЧАННЯ ПЕРСОНАЛЬНИХ ДАНИХ - -",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:pl_4_odp_01, "Визначено періодичність перегляду та оновлення правил поведінки",
      type: :string,
      default: "щорічно"
    )
  ...
  control :"id-spe-pl-4-1" do
    title("ПРАВИЛА ПОВЕДІНКИ - ОБМЕЖЕННЯ НА СОЦІАЛЬНІ МЕДІА ТА МЕРЕЖУ (PL-4(1))")
    desc("")

    param(:pl_4_1_01, "ПРАВИЛА ПОВЕДІНКИ - ОБМЕЖЕННЯ НА СОЦІАЛЬНІ МЕДІА ТА МЕРЕЖУ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-pl-5" do
    title("ОЦІНКА ВПЛИВУ НА ПРИВАТНІСТЬ (PL-5)")
    desc("")

    param(:pl_5_01, "ОЦІНКА ВПЛИВУ НА ПРИВАТНІСТЬ [Вилучено: включено до RА-8]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-pl-6" do
    title("ПЛАНУВАННЯ ДІЯЛЬНОСТІ, ПОВ'ЯЗАНОЇ З БЕЗПЕКОЮ (PL-6)")
    desc("")

    param(:pl_6_01, "ПЛАНУВАННЯ ДІЯЛЬНОСТІ, ПОВ'ЯЗАНОЇ З БЕЗПЕКОЮ [Вилучено: включено до PL-2]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-pl-7" do
  ...
  control :"id-spe-pl-8" do
    ...
    param(:pl_8_01, "АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pl-8-1" do
    title("АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ - «ГЛИБОКА ОБОРОНА» (PL-8(1))")
    desc("")

    param(:pl_8_1_01, "АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ - «ГЛИБОКА ОБОРОНА»",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pl-10" do
    title("ВИБІР БАЗОВОГО ПРОФІЛЮ БЕЗПЕКИ (PL-10)")
    desc("Вибрати базовий профіль безпеки для інформаційної системи.")
    param(:pl_10_01, "Вибрано базовий профіль безпеки для системи", type: :string, default: nil)
  end

  control :"id-spe-pl-11" do
  ...
  control :"id-spe-pm-2" do
    ...
    param(:pm_2_01, "Призначено старшу посадову особу з питань інформаційної безпеки в установі",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-pm-5" do
    ...
    param(:pm_5_01, "Розроблено перелік систем організацї", type: :list, default: [])
    ...
    param(:pm_5_odp, "Визначена періодичність організацї", type: :string, default: "щорічно")
  end

  control :"id-spe-pm-7" do
    ...
    param(:pm_7_01, "Розроблена архітектура інформаційної безпеки; підприємства з урахуванням",
      type: :string,
      default: nil
    )

    param(:pm_7_02, "Підтримується архітектура інформаційної безпеки; підприємства з урахуванням",
      type: :string,
      default: nil
    )

    param(:pm_7_03, "Розроблена архітектура конфіденційності; підприємства з урахуванням",
      type: :string,
      default: nil
    )

    param(:pm_7_04, "Підтримується архітектура конфіденційності; підприємства з урахуванням",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pm-7-1" do
    ...
    param(:pm_7_1_odp, "Визначені несуттєві функції або послуги, які потрібно розвантажити",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-pm-8" do
  ...
  control :"id-spe-pm-11" do
    title("ВИЗНАЧЕННЯ ЗАВДАНЬ ТА ПРОЦЕСІВ (PM-11)")
    desc("безпеки та приватності.")
  ...
  control :"id-spe-pm-13" do
    title("БЕЗПЕКА ТА ПРИВАТНІСТЬ ПРАЦІВНИКІВ (PM-13)")
    desc("")

    param(:pm_13_01, "Існує програма розвитку та вдосконалення спеціалістів з питань безпеки",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pm-14" do
    ...
    param(:pm_14_01, "ТЕСТУВАННЯ, НАВЧАННЯ ТА МОНІТОРИНГ", type: :string, default: nil)
  end

  control :"id-spe-pm-15" do
  ...
  control :"id-spe-pm-17" do
    ...
    param(:pm_17_odp_01, "Визначена періодичність перегляду та оновлення політики",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-pm-18" do
    ...
    param(:pm_18_01, "ПРОГРАМА (КОНЦЕПЦІЯ) ЗАБЕЗПЕЧЕННЯ ПРИВАТНОСТІ", type: :string, default: nil)
  ...
  control :"id-spe-pm-19" do
    ...
    param(:pm_19_01, "Визначена періодичність приватності; оновлення плану програми",
      type: :string,
      default: "щорічно"
    )
    ...
    param(:pm_19_03, "Містить план програми приватності опис структури програми приватності",
      type: :string,
      default: nil
    )
    ...
    param(:pm_19_05, "Містить план програми приватності огляд вимог до програми приватності",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-pm-20" do
  ...
  control :"id-spe-pm-23" do
    ...
    param(:pm_23_01, "Створено орган управління даними, що складається з ролей з обов'язками",
      type: :string,
      default: nil
    )

    param(:pm_23_odp_01, "Визначені ролі органу управління персональними даними",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:pm_23_odp_02, "Визначені обов'язки органу управління персональними даними",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-pm-24" do
  ...
  control :"id-spe-pm-26" do
    ...
    param(:pm_26_odp_03, "Визначено часовий отримання скарг", type: :integer, default: 30)
    param(:pm_26_odp_04, "Визначено термін для відповіді на скарги", type: :string, default: nil)
  end

  control :"id-spe-pm-27" do
    ...
    param(:pm_27_odp_01, "Визначені звіти з питань забезпечення приватності",
      type: :string,
      default: nil
    )

    param(:pm_27_odp_02, "Визначені органи нагляду за дотриманням приватності",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-pm-28" do
    title("ОЦІНКА РИЗИКІВ (PM-28)")
    desc("")

    param(:pm_28_odp_01, "Визначено персонал, який отримуватиме результати визначення ризиків",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-pm-31" do
    ...
    param(:pm_31_odp_02, "Визначено періодичність моніторингу", type: :string, default: "щорічно")

    param(:pm_31_odp_03, "Визначена періодичність оцінки ефективності контролю",
      type: :string,
      default: "щорічно"
    )
    ...
    param(:pm_31_odp_06, "Визначено періодичність звітування про стан безпеки систем організації",
      type: :string,
      default: "щорічно"
    )

    param(:pm_31_odp_07, "Визначено періодичність звітування конфіденційності систем організації",
      type: :string,
      default: "щорічно"
    )
  end

  control :"id-spe-pm-32" do
  ...
  control :"id-spe-ps-3" do
    title("Перевірка персоналу (PS-3)")
    desc("")

    param(:ps_3_odp_01, "Визначені умови, що вимагають повторної перевірки осіб",
      type: :list,
      default: []
    )
  ...
  control :"id-spe-ps-4" do
    title("Звільнення персоналу (PS-4)")
    desc("")

    param(:ps_4_odp_01, "Визначено період часу, протягом якого забороняється доступ до системи",
      type: :integer,
      default: 30
    )
  ...
  control :"id-spe-ps-6" do
    title("Угоди про доступ (PS-6)")
    desc("")

    param(:ps_6_odp_01, "Визначено періодичність перегляду та оновлення угод про доступ",
      type: :string,
      default: "щорічно"
    )
  ...
  control :"id-spe-pt-2" do
    ...
    param(:pt_2_odp_02, "Визначено тип обробки персональних даних",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-pt-3" do
    ...
    param(:pt_3_odp_01, "Визначено мету (цілі) обробки персональних даних",
      type: :list,
      default: ["admin", "security_officer"]
    )

    param(:pt_3_odp_02, "Визначена обробка персональних даних, яка підлягає обмеженню",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-pt-7" do
    title("СПЕЦІАЛЬНІ КАТЕГОРІЇ ПЕРСОНАЛЬНИХ ДАНИХ (PT-7)")
    desc("для певних категорій персональних даних.")

    param(:pt_7_01, "Застосовуються умови обробки до певних категорій персональних даних",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-pt-7-1" do
    title("СПЕЦІАЛЬНІ КАТЕГОРІЇ ПЕРСОНАЛЬНИХ СОЦІАЛЬНОГО СТРАХУВАННЯ (PT-7(1))")
    desc("")

    param(:pt_7_1_01, "СПЕЦІАЛЬНІ КАТЕГОРІЇ ПЕРСОНАЛЬНИХ СОЦІАЛЬНОГО СТРАХУВАННЯ ДАНИХ - НОМЕРИ",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-ra-1" do
    ...
    param(:ra_1_odp_07, "Визначено періодичність перегляду поточних процедур оцінювання ризику",
      type: :string,
      default: "щорічно"
    )
  end

  control :"id-spe-ra-2" do
  ...
  control :"id-spe-ra-3" do
    ...
    param(:ra_3_odp_03, "Визначено періодичність оцінювання ризику",
      type: :string,
      default: "щорічно"
    )
  ...
  control :"id-spe-ra-3-1" do
    title("ОЦІНЮВАННЯ ПОСТАЧАННЯ (RA-3(1))")
    desc("")

    param(:ra_3_1_01, "ОЦІНЮВАННЯ ПОСТАЧАННЯ РИЗИКУ - ОЦІНЮВАННЯ РИЗИКУ ЛАНЦЮГА",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-ra-3-2" do
    title("ОЦІНЮВАННЯ РИЗИКУ - ВИКОРИСТАННЯ ІНФОРМАЦІЇ З УСІХ ДОСТУПНИХ ДЖЕРЕЛ (RA-3(2))")
    desc("")

    param(:ra_3_2_01, "Використовується інформація з усіх доступних джерел для аналізу ризиків",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ra-3-3" do
    ...
    param(:ra_3_3_odp, "Є засоби для постійного визначення поточного стану кіберзагроз",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  end

  control :"id-spe-ra-3-4" do
  ...
  control :"id-spe-ra-4" do
    title("ОНОВЛЕННЯ ОЦІНЮВАННЯ РИЗИКУ (RA-4)")
    desc("")

    param(:ra_4_01, "ОНОВЛЕННЯ ОЦІНЮВАННЯ РИЗИКУ [Вилучено: включено до RA-3]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ra-5" do
  ...
  control :"id-spe-ra-5-1" do
    title("СКАНУВАННЯ ВРАЗЛИВОСТЕЙ ІНСТРУМЕНТІВ (RA-5(1))")
    desc("")

    param(:ra_5_1_01, "СКАНУВАННЯ ВРАЗЛИВОСТЕЙ ІНСТРУМЕНТІВ [Вилучено: включено до RA-5]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ra-5-2" do
    title(
  ...
  control :"id-spe-ra-5-3" do
    title("СКАНУВАННЯ ВРАЗЛИВОСТЕЙ - ШИРОТА ТА ГЛИБИНА ПОКРИТТЯ (RA-5(3))")
    desc("")

    param(:ra_5_3_01, "Визначено ширину вразливостей. та глибину охоплення сканування",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-ra-5-4" do
  ...
  control :"id-spe-ra-5-8" do
    title("СКАНУВАННЯ ВРАЗЛИВОСТЕЙ - ОГЛЯД ЖУРНАЛІВ АУДИТУ ЗА МИНУЛІ ПЕРІОДИ (RA-5(8))")
    desc("")

    param(:ra_5_8_01, "СКАНУВАННЯ ВРАЗЛИВОСТЕЙ - ОГЛЯД ЖУРНАЛІВ АУДИТУ ЗА МИНУЛІ ПЕРІОДИ",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-ra-5-9" do
  ...
  control :"id-spe-ra-6" do
    title("ЗАХОДИ ПРОТИДІЇ ТЕХНІЧНІЙ РОЗВІДЦІ (RA-6)")
    desc("")

    param(:ra_6_odp_01, "Визначені місця для використання заходів ПДТР",
      type: :string,
      default: nil
    )
    ...
    param(:ra_6_odp_03, "Визначено частоту, з якою слід проводити заходи ПДТР (якщо обрано)",
      type: :integer,
      default: 30
    )
  ...
  control :"id-spe-ra-7" do
    title("РЕАГУВАННЯ НА РИЗИК (RA-7)")
    desc("Реагувати на результати оцінювання, моніторингу й аудиту безпеки та приватності.")
  ...
  control :"id-spe-sa-3-2" do
    title("ЖИТТЄВИЙ ЦИКЛ РЕАЛЬНИХ ДАНИХ (SA-3(2))")
    desc("")

    param(:sa_3_2_01, "ЖИТТЄВИЙ ЦИКЛ РЕАЛЬНИХ ДАНИХ РОЗРОБКИ СИСТЕМИ - ВИКОРИСТАННЯ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-3-3" do
  ...
  control :"id-spe-sa-4-2" do
    title("ПРОЦЕС ЗАКУПІВЕЛЬ - РОЗРОБКА ТА ВПРОВАДЖЕННЯ ІНФОРМАЦІЇ ДЛЯ ЗАХОДІВ (SA-4(2))")
    desc("")

    param(:sa_4_2_01, "ПРОЦЕС ЗАКУПІВЕЛЬ - РОЗРОБКА ТА ВПРОВАДЖЕННЯ ІНФОРМАЦІЇ ДЛЯ ЗАХОДІВ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-4-3" do
    title("ПРОЦЕС ЗАКУПІВЕЛЬ РОЗРОБКИ (SA-4(3))")
    desc("")

    param(:sa_4_3_01, "ПРОЦЕС ЗАКУПІВЕЛЬ РОЗРОБКИ - МЕТОДИ, ТЕХНІКИ ТА ПРАКТИКИ",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  ...
  control :"id-spe-sa-4-5" do
    title("ПРОЦЕС ЗАКУПІВЕЛЬ - КОНФІГУРАЦІЇ СИСТЕМИ, КОМПОНЕНТА ТА СИСТЕМНОЇ СЛУЖБИ (SA-4(5))")
    desc("")

    param(:sa_4_5_01, "ПРОЦЕС ЗАКУПІВЕЛЬ - КОНФІГУРАЦІЇ СИСТЕМИ, КОМПОНЕНТА ТА СИСТЕМНОЇ СЛУЖБИ",
      type: :string,
      default: nil
    )
    ...
    param(:sa_4_5_odp, "Визначено конфігурації безпеки для системи, компонента або служби",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-4-6" do
    title("ПРОЦЕС ЗАКУПІВЕЛЬ ІНФОРМАЦІЇ (SA-4(6))")
    desc("")

    param(:sa_4_6_01, "ПРОЦЕС ЗАКУПІВЕЛЬ ІНФОРМАЦІЇ - ВИКОРИСТАННЯ ЗАСОБІВ ЗАХИСТУ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-4-7" do
    title("ПРОЦЕС ЗАКУПІВЕЛЬ - ЗАТВЕРДЖЕНІ ПРОФІЛІ ЗАХИЩЕНОСТІ (SA-4(7))")
    desc("")

    param(:sa_4_7_01, "ПРОЦЕС ЗАКУПІВЕЛЬ - ЗАТВЕРДЖЕНІ ПРОФІЛІ ЗАХИЩЕНОСТІ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-5-5" do
    title("СИСТЕМНА ДОКУМЕНТАЦІЯ - ВИХІДНИЙ КОД (SA-5(5))")
    desc("")

    param(:sa_5_5_01, "СИСТЕМНА ДОКУМЕНТАЦІЯ - ВИХІДНИЙ КОД [Вилучено: включено до SA-4(2)]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-6" do
  ...
  control :"id-spe-sa-8" do
    ...
    param(:sa_8_odp_01, "Визначені принципи інжинірингу безпеки систем",
      type: :string,
      default: nil
    )

    param(:sa_8_odp_02, "Визначені системи", type: :string, default: nil)
  end

  control :"id-spe-sa-8-1" do
    title("БЕЗПЕКА ТА ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ - ЧІТКА АБСТРАКЦІЯ (SA-8(1))")
    desc("")

    param(:sa_8_1_01, "БЕЗПЕКА ТА ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ - ЧІТКА АБСТРАКЦІЯ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-8-2" do
    ...
    param(:sa_8_2_odp, "Реалізовано абстракцій. принцип проектування безпеки чітких",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-8-3" do
  ...
  control :"id-spe-sa-8-25" do
    ...
    param(:sa_8_25_01, "Системи або компоненти реалізують принцип безпеки економіки. які системи",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-8-33" do
    ...
    param(:sa_8_33_01, "БЕЗПЕКА ТА МІНІМІЗАЦІЯ ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ -",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-9-5" do
    ...
    param(:sa_9_5_01, "ЗОВНІШНІ ПОСЛУГИ ДЛЯ СИСТЕМИ- МІСЦЕ ОБРОБКИ, ЗБЕРІГАННЯ ТА ОБСЛУГОВУВАННЯ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-9-6" do
  ...
  control :"id-spe-sa-10" do
    ...
    param(:sa_10_odp_02, "Визначено елементи конфігурації під керуванням",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-10-1" do
    title(
  ...
  control :"id-spe-sa-11" do
    ...
    param(:sa_11_01, "УПРАВЛІННЯ КОНФІГУРАЦІЄЮ РОЗРОБНИКА - ПРЕДСТАВНИКИ БЕЗПЕКИ ТА ПРИВАТНОСТІ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-13" do
    title("ДОВІРЧІСТЬ (SA-13)")
    desc("")
    param(:sa_13_01, "ДОВІРЧІСТЬ [Вилучено: включено до SA-8]", type: :string, default: nil)
  end

  control :"id-spe-sa-14" do
  ...
  control :"id-spe-sa-15" do
    ...
    param(:sa_15_01, "ПРОЦЕСИ, СТАНДАРТИ ТА ІНСТРУМЕНТИ РОЗРОБКИ", type: :string, default: nil)
  ...
  control :"id-spe-sa-15-5" do
    ...
    param(:sa_15_5_odp, "Визначені порогові значення, до яких необхідно зменшити поверхню атаки",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sa-15-6" do
  ...
  control :"id-spe-sa-17" do
    ...
    param(:sa_17_01, "ПРОЄКТ ТА АРХІТЕКТУРА РОЗРОБНИКА БЕЗПЕКИ ТА ПРИВАТНОСТІ ДЛЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-20" do
    ...
    param(:sa_20_01, "Критична система повторно реалізувати або налаштувати на замовлення",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-21" do
    ...
    param(:sa_21_odp_02, "Визначені офіційні обов'язки, покладені на розробника",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sa-22" do
    ...
    param(:sa_22_01, "КОМПОНЕНТИ СИСТЕМИ, ЩО НЕ ПІДТРИМУЮТЬСЯ", type: :string, default: nil)
  ...
  control :"id-spe-sc-1" do
    ...
    param(:sc_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ЗАХИСТУ СИСТЕМИ ТА КОМУНІКАЦІЙ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-sc-2-2" do
    title("РОЗДІЛЕННЯ ФУНКЦІЙ - ВІДОКРЕМЛЕННЯ (SC-2(2))")
    desc("")

    param(:sc_2_2_01, "Зберігається інформація окремо від додатків та програмного забезпечення",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-3" do
    title("ІЗОЛЯЦІЯ ФУНКЦІЙ БЕЗПЕКИ (SC-3)")
    desc("")
    param(:sc_3_01, "Ізольовані функції безпеки від інших функцій", type: :string, default: nil)
  end

  control :"id-spe-sc-3-1" do
  ...
  control :"id-spe-sc-3-4" do
    title("ІЗОЛЯЦІЯ ФУНКЦІЙ ЗВ’ЯЗНІСТЬ (SC-3(4))")
    desc("")

    param(:sc_3_4_01, "ІЗОЛЯЦІЯ ФУНКЦІЙ ЗВ’ЯЗНІСТЬ БЕЗПЕКИ - З’ЄДНАННЯ МОДУЛІВ ТА",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-5" do
    ...
    param(:sc_5_01, "ЗАХИСТ ВІД АТАК «ВІДМОВА В ОБСЛУГОВУВАННІ»", type: :string, default: nil)
  ...
  control :"id-spe-sc-5-3" do
    title("ЗАХИСТ ВІД АТАК «ВІДМОВА В ОБСЛУГОВУВАННІ» - ВИЯВЛЕННЯ ТА МОНІТОРИНГ (SC-5(3))")
    desc("")

    param(:sc_5_3_01, "ЗАХИСТ ВІД АТАК «ВІДМОВА В ОБСЛУГОВУВАННІ» - ВИЯВЛЕННЯ ТА МОНІТОРИНГ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-7-2" do
    title("ЗАХИСТ ПЕРИМЕТРА - ПУБЛІЧНИЙ ДОСТУП (SC-7(2))")
    desc("")

    param(:sc_7_2_01, "ЗАХИСТ ПЕРИМЕТРА - ПУБЛІЧНИЙ ДОСТУП [Вилучено: включено до SC-7]]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-7-3" do
    title("ЗАХИСТ ПЕРИМЕТРА - ТОЧКИ ДОСТУПУ (SC-7(3))")
    desc("")

    param(:sc_7_3_01, "Обмежена кількість зовнішніх мережевих підключень до системи",
      type: :integer,
      default: 3
    )
  end

  control :"id-spe-sc-7-4" do
    ...
    param(:sc_7_4_b, "Встановлена політика потоку трафіку для кожного керованого інтерфейсу",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
    ...
    param(:sc_7_4_c_02, "Захищена цілісність інформації, що передається через кожен інтерфейс",
      type: :string,
      default: nil
    )
    ...
    param(:sc_7_4_e_01, "Переглядаються винятки з політики потоку трафіку частота",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
    ...
    param(:sc_7_4_f, "Запобігається несанкціонований обмін управління із зовнішніми мережами",
      type: :string,
      default: nil
    )
    ...
    param(:sc_7_4_h, "Фільтрується несанкціонований трафік з зовнішніх мереж. трафіком плану",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-7-5" do
    title("ЗАХИСТ ПЕРИМЕТРА - ВІДМОВА ЗА ЗАМОВЧУВАННЯМ - ДОЗВІЛ ЗА ВИНЯТКОМ (SC-7(5))")
    desc("")

    param(:sc_7_5_01, "ЗАХИСТ ПЕРИМЕТРА - ВІДМОВА ЗА ЗАМОВЧУВАННЯМ - ДОЗВІЛ ЗА ВИНЯТКОМ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-7-6" do
  ...
  control :"id-spe-sc-7-7" do
    ...
    param(:sc_7_7_odp, "Визначені гарантії безпечного прокладання розділеному тунелюванню",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-7-8" do
  ...
  control :"id-spe-sc-7-9" do
    title("ЗАХИСТ (SC-7(9))")
    desc("")

    param(:sc_7_9_01, "ЗАХИСТ ПЕРИМЕТРА - ОБМЕЖЕННЯ ТРАФІКУ ВИХІДНИХ ПОВІДОМЛЕНЬ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-8-1" do
    title("КОНФІДЕНЦІЙНІСТЬ ТА КРИПТОГРАФІЧНИЙ ЗАХИСТ (SC-8(1))")
    desc("")

    param(:sc_8_1_01, "КОНФІДЕНЦІЙНІСТЬ ТА КРИПТОГРАФІЧНИЙ ЗАХИСТ ЦІЛІСНІСТЬ ПЕРЕДАЧІ -",
      type: :string,
      default: "AES-256-GCM"
    )
  ...
  control :"id-spe-sc-8-5" do
    title("КОНФІДЕНЦІЙНІСТЬ ТА СИСТЕМА РОЗПОДІЛУ (SC-8(5))")
    desc("")

    param(:sc_8_5_01, "КОНФІДЕНЦІЙНІСТЬ ТА СИСТЕМА РОЗПОДІЛУ ЦІЛІСНІСТЬ ПЕРЕДАЧІ - ЗАХИЩЕНА",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-9" do
    title("КОНФІДЕНЦІЙНІСТЬ ПЕРЕДАЧІ (SC-9)")
    desc("")

    param(:sc_9_01, "КОНФІДЕНЦІЙНІСТЬ ПЕРЕДАЧІ [Вилучено: включено до SC-8]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-10" do
  ...
  control :"id-spe-sc-11" do
    ...
    param(:sc_11_01, "ДОВІРЕНИЙ КАНАЛ ЗВ’ЯЗКУ", type: :string, default: nil)

    param(:sc_11_odp_01, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРІВ: {фізично; логічно}",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-12" do
  ...
  control :"id-spe-sc-13" do
    ...
    param(:sc_13_01, "КРИПТОГРАФІЧНИЙ ЗАХИСТ МЕТА ОЦІНКИ: Визначити, чи:",
      type: :string,
      default: "AES-256-GCM"
    )

    param(:sc_13_odp_01, "Визначено використання криптографічних засобів",
      type: :string,
      default: "AES-256-GCM"
    )
  ...
  control :"id-spe-sc-16" do
    ...
    param(:sc_16_01, "Пов'язані атрибути інформацією, якою обмінюються системи; безпеки з",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
    ...
    param(:sc_16_03, "Пов'язані атрибути приватності інформацією, якою обмінюються системи; з",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-sc-20" do
    ...
    param(:sc_20_01, "БЕЗПЕЧНА СЛУЖБА ІМЕН, АДРЕС (УПОВНОВАЖЕНЕ ДЖЕРЕЛО)",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-21" do
    title(
  ...
  control :"id-spe-sc-23" do
    title("АВТЕНТИФІКАЦІЯ СЕСІЇ (SC-23)")
    desc("")
    param(:sc_23_01, "Захищено автентифікацію сеансів зв'язку", type: :string, default: nil)
  end

  control :"id-spe-sc-24" do
    ...
    param(:sc_24_odp_03, "Потрібно зберігати інформацію про стан системи у випадку її збою",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-25" do
    ...
    param(:sc_25_01, "Використовується мінімальна функціональність для компонентів системи",
      type: :string,
      default: nil
    )

    param(:sc_25_02, "Виділено мінімальне сховище інформації на компоненти системи",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-27" do
    ...
    param(:sc_27_01, "Включені незалежні від платформи додатки в системи організації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-28" do
    ...
    param(:sc_28_odp_02, "Є інформація в стані спокою, яка потребує захисту",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-29" do
  ...
  control :"id-spe-sc-30" do
    ...
    param(:sc_30_odp_03, "Визначені часові періоди для маскування та хибного напряму",
      type: :integer,
      default: 30
    )
  end

  control :"id-spe-sc-31" do
  ...
  control :"id-spe-sc-32" do
    ...
    param(:sc_32_odp_02, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРА: {фізичний; логічний}",
      type: :string,
      default: nil
    )

    param(:sc_32_odp_03, "Визначені обставини для розділення компонентів",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-33" do
    title("ПІДГОТОВКА ЦІЛІСНОСТІ ПЕРЕДАЧІ (SC-33)")
    desc("")

    param(:sc_33_01, "ПІДГОТОВКА ЦІЛІСНОСТІ ПЕРЕДАЧІ [Вилучено: включено до SC-8]",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-34" do
  ...
  control :"id-spe-sc-39" do
    title("ІЗОЛЯЦІЯ ПРОЦЕСУ (SC-39)")
    desc("Підтримувати окремий домен виконання для кожного процесу, що виконується в системі.")
  ...
  control :"id-spe-sc-41" do
    ...
    param(:sc_41_01, "ДОСТУП ДО ПОРТІВ ТА ПРИСТРОЇВ ВВЕДЕННЯ, ВИВЕДЕННЯ",
      type: :string,
      default: nil
    )
    ...
    param(:sc_41_odp_02, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРІВ: {фізично; логічно}",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sc-42" do
    ...
    param(:sc_42_01, "Механізми, що перешкоджають МОЖЛИВОСТІ ДАТЧИКА ТА ДАНІ",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  ...
  control :"id-spe-sc-45" do
    title("СИНХРОНІЗАЦІЯ СИСТЕМИ З ЧАСОМ (SC-45)")
    desc("системи і між ними.")
  ...
  control :"id-spe-sc-46" do
    ...
    param(:sc_46_odp, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРІВ: {фізично; логічно}",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sc-47" do
  ...
  control :"id-spe-sc-48" do
    ...
    param(:sc_48_odp_02, "Визначені місця, куди будуть переміщені датчики та засоби моніторингу",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  ...
  control :"id-spe-si-2-3" do
    ...
    param(:si_2_3_odp, "Визначені контрольні коригувальних заходів; показники для вжиття",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-2-4" do
    title("ВИПРАВЛЕННЯ ДЕФЕКТІВ - АВТОМАТИЧНІ ЗАСОБИ УПРАВЛІННЯ ВИПРАВЛЕННЯМИ (SI-2(4))")
    desc("")

    param(:si_2_4_01, "ВИПРАВЛЕННЯ ДЕФЕКТІВ - АВТОМАТИЧНІ ЗАСОБИ УПРАВЛІННЯ ВИПРАВЛЕННЯМИ",
      type: :string,
      default: "автоматизований засіб моніторингу"
    )
  ...
  control :"id-spe-si-3-5" do
    title("ЗАХИСТ ВІД ШКІДЛИВОГО ЗБЕРІГАННЯ ДАНИХ (SI-3(5))")
    desc("")

    param(:si_3_5_01, "ЗАХИСТ ВІД ШКІДЛИВОГО ЗБЕРІГАННЯ ДАНИХ [Вилучено: включено до MP-7]. КОДУ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-3-6" do
    ...
    param(:si_3_6_b_01, "Відбувається виявлення (доброякісний тест) коду",
      type: :string,
      default: nil
    )

    param(:si_3_6_b_02, "Відбувається відповідне звітування про інцидент",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-3-8" do
    title("ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - ВИЯВЛЕННЯ НЕАВТОРИЗОВАНИХ КОМАНД (SI-3(8))")
    desc("")

    param(:si_3_8_01, "ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - ВИЯВЛЕННЯ НЕАВТОРИЗОВАНИХ КОМАНД",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-3-10" do
    title("ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - АНАЛІЗ ШКІДЛИВОГО КОДУ (SI-3(10))")
    desc("")

    param(:si_3_10_01, "ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - АНАЛІЗ ШКІДЛИВОГО КОДУ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-4-4" do
    title("МОНІТОРИНГ СИСТЕМИ КОМУНІКАЦІЙ (SI-4(4))")
    desc("")

    param(:si_4_4_01, "МОНІТОРИНГ СИСТЕМИ КОМУНІКАЦІЙ - ТРАФІК ВХІДНИХ І ВИХІДНИХ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-4-7" do
    title("МОНІТОРИНГ СИСТЕМИ ПІДОЗРІЛІ ПОДІЇ (SI-4(7))")
    desc("")

    param(:si_4_7_01, "МОНІТОРИНГ СИСТЕМИ ПІДОЗРІЛІ ПОДІЇ - АВТОМАТИЧНЕ РЕАГУВАННЯ НА",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
    ...
    param(:si_4_7_b, "Вживаються найменш руйнівні дії при виявленні підозрілих подій",
      type: :list,
      default: ["login", "logout", "failed_attempt"]
    )
  end

  control :"id-spe-si-4-8" do
  ...
  control :"id-spe-si-4-13" do
    title("МОНІТОРИНГ СИСТЕМИ - АНАЛІЗ ТРАФІКУ ТА ШАБЛОНІВ ПОДІЙ (SI-4(13))")
    desc("")

    param(:si_4_13_01, "МОНІТОРИНГ СИСТЕМИ - АНАЛІЗ ТРАФІКУ ТА ШАБЛОНІВ ПОДІЙ",
      type: :string,
      default: nil
    )

    param(:si_4_13_a_01, "Аналізується трафік для системи", type: :string, default: nil)
    param(:si_4_13_a_02, "Проаналізовано патерни подій для системи", type: :string, default: nil)

    param(:si_4_13_b_01, "Розроблені профілі, що представляють загальний трафік",
      type: :string,
      default: nil
    )

    param(:si_4_13_b_02, "Розроблені профілі, що представляють патерни подій",
      type: :string,
      default: nil
    )

    param(:si_4_13_c_01, "Використовуються профілі трафіку пристроїв системного моніторингу",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-4-15" do
    title("МОНІТОРИНГ СИСТЕМИ - ПЕРЕХІД ВІД БЕЗДРОТОВОГО ЗВ’ЯЗКУ ДО ПРОВІДНИХ МЕРЕЖ (SI-4(15))")
    desc("")

    param(:si_4_15_01, "МОНІТОРИНГ СИСТЕМИ - ПЕРЕХІД ВІД БЕЗДРОТОВОГО ЗВ’ЯЗКУ ДО ПРОВІДНИХ МЕРЕЖ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-4-16" do
  ...
  control :"id-spe-si-4-20" do
    ...
    param(:si_4_20_odp, "Визначено додатковий користувачів; моніторинг",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-4-21" do
  ...
  control :"id-spe-si-4-22" do
    title("МОНІТОРИНГ СИСТЕМИ - НЕСАНКЦІОНОВАНІ ПОСЛУГИ МЕРЕЖІ (SI-4(22))")
    desc("")

    param(:si_4_22_01, "МОНІТОРИНГ СИСТЕМИ - НЕСАНКЦІОНОВАНІ ПОСЛУГИ МЕРЕЖІ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-4-24" do
    title("МОНІТОРИНГ СИСТЕМИ - ІНДИКАТОРИ КОМПРОМЕТАЦІЇ (SI-4(24))")
    desc("")

    param(:si_4_24_01, "Виявлено індикатори компрометації, 04(24)_ODP[01] джерелами>",
      type: :string,
      default: nil
    )

    param(:si_4_24_02, "Збираються індикатори компрометації, що надаються джерелами",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-5" do
    title("ПОПЕРЕДЖЕННЯ, РЕКОМЕНДАЦІЇ ТА ДИРЕКТИВИ З БЕЗПЕКИ (SI-5)")
    desc("")

    param(:si_5_01, "ПОПЕРЕДЖЕННЯ, РЕКОМЕНДАЦІЇ ТА ДИРЕКТИВИ З БЕЗПЕКИ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-6-3" do
    ...
    param(:si_6_3_01, "Повідомляються результати перевірки функцій безпеки персоналу або ролям",
      type: :list,
      default: ["admin", "security_officer"]
    )
  ...
  control :"id-spe-si-7-7" do
    ...
    param(:si_7_7_odp, "Визначені зміни в системі, що мають відношення до безпеки",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-7-8" do
    title(
  ...
  control :"id-spe-si-8" do
    title("ЗАХИСТ ВІД СПАМУ (SI-8)")
    desc("")
  end

  control :"id-spe-si-8-1" do
  ...
  control :"id-spe-si-8-2" do
    title("ЗАХИСТ ВІД СПАМУ - АВТОМАТИЧНІ ОНОВЛЕННЯ (SI-8(2))")
    desc("")

    param(:si_8_2_01, "Автоматично оновлюються механізми захисту від спаму частота",
      type: :string,
      default: "щорічно"
    )
  ...
  control :"id-spe-si-9" do
    title("ОБМЕЖЕННЯ НА ВВЕДЕННЯ ІНФОРМАЦІЇ (SI-9)")
    desc("")
  end

  control :"id-spe-si-10" do
    title("ПЕРЕВІРКА ВВОДУ ІНФОРМАЦІЇ (SI-10)")
    desc("інформація].")

    param(:si_10_01, "Перевіряється дійсність синтаксису вхідної інформації",
      type: :string,
      default: nil
    )

    param(:si_10_odp, "Визначено вхідні дані до системи, які перевірки достовірності; потребують",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-10-1" do
    title("ПЕРЕВІРКА ВВОДУ ПЕРЕВИЗНАЧЕННЯ (SI-10(1))")
    desc("")

    param(:si_10_1_01, "ПЕРЕВІРКА ВВОДУ ПЕРЕВИЗНАЧЕННЯ ІНФОРМАЦІЇ - МОЖЛИВІСТЬ РУЧНОГО",
      type: :string,
      default: nil
    )
    ...
    param(:si_10_1_c, "Проводиться аудит перевизначення. використання можливості для ручного",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-10-2" do
    title("ПЕРЕВІРКА ВВОДУ ІНФОРМАЦІЇ ПОМИЛОК (SI-10(2))")
    desc("")

    param(:si_10_2_01, "Переглядаються помилки валідації вхідних даних протягом часового періоду",
      type: :integer,
      default: 30
    )
  ...
  control :"id-spe-si-10-3" do
    title("ПЕРЕВІРКА ВВОДУ ІНФОРМАЦІЇ - ПЕРЕДБАЧУВАНА ПОВЕДІНКА (SI-10(3))")
    desc("")

    param(:si_10_3_01, "ПЕРЕВІРКА ВВОДУ ІНФОРМАЦІЇ - ПЕРЕДБАЧУВАНА ПОВЕДІНКА",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-12-1" do
    ...
    param(:si_12_1_odp, "Визначені елементи персональних даних у життєвому циклі інформації",
      type: :list,
      default: ["admin", "security_officer"]
    )
  end

  control :"id-spe-si-12-2" do
    title(
  ...
  control :"id-spe-si-13-5" do
    title("ЗАПОБІГАННЯ ПЕРЕДБАЧУВАНИХ АВАРІЙНОГО ПЕРЕМИКАННЯ (SI-13(5))")
    desc("")

    param(:si_13_5_01, "ЗАПОБІГАННЯ ПЕРЕДБАЧУВАНИХ АВАРІЙНОГО ПЕРЕМИКАННЯ ЗБОЇВ - МОЖЛИВІСТЬ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-14" do
  ...
  control :"id-spe-si-14-2" do
    title("НЕСТІЙКІСТЬ - НЕСТІЙКА ІНФОРМАЦІЯ (SI-14(2))")
    desc("")

    param(:si_14_2_b, "Видаляється інформація, коли вона більше не потрібна",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-14-3" do
    title("НЕСТІЙКІСТЬ - НЕСТІЙКІ ПІДКЛЮЧЕННЯ (SI-14(3))")
    desc("")

    param(:si_14_3_01, "Встановлюються з'єднання з системою на вимогу",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-si-17" do
    ...
    param(:si_17_odp_01, "Визначені відмовостійкі процедури, пов'язані з умовами відмови",
      type: :string,
      default: nil
    )

    param(:si_17_odp_02, "Визначено перелік умов відмовостійких процедур",
      type: :list,
      default: []
    )
  end

  control :"id-spe-si-18" do
  ...
  control :"id-spe-si-18-2" do
    title("ОПЕРАЦІЇ ЗАБЕЗПЕЧЕННЯ ЯКОСТІ ДАНИХ - ТЕГУВАННЯ ДАНИХ (SI-18(2))")
    desc("")

    param(:si_18_2_01, "ОПЕРАЦІЇ ЗАБЕЗПЕЧЕННЯ ЯКОСТІ ДАНИХ - ТЕГУВАННЯ ДАНИХ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-si-18-3" do
    title("ОПЕРАЦІЇ ЗАБЕЗПЕЧЕННЯ ЯКОСТІ ДАНИХ - ЗБИРАННЯ (SI-18(3))")
    desc("")
  end

  control :"id-spe-si-18-4" do
  ...
  control :"id-spe-si-19-7" do
    title("ДЕІДЕНТИФІКАЦІЯ - ПЕРЕВІРЕНЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ (SI-19(7))")
    desc("")

    param(:si_19_7_01, "Виконується деідентифікація за допомогою перевірених алгоритмів",
      type: :string,
      default: "AES-256-GCM"
    )
  ...
  control :"id-spe-si-21" do
    ...
    param(:si_21_odp_01, "Визначена інформація, яку потрібно оновити",
      type: :string,
      default: nil
    )

    param(:si_21_odp_02, "Визначені частоти, інформацію", type: :integer, default: 30)
  end

  control :"id-spe-si-22" do
  ...
  control :"id-spe-si-23" do
    title("ФРАГМЕНТАЦІЯ ІНФОРМАЦІЇ (SI-23)")
    desc("")

    param(:si_23_odp_01, "Визначені обставини, інформації; які вимагають фрагментації",
      type: :string,
      default: nil
    )

    param(:si_23_odp_02, "Визначена інформація, яка підлягає фрагментації",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sr-1" do
    ...
    param(:sr_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ УПРАВЛІННЯ РИЗИКАМИ ЛАНЦЮГА ПОСТАЧАННЯ",
      type: :list,
      default: ["default_deny_rule", "abac_rule_1"]
    )
  ...
  control :"id-spe-sr-3-1" do
    title("КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - РІЗНІ БАЗИ ПОСТАЧАННЯ (SR-3(1))")
    desc("")

    param(:sr_3_1_01, "КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - РІЗНІ БАЗИ ПОСТАЧАННЯ",
      type: :string,
      default: nil
    )
  end

  control :"id-spe-sr-3-2" do
    title("КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - ОБМЕЖЕННЯ ШКОДИ (SR-3(2))")
    desc("")

    param(:sr_3_2_01, "КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - ОБМЕЖЕННЯ ШКОДИ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sr-8" do
    ...
    param(:sr_8_01, "Аналізу/тестування елементів, ПОВІДОМЛЕННЯ ПРО ПОРУШЕННЯ ЛАНЦЮГА ПОСТАЧАННЯ",
      type: :string,
      default: nil
    )
  ...
  control :"id-spe-sr-9" do
    title("ЗАХИСТ ВІД ЗЛОМУ ТА ВИЯВЛЕННЯ (SR-9)")
    desc("системи, системного компонента або системної служби.")
  ...
  control :"id-spe-sr-10" do
    ...
    param(:sr_10_odp_01, "Визначені системи або компоненти системи, які потребують перевірки",
      type: :string,
      default: nil
    )
