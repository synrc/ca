defmodule CA.Profile.Data do
  ...
  def spec(:"id-spe-ac-2-3") do
    %{
      id: :"id-spe-ac-2-3",
      description:
        "ЗАПИСІВ Автоматично деактивувати облікові записи коли: a) їх строк дії минув; b) вони більше не пов’язані з користувачем; c) вони порушують організаційну політику; d) вони були неактивними впродовж [Призначення: визначеного організацією періоду часу].",
      title: "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДЕАКТИВАЦІЯ ОБЛІКОВИХ ЗАПИСІВ (AC-2(3))",
      parameters: [
        {:ac_2_3_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДЕАКТИВАЦІЯ ОБЛІКОВИХ ЗАПИСІВ",
         [type: :string, default: nil]},
        {:ac_2_3_b,
  ...
  def spec(:"id-spe-ac-2-4") do
    %{
      ...
      parameters: [
        {:ac_2_4_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДІЇ ПРИ АВТОМАТИЗОВАНОМУ АУДИТІ",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
  ...
  def spec(:"id-spe-ac-2-6") do
    %{
      ...
      parameters: [
        {:ac_2_6_01, "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ДИНАМІЧНЕ УПРАВЛІННЯ ПРИВІЛЕЯМИ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-ac-2-9") do
    %{
      ...
      parameters: [
        {:ac_2_9_01,
         "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ОБМЕЖЕННЯ НА ВИКОРИСТАННЯ СПІЛЬНИХ ТА ГРУПОВИХ ОБЛІКОВИХ ЗАПИСІВ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-ac-2-10") do
    %{
      ...
      description: "",
      title:
        "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - ЗМІНА ДАНИХ СПІЛЬНИХ І ГРУПОВИХ ОБЛІКОВИХ ЗАПИСІВ (AC-2(10))",
      parameters: [
        {:ac_2_10_01,
  ...
  def spec(:"id-spe-ac-2-12") do
    %{
      ...
      parameters: [
        {:ac_2_12_01,
         "УПРАВЛІННЯ ОБЛІКОВИМИ ЗАПИСАМИ - МОНІТОРИНГ НЕТИПОВОГО ВИКОРИСТАННЯ ОБЛІКОВИХ ЗАПИСІВ",
         [type: :string, default: nil]},
        {:ac_2_12_a,
  ...
  def spec(:"id-spe-ac-3-7") do
    %{
      id: :"id-spe-ac-3-7",
      description:
        "РОЛЕЙ Застосовувати політику управління доступом на основі ролей щодо визначених суб’єктів і об’єктів та управління доступом на основі [Призначення: визначених організацією ролей та користувачів, уповноважених приймати такі ролі].",
  ...
  def spec(:"id-spe-ac-3-9") do
    %{
      ...
      parameters: [
        {:ac_3_9_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - КЕРОВАНА ПЕРЕДАЧА (ПУБЛІКАЦІЯ) ІНФОРМАЦІЇ",
         [type: :string, default: nil]},
        {:ac_3_9_a,
  ...
  def spec(:"id-spe-ac-3-11") do
    %{
      ...
      parameters: [
        {:ac_3_11_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - ОБМЕЖЕННЯ ДОСТУПУ ДО СПЕЦІАЛЬНОЇ ІНФОРМАЦІЇ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-3-12") do
    %{
      ...
      parameters: [
        {:ac_3_12_01,
         "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - ВСТАНОВЛЕННЯ ТА ЗАБЕЗПЕЧЕННЯ ДОСТУПУ ДО ЗАСТОСУНКІВ",
         [type: :string, default: nil]},
        {:ac_3_12_a,
        ...
        {:ac_3_12_b,
         ...
         [type: :string, default: nil]},
        {:ac_3_12_c, "Зміни доступу після первинної інсталяції програми схвалено. для",
         [type: :string, default: nil]},
        {:ac_3_12_odp,
  ...
  def spec(:"id-spe-ac-3-13") do
    %{
      ...
      parameters: [
        {:ac_3_13_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - УПРАВЛІННЯ ДОСТУПОМ НА ОСНОВІ АТРИБУТІВ",
         [type: :string, default: nil]},
        {:ac_3_13_1,
  ...
  def spec(:"id-spe-ac-3-15") do
    %{
      id: :"id-spe-ac-3-15",
      description:
        "ДОСТУП (a) Застосовувати [Призначення: визначену організацією політику обов’язкового контролю доступу] до набору охоплених суб’єктів і об’єктів, указаних у політиці; (b) Застосування [Призначення: визначена організацією дискреційна політика контролю доступу] до набору охоплених суб’єктів і об’єктів, указаних у політиці.",
      title: "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - ДИСКРЕЦІЙНИЙ ТА ОБОВʼЯЗКОВИЙ ДОСТУП (AC-3(15))",
      parameters: [
        {:ac_3_15_01, "ЗАБЕЗПЕЧЕННЯ ДОСТУПУ - ДИСКРЕЦІЙНИЙ ТА ОБОВʼЯЗКОВИЙ ДОСТУП",
         [type: :string, default: nil]},
        {:ac_3_15_a_01,
  ...
  def spec(:"id-spe-ac-4-1") do
    %{
      id: :"id-spe-ac-4-1",
      description:
        "ОБ'ЄКТУ Використовувати [Призначення: визначені організацією атрибути безпеки], пов’язані з [Призначення: визначеними організацією інформацією, джерелами та об’єктами призначення], щоб запровадити [Призначення: визначену організацією політику управління потоками інформації] як основу для ухвалення рішень щодо управління потоками.",
  ...
  def spec(:"id-spe-ac-4-2") do
    %{
      id: :"id-spe-ac-4-2",
      description:
        "ДАНИХ Використовувати захищені домени обробки даних для забезпечення [Призначення: визначеної організацією політики управління потоками інформації] як основу для ухвалення рішень щодо управління потоками.",
  ...
  def spec(:"id-spe-ac-4-4") do
    %{
      ...
      parameters: [
        {:ac_4_4_01,
         "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - УПРАВЛІННЯ ПОТОКОМ ЗАШИФРОВАНОЇ ІНФОРМАЦІЇ",
         [type: :string, default: nil]},
        {:ac_4_4_odp_01,
  ...
  def spec(:"id-spe-ac-4-5") do
    %{
      id: :"id-spe-ac-4-5",
      description:
        "ДАНИХ Впровадити [Призначення: визначені організацією вбудовування типів даних в інші типи даних. обмеження] для",
      title: "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ВБУДОВУВАННЯ ТИПІВ ДАНИХ (AC-4(5))",
      parameters: [
        {:ac_4_5_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ВБУДОВУВАННЯ ТИПІВ ДАНИХ",
         [type: :string, default: nil]},
        {:ac_4_5_odp,
  ...
  def spec(:"id-spe-ac-4-8") do
    %{
      id: :"id-spe-ac-4-8",
      description:
        "БЕЗПЕКИ a) Забезпечити контроль над потоком інформації, використовуючи [Призначення: визначені організацією фільтри безпеки або політики конфіденційності] як основу для рішень щодо керування потоком для [Призначення: визначені організацією потоки інформації]; b) [Вибір (один або кілька): Блокування; Зміна; Карантин] даних після помилки обробки фільтра відповідно до [Призначення: політика безпеки або конфіденційності, визначена організацією].",
  ...
  def spec(:"id-spe-ac-4-11") do
    %{
      id: :"id-spe-ac-4-11",
      description:
        "– КОНФІГУРАЦІЯ Впровадити можливість для привілейованих адміністраторів налаштувати [Призначення: визначені організацією фільтри політики безпеки] для підтримки різних політик безпеки.",
      title:
  ...
  def spec(:"id-spe-ac-4-12") do
    %{
      ...
      parameters: [
        {:ac_4_12_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ІДЕНТИФІКАТОРИ ТИПУ ДАНИХ",
         [type: :string, default: nil]},
        {:ac_4_12_odp,
  ...
  def spec(:"id-spe-ac-4-16") do
    %{
      ...
      description: "",
      title:
        "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ПЕРЕДАЧА ІНФОРМАЦІЇ ПРО ВЗАЄМОПОВ’ЯЗАНІ СИСТЕМИ (AC-4(16))",
      parameters: [
        {:ac_4_16_01,
  ...
  def spec(:"id-spe-ac-4-21") do
    %{
      ...
      parameters: [
        {:ac_4_21_01,
         "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ФІЗИЧНЕ ТА ЛОГІЧНЕ ВІДДІЛЕННЯ ІНФОРМАЦІЙНИХ ПОТОКІВ",
         [type: :string, default: nil]},
        {:ac_4_21_02,
  ...
  def spec(:"id-spe-ac-4-23") do
    %{
      id: :"id-spe-ac-4-23",
      description:
        "ІНФОРМАЦІЯ, ЯКА НЕ ПІДЛЯГАЄ ОПРИЛЮДНЕННЮ Під час передачі інформації між різними доменами безпеки змінюйте інформацію, яка не підлягає оприлюдненню, реалізувавши [Призначення: визначена організацією дія модифікації]",
      title:
        "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - МОДИФІКОВАНА ІНФОРМАЦІЯ, ЯКА НЕ ПІДЛЯГАЄ ОПРИЛЮДНЕННЮ (AC-4(23))",
      parameters: [
        {:ac_4_23_01,
         "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - МОДИФІКОВАНА ІНФОРМАЦІЯ, ЯКА НЕ ПІДЛЯГАЄ ОПРИЛЮДНЕННЮ",
         [type: :string, default: nil]},
        {:ac_4_23_odp,
  ...
  def spec(:"id-spe-ac-4-24") do
    %{
      ...
      parameters: [
        {:ac_4_24_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ НОРМАЛІЗОВАНИЙ ФОРМАТ ПОТОКАМИ - ВНУТРІШНІЙ",
         [type: :string, default: nil]},
        {:ac_4_24_1,
  ...
  def spec(:"id-spe-ac-4-25") do
    %{
      ...
      parameters: [
        {:ac_4_25_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ОЧИЩЕННЯ ДАНИХ",
         [type: :string, default: nil]},
        {:ac_4_25_odp_01,
         ...
         [type: :string, default: nil]},
        {:ac_4_25_odp_02, "Визначено політику очищення даних",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-4-26") do
    %{
      id: :"id-spe-ac-4-26",
      description:
        "АУДИТУ Під час передачі інформації між різними доменами безпеки записуйте та перевіряйте дії фільтрації вмісту та результати для інформації, що фільтрується.",
  ...
  def spec(:"id-spe-ac-4-29") do
    %{
      ...
      parameters: [
        {:ac_4_29_01, "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ХАНІЗМІВ ОРКЕСТРОВКИ ПОТОКАМИ - ФІЛЬТР МЕ-",
         [type: :string, default: nil]},
        {:ac_4_29_a,
  ...
  def spec(:"id-spe-ac-4-31") do
    %{
      id: :"id-spe-ac-4-31",
      description:
        "ВМІСТУ, ЯКИЙ НЕ ПРОЙШОВ ПЕРЕВІРКУ ФІЛЬТРАЦІЇ Під час передачі інформації між різними доменами безпеки запобігайте передачі вмісту, який не пройшов перевірку фільтрації до домену-одержувача.",
      title:
        "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ЗАПОБІГАННЯ СПРОБАМ ПЕРЕДАЧІ ВМІСТУ, ЯКИЙ НЕ ПРОЙШОВ ПЕРЕВІРКУ ФІЛЬТРАЦІЇ (AC-4(31))",
      parameters: [
        {:ac_4_31_01,
         "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ЗАПОБІГАННЯ СПРОБАМ ПЕРЕДАЧІ ВМІСТУ, ЯКИЙ НЕ ПРОЙШОВ ПЕРЕВІРКУ ФІЛЬТРАЦІЇ",
  ...
  def spec(:"id-spe-ac-4-32") do
    %{
      ...
      parameters: [
        {:ac_4_32_01,
         "УПРАВЛІННЯ ІНФОРМАЦІЙНИМИ ПОТОКАМИ - ВИМОГИ ДО ПРОЦЕСУ ПЕРЕДАЧІ ІНФОРМАЦІЇ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-5") do
    %{
      ...
      parameters: [
        {:ac_5_01, "РОЗМЕЖУВАННЯ ОБОВ'ЯЗКІВ", [type: :string, default: nil]},
        {:ac_5_odp,
  ...
  def spec(:"id-spe-ac-6-1") do
    %{
      ...
      parameters: [
        {:ac_6_1_01, "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - АВТОРИЗОВАНИЙ ДОСТУП ДО ФУНКЦІЙ БЕЗПЕКИ",
         [type: :string, default: nil]},
        {:ac_6_1_a_01,
        ...
        {:ac_6_1_a_03,
         ...
         [type: :string, default: nil]},
        {:ac_6_1_b, "Авторизовано доступ для осіб та ролей до інформації",
         [type: :string, default: nil]},
        {:ac_6_1_odp_01,
  ...
  def spec(:"id-spe-ac-6-6") do
    %{
      id: :"id-spe-ac-6-6",
      description:
        "КОРИСТУВАЧАМИ, ЩО НЕ НАЛЕЖАТЬ ДО ОРГАНІЗАЦІЇ ДОСТУП Заборонити привілейований доступ до системи користувачам, які не належать до організації.",
      title:
        "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - ПРИВІЛЕЙОВАНИЙ ДОСТУП КОРИСТУВАЧАМИ, ЩО НЕ НАЛЕЖАТЬ ДО ОРГАНІЗАЦІЇ (AC-6(6))",
      parameters: [
        {:ac_6_6_01,
         "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - ПРИВІЛЕЙОВАНИЙ ДОСТУП КОРИСТУВАЧАМИ, ЩО НЕ НАЛЕЖАТЬ ДО ОРГАНІЗАЦІЇ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-6-7") do
    %{
      ...
      parameters: [
        {:ac_6_7_01, "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - ПЕРЕГЛЯД ПОВНОВАЖЕНЬ КОРИСТУВАЧА",
         [type: :string, default: nil]},
        {:ac_6_7_a,
  ...
  def spec(:"id-spe-ac-6-8") do
    %{
      id: :"id-spe-ac-6-8",
      description:
        "КОДУ Запобігати виконанню програмного забезпечення на рівні привілеїв вищому, ніж доступний користувачеві, який використовує програмне забезпечення [Призначення: визначене організацією програмне забезпечення].",
  ...
  def spec(:"id-spe-ac-6-9") do
    %{
      ...
      parameters: [
        {:ac_6_9_01, "МІНІМІЗАЦІЯ ПОВНОВАЖЕНЬ - АУДИТ ВИКОРИСТАННЯ ПРИВІЛЕЙОВАНИХ ФУНКЦІЙ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-7-1") do
    %{
      ...
      description: "",
      title:
        "НЕВДАЛІ СПРОБИ ВХОДУ В СИСТЕМУ - АВТОМАТИЧНЕ БЛОКУВАННЯ ОБЛІКОВОГО ЗАПИСУ (AC-7(1))",
      parameters: [
        {:ac_7_1_01,
  ...
  def spec(:"id-spe-ac-7-4") do
    %{
      ...
      parameters: [
        {:ac_7_4_01, "НЕВДАЛІ СПРОБИ ВХОДУ В СИСТЕМУ - ВИКОРИСТАННЯ АЛЬТЕРНАТИВНОГО ФАКТОРА",
         [type: :integer, default: 3]},
        {:ac_7_4_a,
  ...
  def spec(:"id-spe-ac-11-1") do
    %{
      ...
      description: "",
      title:
        "Управління обліковими записами — Динамічне управління привілеями Управління обліковими записами — Умови використання Управління паралельною сесією Управління паралельною сесією Блокування пристрою Блокування пристрою — Приховані дисплеї (AC-11(1))",
      parameters: [
        {:ac_11_1_01,
  ...
  def spec(:"id-spe-ac-13") do
    %{
      ...
      parameters: [
        {:ac_13_01, "НАГЛЯД ТА ОГЛЯД - УПРАВЛІННЯ ДОСТУПОМ [Вилучено: включено в АС-02 та АU-06]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-15") do
    %{
      ...
      parameters: [
        {:ac_15_01, "АВТОМАТИЗОВАНЕ МАРКУВАННЯ [Вилучено: включено до MP-03]",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:ac_16_odp_02,
         ...
         [type: :string, default: nil]},
        {:ac_16_odp_03, "Визначено значення атрибутів безпеки для типів атрибутів безпеки",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-16-1") do
    %{
      ...
      parameters: [
        {:ac_16_1_01, "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ДИНАМІЧНЕ ПОВ’ЯЗАННЯ АТРИБУТІВ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ac_16_1_02,
  ...
  def spec(:"id-spe-ac-16-2") do
    %{
      ...
      parameters: [
        {:ac_16_2_01,
         "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ЗМІНА ЗНАЧЕНЬ АТРИБУТІВ АВТОРИЗОВАНИМИ ОСОБАМИ",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ac_16_2_02,
  ...
  def spec(:"id-spe-ac-16-3") do
    %{
      ...
      parameters: [
        {:ac_16_3_01, "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ПІДТРИМКА СИСТЕМОЮ ПОВ’ЯЗАННЯ АТРИБУТІВ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
  ...
  def spec(:"id-spe-ac-16-4") do
    %{
      ...
      parameters: [
        {:ac_16_4_01,
         "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ПОВ’ЯЗАННЯ АТРИБУТІВ АВТОРИЗОВАНИМИ ОСОБАМИ",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ac_16_4_03,
  ...
  def spec(:"id-spe-ac-16-5") do
    %{
      ...
      parameters: [
        {:ac_16_5_01,
         "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ВІДОБРАЖЕННЯ АТРИБУТІВ НА ПРИСТРОЯХ ВИВЕДЕННЯ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ac_16_5_02,
  ...
  def spec(:"id-spe-ac-16-7") do
    %{
      ...
      parameters: [
        {:ac_16_7_01, "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - ПОСЛІДОВНА ІНТЕРПРЕТАЦІЯ АТРИБУТІВ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ac_16_7_02,
  ...
  def spec(:"id-spe-ac-16-10") do
    %{
      ...
      parameters: [
        {:ac_16_10_01,
         "АТРИБУТИ БЕЗПЕКИ ТА ПРИВАТНОСТІ - КОНФІГУРАЦІЯ АТРИБУТІВ УПОВНОВАЖЕНИМИ ОСОБАМИ",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ac_16_10_02,
  ...
  def spec(:"id-spe-ac-17-1") do
    %{
      ...
      parameters: [
        {:ac_17_1_01, "ВІДДАЛЕНИЙ ДОСТУП - АВТОМАТИЗОВАНИЙ МОНІТОРИНГ ТА УПРАВЛІННЯ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-ac-17-2") do
    %{
      ...
      parameters: [
        {:ac_17_2_01,
         "ВІДДАЛЕНИЙ ДОСТУП - ЗАХИСТ КОНФІДЕНЦІЙНОСТІ ТА ЦІЛІСНОСТІ ЗА ДОПОМОГОЮ ШИФРУВАННЯ МЕТА ОЦІНКИ: Визначте, чи інформаційна система криптографічні механізми для",
         [type: :string, default: "AES-256-GCM"]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-17-4") do
    %{
      ...
      parameters: [
        {:ac_17_4_01, "ВІДДАЛЕНИЙ ДОСТУП - ПРИВІЛЕЙОВАНІ КОМАНДИ ТА ДОСТУП",
         [type: :string, default: nil]},
        {:ac_17_4_a_01,
  ...
  def spec(:"id-spe-ac-17-10") do
    %{
      ...
      parameters: [
        {:ac_17_10_01, "Визначені механізми атентифіку- ють визначені віддалені команди",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:ac_17_10_odp_01,
    ...
    %{
      ...
      parameters: [
        ...
        {:ac_18_a_02,
         ...
         [type: :string, default: nil]},
        {:ac_18_a_03, "Встановлено доступу", [type: :string, default: nil]},
        {:ac_18_b,
  ...
  def spec(:"id-spe-ac-19-1") do
    %{
      ...
      description: "",
      title:
        "КОНТРОЛЬ ДОСТУПУ ДЛЯ МОБІЛЬНИХ ПРИСТРОЇВ - ВИКОРИСТАННЯ ПИСЬМОВИХ ТА ПОРТАТИВНИЙ ПРИСТРОЇВ ДЛЯ ЗБЕРІГАННЯ ДАНИХ (AC-19(1))",
      parameters: [
        {:ac_19_1_01,
  ...
  def spec(:"id-spe-ac-19-2") do
    %{
      ...
      description: "",
      title:
        "КОНТРОЛЬ ДОСТУПУ ДЛЯ МОБІЛЬНИХ ПРИСТРОЇВ - ВИКОРИСТАННЯ ПЕРСОНАЛЬНИХ ПОРТАТИВНИХ ПРИСТРОЇВ ЗБЕРІГАННЯ ДАНИХ (AC-19(2))",
      parameters: [
        {:ac_19_2_01,
  ...
  def spec(:"id-spe-ac-19-4") do
    %{
      ...
      parameters: [
        {:ac_19_4_01,
         "КОНТРОЛЬ ДОСТУПУ ДЛЯ МОБІЛЬНИХ ПРИСТРОЇВ - ОБМЕЖЕННЯ ДЛЯ ЗАСЕКРЕЧЕНОЇ ІНФОРМАЦІЇ",
         [type: :string, default: nil]},
        {:ac_19_4_a,
  ...
  def spec(:"id-spe-ac-19-5") do
    %{
      ...
      parameters: [
        {:ac_19_5_01,
         "КОНТРОЛЬ ДОСТУПУ ДЛЯ МОБІЛЬНИХ ПРИСТРОЇВ - ПОВНЕ ШИФРУВАННЯ ПРИСТРОЇВ ТА СХОВИЩ ІНФОРМАЦІЇ",
         [type: :string, default: "AES-256-GCM"]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-20-1") do
    %{
      ...
      parameters: [
        {:ac_20_1_01, "ВИКОРИСТАННЯ ЗОВНІШНІХ СИСТЕМ - ОБМЕЖЕННЯ НА АВТОРИЗОВАНЕ ВИКОРИСТАННЯ",
         [type: :string, default: nil]},
        {:ac_20_1_a,
  ...
  def spec(:"id-spe-ac-20-4") do
    %{
      ...
      parameters: [
        {:ac_20_4_01,
         "ВИКОРИСТАННЯ ЗОВНІШНІХ СИСТЕМ - ПРИСТРОЇ ДЛЯ ЗБЕРІГАННЯ ДАНИХ, ЯКІ МОЖУТЬ МАТИ ДОСТУП ДО МЕРЕЖІ",
         [type: :string, default: nil]},
        {:ac_20_4_b, "Заборонено використання заборонені типи зовнішніх систем (якщо застосовно)",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ac-21") do
    %{
      id: :"id-spe-ac-21",
      description:
        "a. Спростити обмін інформацією, надаючи авторизованим користувачам змогу визначати, чи відповідають повноваження на доступ, що призначені партнерам для обміну, обмеженням доступу та повноваженням з приватності щодо інформації для [Призначення: визначених організацією обставин обміну інформацією, коли це необхідно користувачу]. b. Використовувати [Призначення: визначені організацією автоматизовані механізми або ручні процеси], щоб допомогти користувачам в ухваленні рішень щодо обміну інформацією та співпраці.",
  ...
  def spec(:"id-spe-ac-24-2") do
    %{
      id: :"id-spe-ac-24-2",
      description:
        "ПРОЦЕСУ, ЩО ДІЄ ВІД ІМЕНІ КОРИСТУВАЧА Здійснювати ухвалення рішень щодо управління доступом, засновуючись на [Призначення: визначених організацією атрибутах безпеки], які не охоплюють ідентифікацію користувача або процесу, що діє від імені користувача.",
      title:
  ...
  def spec(:"id-spe-at-1") do
    %{
      ...
      parameters: [
        {:at_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ПІДВИЩЕННЯ ОБІЗНАНОСТІ ТА НАВЧАННЯ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-at-3-1") do
    %{
      ...
      description: "",
      title:
        "<AT-03(01)_ODP[01] персонал або ролі> забезпечується підвищенням кваліфікації в галузі зайнятості та функціонування заходів захисту робочого середовища з <AT03(01)_ODP[02] частотою>. (AT-3(1))",
      parameters: [
        {:at_3_1_01,
  ...
  def spec(:"id-spe-at-3-2") do
    %{
      ...
      title:
        "<AT-03(02)_ODP[01] персонал або ролі> забезпечуються підготовкою з питань застосування та експлуатації заходів (AT-3(2))",
      parameters: [
        {:at_3_2_01,
  ...
  def spec(:"id-spe-at-5") do
    %{
      ...
      parameters: [
        {:at_5_01, "КОНТАКТИ З ГРУПАМИ БЕЗПЕКИ ТА АСОЦІАЦІЯМИ Вилучено: включено в PM-15",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-at-6") do
    %{
      id: :"id-spe-at-6",
      description:
        "персоналу [Призначення: з визначеною організацією частотою та визначеному організацією персоналу]",
  ...
  def spec(:"id-spe-au-2-3") do
    %{
      ...
      parameters: [
        {:au_2_3_01, "ПОДІЇ АУДИТУ - ПЕРЕГЛЯД ТА ОНОВЛЕННЯ [Вилучено: Включено в АU-02]",
         [type: :list, default: ["login", "logout", "failed_attempt"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-au-2-4") do
    %{
      ...
      parameters: [
        {:au_2_4_01, "ПОДІЇ АУДИТУ - ПРИВІЛЕЙОВАНІ ФУНКЦІЇ [Вилучено: Включено в AC-06(09)]",
         [type: :list, default: ["login", "logout", "failed_attempt"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-au-3-2") do
    %{
      ...
      description: "",
      title:
        "ЗМІСТ ЗАПИСІВ АУДИТУ - ЦЕНТРАЛІЗОВАНЕ УПРАВЛІННЯ ПЛАНОВАНИМ ЗМІСТОМ ЗАПИСІВ АУДИТУ (AU-3(2))",
      parameters: [
        {:au_3_2_01,
  ...
  def spec(:"id-spe-au-3-3") do
    %{
      id: :"id-spe-au-3-3",
      description:
        "ДАНИХ Обмежити персональні дані, що міститься в записах аудиту, до таких елементів, які визначені в оцінці ризику приватності: [Призначення: визначені організацією елементи].",
  ...
  def spec(:"id-spe-au-5-4") do
    %{
      ...
      parameters: [
        {:au_5_4_01, "РЕАГУВАННЯ НА ВІДМОВИ ОБРОБКИ ДАНИХ АУДИТУ - ВИМКНЕННЯ У РАЗІ ВІДМОВИ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-au-6") do
    %{
      ...
      parameters: [
        {:au_6_01, "ОГЛЯД, АНАЛІЗ І ЗВІТНІСТЬ АУДИТУ МЕТА ОЦІНКИ: Визначити, чи:",
         [type: :string, default: nil]},
        {:au_6_a,
  ...
  def spec(:"id-spe-au-6-7") do
    %{
      ...
      parameters: [
        {:au_6_7_01, "ОГЛЯД, АНАЛІЗ І ЗВІТНІСТЬ АУДИТУ - ДОЗВОЛЕНІ ДІЇ",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:au_6_7_odp,
  ...
  def spec(:"id-spe-au-9") do
    %{
      ...
      parameters: [
        {:au_9_01, "ЗАХИСТ ІНФОРМАЦІЇ АУДИТУ МЕТА ОЦІНКИ: Визначити, чи:",
         [type: :string, default: nil]},
        {:au_9_a,
  ...
  def spec(:"id-spe-au-9-1") do
    %{
      ...
      parameters: [
        {:au_9_1_01, "Журнали аудиту записані на апаратні носії інформації з одноразовим записом",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-au-10-4") do
    %{
      ...
      parameters: [
        {:au_10_4_01, "НЕСПРОСТОВНІСТЬ - ВАЛІДАЦІЯ ЗВ'ЯЗКУ ІДЕНТИЧНОСТІ ПЕРЕГЛЯ- ДАЧА ІНФОРМАЦІЇ",
         [type: :string, default: nil]},
        {:au_10_4_a,
  ...
  def spec(:"id-spe-au-10-5") do
    %{
      ...
      parameters: [
        {:au_10_5_01, "НЕСПРОСТОВНІСТЬ - ЦИФРОВІ ПІДПИСИ [Вилучено: Включено до SI-07]",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:au_12_3_odp_01,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:au_12_3_odp_02, "Визначено компоненти системи, на яких має виконуватися аудит",
         [type: :string, default: nil]},
        {:au_12_3_odp_03, "Визначено критерії вибору подій", [type: :list, default: []]},
        {:au_12_3_odp_04, "Визначено часові пороги, в яких мають змінюватися аудит",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-au-13") do
    %{
      id: :"id-spe-au-13",
      description:
        "a. Моніторинг [Завдання: визначена організацією інформація з відкритих джерел та/або інформаційних сайтів] [Завдання: частота, визначена організацією] на наявність доказів неавторизованого розголошення конфіденційної інформації; b. Якщо виявлено розголошення інформації: 1. Повідомити [Призначення: персонал або ролі, визначені організацією]; 2. Виконайте такі додаткові дії: [Призначення: додаткові дії, визначені організацією].",
      ...
      parameters: [
        ...
        {:au_13_b_01,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:au_13_b_02, "Додаткові дії вживаються, якщо виявлено розголошення інформації",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:au_13_odp_01,
  ...
  def spec(:"id-spe-au-13-2") do
    %{
      id: :"id-spe-au-13-2",
      description:
        "САЙТІВ, ЩО Проводити огляд відкритих інформаційних сайтів, що підлягають моніторингу [Призначення: з визначеною організацією частотою].",
      title:
        "МОНІТОРИНГ РОЗКРИТТЯ ІНФОРМАЦІЇ - ОГЛЯД САЙТІВ, ЩО ПІДЛЯГАЮТЬ МОНІТОРИНГУ (AU-13(2))",
      parameters: [
        {:au_13_2_01, "МОНІТОРИНГ РОЗКРИТТЯ ІНФОРМАЦІЇ - ОГЛЯД САЙТІВ, ЩО ПІДЛЯГАЮТЬ МОНІТОРИНГУ",
         [type: :string, default: nil]},
        {:au_13_2_odp,
  ...
  def spec(:"id-spe-au-15") do
    %{
      ...
      parameters: [
        {:au_15_01, "АЛЬТЕРНАТИВНА МОЖЛИВІСТЬ АУДИТУ [Вилучено: Включено до AU-05(05)]",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:au_16_2_odp_01,
         ...
         [type: :string, default: nil]},
        {:au_16_2_odp_02, "Визначено міжорганізаційну угоду про розподіл",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ca-1") do
    %{
      ...
      parameters: [
        {:ca_1_01, "ПОЛІТИКА І ПРОЦЕДУРИ ОЦІНЮВАННЯ, АКРЕДИТАЦІЯ ТА МОНІТОРИНГ БЕЗПЕКИ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ca_1_a_01,
    ...
    %{
      ...
      parameters: [
        ...
        {:ca_2_b_01,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ca_2_b_02,
         "Розроблено план контрольної оцінки, який описує обсяг оцінки, включаючи процедури оцінювання, які використовуватимуться для визначення ефективності заходів. CA-02(b)[03][01] розроблено план контрольної оцінки, який описує обсяг оцінки, включаючи середовище оцінювання. CA-02(b)[03][02] розроблено план контрольної оцінки, який описує обсяг оцінки, включаючи групу оцінювання. CA-02(b)[03][03] розроблено план контрольної оцінки, який описує обсяг оцінки, включаючи ролі й обов’язки з оцінювання. Рисунок 5.5 – Вибір заходу захисту в групі Рисунок 5.6 – Виділення часткових заходів захисту Після цього необхідно переходити до іншого заходу захисту. В рамках заходу захисту в групі СА-2, наприклад, перейдемо до заходу захисту d. Виділяємо третій захід захисту в групі СА-2 (рисунок 5.7). Встановлюємо параметр на рівні трьох місяців. Параметр формулює завдання:  [1] Визначити частоту оцінювання заходів захисту в системі;  [2] Визначити частоту оцінювання заходів захисту в середовищі функціонування системи. Виділяємо завдання конкретного заходу захисту:  [3] Оцінити заходи захисту в системі;  [4] Оцінити заходи захисту в середовищі функціонування системи. Рисунок 5.7 – Виділення наступного заходу захисту При цьому, з Каталогу видно, що часткові заходи заходу відсутні. Таким чином, таблиця 5.3 доповнюється оцінюванням третього заходу захисту в групі СА-2 (таблиця 5.5). Аналогічно оцінювач / група оцінювачів розглядає кожен впроваджений захід захисту. Захід захисту вважається коректно реалізованим, якщо повністю реалізовані всі його елементи. В процесі оцінювання можуть бути використані наступні методи: дослідження, співбесіда або перевірка. Вибір методу та об’єктів залежить від конкретного заходу захисту. У таблиці 5.6 наведено приклади об’єктів та методи їх оцінювання. Таблиця 5.5 – Оцінювання третього заходу захисту в групі СА-2",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ca_2_c,
        ...
        {:ca_2_d_01,
         ...
         [type: :string, default: "щорічно"]},
        {:ca_2_d_02,
         "Заходи захисту оцінюються в системі та середовищі її функціонування частота оцінки, щоб визначити, наскільки коректно реалізовані заходи захисту, чи працюють вони за призначенням і чи дають бажаний результат щодо дотримання встановлених вимог до конфіденційності; Таблиця 5.6 – Потенційні об’єкти та методи оцінювання Метод Об’єкти Коментар оцінювання Дослідження Політики та процедури, Оцінювач має ознайомитися та вивчити об’єкт проєктна та супутня та прийняти вмотивоване рішення щодо документація, налаштування коректності реалізації відповідного заходу конфігурацій, журнали аудиту захисту. Рішення має бути відображене у звіті тощо оцінювача. Співбесіда Відповідальні посадові особи Оцінювач може проводити співбесіди із та уповноважений персонал залученими працівниками для кращого розуміння реалій впровадження заходів захисту. Рішення за результатами співбесіди має бути відображене у звіті оцінювача. Перевірка Автоматизовані механізми Оцінювач проводить тестові випробування автоматизованих механізмів. розгорнутих для забезпечення реалізації заходів захисту. Результати тестування мають бути відображені у звіті оцінювача. Результат оцінювання є позитивним у випадку коли в процесі оцінювання встановлена та підтверджена коректна реалізація кожного із впроваджених заходів захисту в ІС. Методика оцінювання груп заходів захисту, які містяться у каталозі відповідно до положень НД ТЗІ, який визначає порядок вибору заходів захисту, наведено у додатках А та Б цього НД ТЗІ. 5.2.4 Документування звітів з оцінювання впроваджених заходів захисту в ІС Результати оцінювання заходів захисту оформлюються у вигляді Звіту. В такому Звіті повинні міститися результати оцінювання впроваджених заходів захисту із позначенням документів, які підтверджують коректну та повну реалізацію заходів захисту. Результати оцінювання заходів захисту впливають на подальшу їхню реалізацію, зміст планів заходів захисту. Власники інформаційних систем мають переглядати звіти про результати оцінювання заходів захисту, а також оновлену оцінку ризиків та за згодою призначених посадових осіб організації (наприклад, адміністратор безпеки) визначати відповідні кроки, необхідні для реагування на ті слабкі місця та недоліки, які були виявлені під час оцінки. Після ознайомлення із результатними звіту про оцінювання заходів захисту, власники систем можуть вирішити, що певні висновки, є суттєвими, і вони вимагають негайних заходів з виправлення. І навпаки, проконсультувавшись із призначеними посадовими особами організації, можуть вирішити, що певні результати оцінки, мають несуттєвий характер і не становлять суттєвого ризику для організації. Організація може залучати більше одного оцінювача / групи оцінювачів для проведення оцінювання. В такому випадку необхідне окреме проведення аналізу результатів оцінювання кожного оцінювача / групи оцінювачів. Додаток А В додатку А подається зміст НД ТЗІ 2.3-025-24 Том 2 та НД ТЗІ 2.3-025-24 Том 3. I. КЛАС ЗАХОДІВ ЗАХИСТУ АС – УПРАВЛІННЯ ДОСТУПОМ………………..….19 II. КЛАС ЗАХОДІВ ЗАХИСТУ АТ – ОБІЗНАНІСТЬ ТА НАВЧАННЯ…………….…110 III. КЛАС ЗАХОДІВ ЗАХИСТУ АU – АУДИТ ТА ПІДЗВІТНІСТЬ……………............121 IV. КЛАС ЗАХОДІВ ЗАХИСТУ CA – ОЦІНЮВАННЯ, АКРЕДИТАЦІЯ ТА МОНІТОРИНГ…………………………………………………………………………..155 V. КЛАС ЗАХОДІВ ЗАХИСТУ CM – УПРАВЛІННЯ КОНФІГУРАЦІЄЮ…………...174 VI. КЛАС ЗАХОДІВ ЗАХИСТУ CP – ПЛАНУВАННЯ БЕЗПЕРЕРВНОЇ РОБОТИ…...218 VII. КЛАС ЗАХОДІВ ЗАХИСТУ IA – ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ……252 VIII. КЛАС ЗАХОДІВ ЗАХИСТУ IR – РЕАГУВАННЯ НА ІНЦИДЕНТИ……………….287 IX. КЛАС ЗАХОДІВ ЗАХИСТУ MA – ТЕХНІЧНЕ ОБСЛУГОВУВАННЯ…………….313 X. КЛАС ЗАХОДІВ ЗАХИСТУ MP – ЗАХИСТ НОСІЇВ ІНФОРМАЦІЇ…………….....334 КЛАС ЗАХОДІВ ЗАХИСТУ PE - ФІЗИЧНИЙ ЗАХИСТ ТА ЗАХИСТ РОБОЧОГО СЕРЕДОВИЩА…………………………………………………………………………351 XII. КЛАС ЗАХОДІВ ЗАХИСТУ PL – ПЛАНУВАННЯ БЕЗПЕКИ…………….………..387 XI. XIII. КЛАС ЗАХОДІВ ЗАХИСТУ PM – МЕНЕДЖМЕНТ ІНФОРМАЦІЙНОЇ БЕЗПЕКИ…………………………………………………………………………...……399 XIV. КЛАС ЗАХОДІВ ЗАХИСТУ PS – КАДРОВА БЕЗПЕКА…………………….…...….434 XV. КЛАС ЗАХОДІВ ЗАХИСТУ PT — ПОВНОВАЖЕННЯ НА ОБРОБКУ ПЕРСОНАЛЬНИХ ДАНИХ…………….…………….…………….…………….…………….………447 XVI. КЛАС ЗАХОДІВ ЗАХИСТУ RA – ОЦІНКА РИЗИКУ……………………….......…..463 XVII.КЛАС ЗАХОДІВ ЗАХИСТУ SA – ПРИДБАННЯ СИСТЕМИ ТА ПОСЛУГ….........479 XVIII. КЛАС ЗАХОДІВ ЗАХИСТУ SC – ЗАХИСТ ІНФОРМАЦІЙНОЇ СИСТЕМИ ТА КОМУНІКАЦІЇ………………………………………………………………………......568 XIX. КЛАС ЗАХОДІВ ЗАХИСТУ SI – ЦІЛІСНІСТЬ СИСТЕМИ ТА ІНФОРМАЦІЇ….....650 XX. КЛАС ЗАХОДІВ ЗАХИСТУ SR — УПРАВЛІННЯ РИЗИКАМИ ЛАНЦЮГА………723",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ca_2_f,
  ...
  def spec(:"id-spe-ca-2-2") do
    %{
      ...
      title:
        "<CA-02(02)_ODP[01] періодичність оцінювання> <CA02(02)_ODP[02] ВИБРАНЕ ЗНАЧЕННЯ ПАРАМЕТРА> <CA-02(02)_ODP[03] ВИБРАНЕ ЗНАЧЕННЯ ПАРАМЕТРА(ів)> включаються як частина оцінювання заходів безпеки та конфіденційності; (CA-2(2))",
      parameters: [
        {:ca_2_2_odp_01,
    ...
    %{
      ...
      parameters: [
        {:ca_3_b_01,
         ...
         [type: :integer, default: 30]},
        {:ca_3_b_02, "Вимоги до безпеки задокументовані як частина кожної угоди про обмін",
         [type: :integer, default: 30]},
        {:ca_3_b_03,
         "Вимоги щодо конфіденційності задокументовані як частина кожної угоди про обмін",
         [type: :integer, default: 30]},
        {:ca_3_b_04, "Заходи захисту задокументовані як частина кожної угоди про обмін",
         [type: :integer, default: 30]},
        {:ca_3_b_05,
        ...
        {:ca_3_b_06,
         ...
         [type: :integer, default: 30]},
        {:ca_3_c, "Угоди переглядаються та оновлюються частота",
         [type: :string, default: "щорічно"]},
        {:ca_3_odp_01,
        ...
        {:ca_3_odp_02,
         ...
         [type: :string, default: nil]},
        {:ca_3_odp_03, "Визначено частоту, з якою необхідно переглядати та оновлювати угоди",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ca-3-3") do
    %{
      ...
      description: "",
      title:
        "ВЗАЄМОДІЯ СИСТЕМ - НЕСЕКРЕТНІ З’ЄДНАННЯ СИСТЕМИ БЕЗПЕКИ, ЩО НЕ Є НАЦІОНАЛЬНИМИ (CA-3(3))",
      parameters: [
        {:ca_3_3_01,
  ...
  def spec(:"id-spe-ca-4") do
    %{
      ...
      parameters: [
        {:ca_4_01, "СЕРТИФІКАЦІЯ БЕЗПЕКИ [Вилучено: Включено до CA-02]",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:ca_6_d,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ca_6_e, "Акредитації оновлюються частота", [type: :string, default: "щорічно"]},
  ...
  def spec(:"id-spe-ca-6-1") do
    %{
      ...
      parameters: [
        {:ca_6_1_01, "АКРЕДИТАЦІЯ - СПІЛЬНА АКРЕДИТАЦІЯ - ОДНА І ТА САМА ОРГАНІЗАЦІЯ",
         [type: :string, default: nil]},
        {:ca_6_1_02,
  ...
  def spec(:"id-spe-ca-6-2") do
    %{
      ...
      parameters: [
        {:ca_6_2_01, "Для системи впроваджено спільний процес акредитації",
         [type: :string, default: nil]},
        {:ca_6_2_02,
    ...
    %{
      ...
      parameters: [
        ...
        {:ca_7_g_02,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ca_7_odp_01, "Визначено метрики системного рівня, які підлягають моніторингу",
         [type: :string, default: nil]},
        {:ca_7_odp_02, "Визначено частоту, з якою слід моніторити ефективність заходів захисту",
         [type: :integer, default: 30]},
        {:ca_7_odp_03, "Визначено частоту, з якою слід оцінювати ефективність заходів захисту",
         [type: :integer, default: 30]},
        {:ca_7_odp_04,
         "Визначено персонал або ролі, яким повідомляється про стан безпеки системи",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ca_7_odp_05, "Визначено частоту, з якою повідомляється про стан безпеки системи",
         [type: :integer, default: 30]},
        {:ca_7_odp_06,
  ...
  def spec(:"id-spe-ca-7-2") do
    %{
      ...
      parameters: [
        {:ca_7_2_01, "БЕЗПЕРЕРВНИЙ МОНІТОРИНГ - ВИДИ ОЦІНОК [Вилучено: Включено до CA-02]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ca-7-5") do
    %{
      ...
      parameters: [
        {:ca_7_5_01, "Дії використовуються для перевірки того, що політики встановлено",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ca_7_5_02,
         "Дії використовуються для перевірки того, що впроваджені заходи захисту працюють узгоджено",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:ca_7_5_odp_01, "Визначені дії для підтвердження того, що політики встановлені",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ca_7_5_odp_02,
  ...
  def spec(:"id-spe-ca-8") do
    %{
      ...
      parameters: [
        {:ca_8_01, "Проводиться тестування на проникнення з частотою у системі",
         [type: :integer, default: 30]},
        {:ca_8_odp_01, "Визначено частоту з якою проводить тестування на проникнення",
         [type: :integer, default: 30]},
        {:ca_8_odp_02, "Визначено систему у якій проводить тестування на проникнення",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ca-8-3") do
    %{
      ...
      parameters: [
        {:ca_8_3_01, "ТЕСТУВАННЯ НА ПРОНИКНЕННЯ - МОЖЛИВОСТІ ПЕРЕВІРКИ НА ПРОНИКНЕННЯ",
         [type: :string, default: nil]},
        {:ca_8_3_odp_01,
  ...
  def spec(:"id-spe-ca-9") do
    %{
      id: :"id-spe-ca-9",
      description:
        "a. Авторизувати внутрішні підключення [Призначення: системні компоненти або класи компонентів, що організація визначила] до системи; b. Задокументувати, для кожного внутрішнього з’єднання, характеристики інтерфейсу, вимоги безпеки та приватності, а також характер переданої інформації; c. Розірвати внутрішні системні підключення після [Призначення: умови, визначені організацією]; d. Переглядати [Призначення: частота, визначена організацією] постійну потребу в кожному внутрішньому з’єднанні.",
      title: "ВНУТРІШНІ З’ЄДНАННЯ СИСТЕМИ (CA-9)",
      parameters: [
        {:ca_9_01, "ВНУТРІШНІ З’ЄДНАННЯ СИСТЕМИ", [type: :string, default: nil]},
        {:ca_9_a, "Внутрішні підключення компонентів системи до системи є авторизовані",
         [type: :string, default: nil]},
        {:ca_9_b_01,
         "Для кожного внутрішнього з'єднання задокументовані характеристики інтерфейсу",
         [type: :string, default: nil]},
        {:ca_9_b_02, "Для кожного внутрішнього з'єднання задокументовані вимоги безпеки",
         [type: :string, default: nil]},
        {:ca_9_b_03, "Для кожного внутрішнього з'єднання задокументовані вимоги конфіденційності",
         [type: :string, default: nil]},
        {:ca_9_b_04,
         "Для кожного внутрішнього з'єднання задокументовані характер переданої інформації",
         [type: :string, default: nil]},
        {:ca_9_c, "Внутрішні з'єднання системи розриваються після виконання умов",
         [type: :string, default: nil]},
        {:ca_9_d, "Переглядається подальша потреба у кожному внутрішньому з'єднанні частота",
         [type: :string, default: "щорічно"]},
        {:ca_9_odp_01,
         "Визначено компоненти системи або класи компонентів, що потребують внутрішніх підключень до системи",
         [type: :string, default: nil]},
        {:ca_9_odp_02, "Визначено умови, за яких необхідно розірвати внутрішні підключення",
         [type: :list, default: []]},
        {:ca_9_odp_03,
  ...
  def spec(:"id-spe-cm-1") do
    %{
      ...
      parameters: [
        {:cm_1_a_01, "Розроблено та задокументовано політику управління конфігурацією",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cm_1_a_02, "Політика управління конфігурацією поширюється на персонал або ролі",
         [type: :list, default: ["admin", "security_officer"]]},
        {:cm_1_a_03,
  ...
  def spec(:"id-spe-cm-2") do
    %{
      ...
      parameters: [
        {:cm_2_a_01, "Розроблено та задокументовано поточні базові налаштування системи",
         [type: :string, default: nil]},
        {:cm_2_a_02,
         "Поточні базові налаштування системи підтримуються за допомогою заходів конфігурації",
         [type: :string, default: nil]},
        {:cm_2_b_01, "Переглядаються та оновлюються базові налаштування системи частота",
         [type: :string, default: "щорічно"]},
        {:cm_2_b_02, "Переглядаються та оновлюються базові налаштування системи після подій",
         [type: :string, default: nil]},
        {:cm_2_b_03,
         "Переглядаються та оновлюються базові налаштування системи коли встановлюються або модернізуються компоненти системи",
         [type: :string, default: nil]},
        {:cm_2_odp_01, "Визначено частоту налаштувань; перегляду та оновлення базових",
         [type: :integer, default: 30]},
        {:cm_2_odp_02,
  ...
  def spec(:"id-spe-cm-2-1") do
    %{
      ...
      parameters: [
        {:cm_2_1_01, "БАЗОВА КОНФІГУРАЦІЯ - ПЕРЕГЛЯД ТА ОНОВЛЕННЯ [Вилучено: Включено до CM-02]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-2-2") do
    %{
      ...
      parameters: [
        {:cm_2_2_01, "БАЗОВА КОНФІГУРАЦІЯ - АВТОМАТИЗАЦІЯ ПІДТРИМКИ ЗАДЛЯ ТОЧНОСТІ ТА ВЖИВАНОСТІ",
         [type: :string, default: nil]},
        {:cm_2_2_02,
  ...
  def spec(:"id-spe-cm-2-7") do
    %{
      ...
      parameters: [
        {:cm_2_7_01,
         "БАЗОВА КОНФІГУРАЦІЯ - КОНФІГУРАЦІЯ СИСТЕМ ТА КОМПОНЕНТІВ ДЛЯ СФЕР З ВИСОКИМ РИЗИКОМ",
         [type: :string, default: nil]},
        {:cm_2_7_a,
    ...
    %{
      ...
      parameters: [
        ...
        {:cm_3_e,
         ...
         [type: :integer, default: 30]},
        {:cm_3_f_01, "Здійснюється моніторинг конфігурації системи",
         [type: :string, default: nil]},
        {:cm_3_f_02, "Здійснюється аналіз дій, пов'язаних зі змінами конфігурації системи",
         [type: :string, default: nil]},
        {:cm_3_g_01,
  ...
  def spec(:"id-spe-cm-3-1") do
    %{
      ...
      parameters: [
        {:cm_3_1_01,
         "УПРАВЛІННЯ ЗМІНАМИ КОНФІГУРАЦІЇ - АВТОМАТИЗОВАНЕ ДОКУМЕНТУВАННЯ, ПОВІДОМЛЕННЯ ТА ЗАБОРОНА ВНЕСЕННЯ ЗМІН",
         [type: :string, default: nil]},
        {:cm_3_1_a,
  ...
  def spec(:"id-spe-cm-3-2") do
    %{
      ...
      parameters: [
        {:cm_3_2_01, "Зміни в системі тестуються перед повним впровадженням змін",
         [type: :string, default: nil]},
        {:cm_3_2_02, "Зміни в системі перевіряються перед повним впровадженням змін",
         [type: :string, default: nil]},
        {:cm_3_2_03, "Зміни в системі документуються перед повним впровадженням змін",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-3-5") do
    %{
      id: :"id-spe-cm-3-5",
      description:
        "БЕЗПЕКИ Реалізувати автоматичне [Призначення: визначене організацією реагування безпеки], якщо базова конфігурація системи змінюється несанкціонованим чином.",
    ...
    %{
      ...
      parameters: [
        {:cm_3_7_01,
         ...
         [type: :string, default: "щорічно"]},
        {:cm_3_7_odp_01, "Визначено частоту, з якою необхідно переглядати зміни",
         [type: :integer, default: 30]},
        {:cm_3_7_odp_02, "Визначено обставини, за яких зміни мають бути переглянуті",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-3-8") do
    %{
      ...
      parameters: [
        {:cm_3_8_01,
         "УПРАВЛІННЯ ЗМІНАМИ КОНФІГУРАЦІЇ - ЗАПОБІГАННЯ ЧИ ОБМЕЖЕННЯ ЗМІН КОНФІГУРАЦІЇ",
         [type: :string, default: nil]},
    ...
    %{
      ...
      parameters: [
        {:cm_4_1_01,
         ...
         [type: :string, default: nil]},
        {:cm_4_1_02, "Зміни в системі аналізуються на предмет впливу на безпеку через недоліки",
         [type: :string, default: nil]},
        {:cm_4_1_03,
         "Зміни в системі аналізуються на предмет впливу на конфіденційність через недоліки",
         [type: :string, default: nil]},
        {:cm_4_1_04, "Зміни в системі аналізуються на предмет впливу на безпеку через слабкості",
         [type: :string, default: nil]},
        {:cm_4_1_05,
    ...
    %{
      ...
      parameters: [
        {:cm_5_01,
         ...
         [type: :string, default: nil]},
        {:cm_5_02, "Затверджені фізичні обмеження доступу, пов'язані зі змінами в системі",
         [type: :string, default: nil]},
        {:cm_5_03, "Застосовуються фізичні обмеження доступу, пов'язані зі змінами в системі",
         [type: :string, default: nil]},
        {:cm_5_04,
         "Визначені та задокументовані логічні обмеження доступу, пов'язані зі змінами в системі",
         [type: :string, default: nil]},
        {:cm_5_05, "Затверджені логічні обмеження доступу, пов'язані зі змінами в системі",
         [type: :string, default: nil]},
        {:cm_5_06, "Застосовуються логічні обмеження доступу, пов'язані зі змінами в системі",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-5-1") do
    %{
      ...
      parameters: [
        {:cm_5_1_01, "ОБМЕЖЕННЯ ДОСТУПУ ДО ЗМІНИ - АУДИТ І ЗДІЙСНЕННЯ АВТОМАТИЧНОГО ДОСТУПУ",
         [type: :string, default: nil]},
        {:cm_5_1_a,
  ...
  def spec(:"id-spe-cm-5-4") do
    %{
      ...
      parameters: [
        {:cm_5_4_01, "Запроваджено подвійну авторизацію для внесення змін до компонентів системи",
         [type: :string, default: nil]},
        {:cm_5_4_02, "Запроваджено подвійну авторизацію для внесення змін до інформації",
         [type: :string, default: nil]},
        {:cm_5_4_odp_01,
  ...
  def spec(:"id-spe-cm-5-5") do
    %{
      ...
      parameters: [
        {:cm_5_5_01,
         "ОБМЕЖЕННЯ ДОСТУПУ ДО ЗМІНИ - ОБМЕЖЕННЯ ПОВНОВАЖЕНЬ ДЛЯ ВИРОБНИЦТВА ТА ЕКСПЛУАТАЦІЇ",
         [type: :string, default: nil]},
        {:cm_5_5_a_01,
        ...
        {:cm_5_5_a_02,
         ...
         [type: :string, default: nil]},
        {:cm_5_5_b_01, "Переглядаються частота>", [type: :string, default: "щорічно"]},
        {:cm_5_5_b_02, "Переоцінюються повноваження частота; повноваження <CM-05(05)_ODP[01]",
         [type: :string, default: "щорічно"]},
        {:cm_5_5_odp_01, "Визначено частоту перегляду повноважень",
         [type: :integer, default: 30]},
        {:cm_5_5_odp_02, "Визначено частоту переоцінення повноважень",
         [type: :integer, default: 30]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:cm_6_odp_01,
         ...
         [type: :string, default: nil]},
        {:cm_6_odp_03, "Визначені експлуатаційні вимоги, що вимагають затвердження відхилень",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:cm_6_1_03,
         ...
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:cm_6_1_odp_02, "Визначено автоматизовані механізми налаштуваннями конфігурації",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:cm_6_1_odp_03,
         "Визначено автоматизовані механізми застосування налаштувань конфігурації",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:cm_6_1_odp_04, "Визначено автоматизовані налаштувань конфігурації",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-6-2") do
    %{
      ...
      parameters: [
        {:cm_6_2_01, "НАЛАШТУВАННЯ КОНФІГУРАЦІЇ САНКЦІОНОВАНІ ЗМІНИ - РЕАГУВАННЯ НА НЕ-",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-7") do
    %{
      ...
      parameters: [
        {:cm_7_a, "Система налаштована на забезпечення лише основні функції системи ",
         [type: :string, default: nil]},
        {:cm_7_b_01, "Використання функцій заборонено або обмежено",
         [type: :string, default: nil]},
        {:cm_7_b_02, "Використання порти заборонено або обмежено", [type: :string, default: nil]},
        {:cm_7_b_03, "Використання протоколи заборонено або обмежено",
         [type: :string, default: "TLS 1.3"]},
        {:cm_7_b_04, "Використання програмне забезпечення заборонено або обмежено",
         [type: :string, default: nil]},
        {:cm_7_b_05, "Використання служби заборонено або обмежено",
         [type: :string, default: nil]},
        {:cm_7_odp_01, "Визначено основні функції системи, необхідні для виконання місії",
         [type: :string, default: nil]},
        {:cm_7_odp_02, "Визначено функції, які необхідно заборонити або обмежити",
         [type: :string, default: nil]},
        {:cm_7_odp_03, "Визначено системні порти, які необхідно заборонити або обмежити",
         [type: :string, default: nil]},
        {:cm_7_odp_04,
         ...
         [type: :string, default: "TLS 1.3"]},
        {:cm_7_odp_06, "Визначено служби, які необхідно заборонити або обмежити",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-7-1") do
    %{
      ...
      parameters: [
        {:cm_7_1_01, "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ПЕРІОДИЧНИЙ ПЕРЕГЛЯД",
         [type: :integer, default: 30]},
        {:cm_7_1_a,
         "Система переглядається частота для виявлення непотрібних та/або незахищених функцій, портів, протоколів і послуг",
         [type: :string, default: "TLS 1.3"]},
        {:cm_7_1_b_01, "Функції, які вважаються непотрібними та/або незахищеними, вимкнено",
         [type: :string, default: nil]},
        {:cm_7_1_b_02, "Порти, які вважаються непотрібними та/або незахищеними, вимкнено",
         [type: :string, default: nil]},
        {:cm_7_1_b_03, "Протоколи, які вважаються непотрібними та/або незахищеними, вимкнено",
         [type: :string, default: "TLS 1.3"]},
        {:cm_7_1_b_04, "Послуги, які вважаються непотрібними та/або незахищеними, вимкнено",
         [type: :string, default: nil]},
        {:cm_7_1_odp_01,
  ...
  def spec(:"id-spe-cm-7-2") do
    %{
      ...
      parameters: [
        {:cm_7_2_01, "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ЗАБОРОНА ВИКОНАННЯ ПРОГРАМИ",
         [type: :string, default: nil]},
        {:cm_7_2_odp_01,
  ...
  def spec(:"id-spe-cm-7-3") do
    %{
      ...
      parameters: [
        {:cm_7_3_01, "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ВІДПОВІДНІСТЬ РЕЄСТРАЦІЇ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-cm-7-4") do
    %{
      id: :"id-spe-cm-7-4",
      description:
        "— ЧОРНИЙ СПИСОК (a) Визначити [Призначення: визначені організацією програмне забезпечення, що не має дозволу виконуватися в системі]. (b) Впровадити політику «дозволу всього, за винятком деяких» для заборони виконання неавторизованих програм у системі (c) Переглядати та оновлювати список неавторизованих програм [Призначення: з визначеною організацією частотою].",
      title:
        "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - НЕАВТОРИЗОВАНЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ - ЧОРНИЙ СПИСОК (CM-7(4))",
      parameters: [
        {:cm_7_4_01,
         "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - НЕАВТОРИЗОВАНЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ - ЧОРНИЙ СПИСОК",
         [type: :list, default: []]},
        {:cm_7_4_a, "Визначено програмне забезпечення", [type: :string, default: nil]},
        {:cm_7_4_b,
         "Політика \"дозволу всього, за винятком деяких\" застосовується для заборони виконання неавторизованих програм у системі",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cm_7_4_c, "Переглядається та оновлюється список неавторизованих програм частота",
         [type: :list, default: []]},
        {:cm_7_4_odp_01,
  ...
  def spec(:"id-spe-cm-7-5") do
    %{
      id: :"id-spe-cm-7-5",
      description:
        "— БІЛИЙ СПИСОК (a) Визначити [Призначення: визначені організацією програмне забезпечення, яке авторизовано виконується в системі] (b) Впровадити політику «заборони всього, за винятком деяких», щоб дозволити виконання авторизованих програм у системі. (c) Переглядати та оновлювати список авторизованих програм [Призначення: з визначеною організацією частотою].",
      title:
        "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - АВТОРИЗОВАНЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ – БІЛИЙ СПИСОК (CM-7(5))",
      parameters: [
        {:cm_7_5_01,
         "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - АВТОРИЗОВАНЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ – БІЛИЙ СПИСОК",
         [type: :list, default: []]},
        {:cm_7_5_a, "Визначено програмне забезпечення", [type: :string, default: nil]},
        {:cm_7_5_b,
         "Політика \"заборонити все, дозволити за винятком\" застосовуэться, щоб дозволити виконання авторизованих програм у системі",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cm_7_5_c, "Переглядається та оновлюється список авторизованих програм частота",
         [type: :list, default: []]},
        {:cm_7_5_odp_01,
         "Визначено програмне забезпечення, яке авторизовано для виконання в системі",
         [type: :string, default: nil]},
        {:cm_7_5_odp_02, "Визначено частоту перегляду та оновлення списку авторизованих програм",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-7-8") do
    %{
      ...
      parameters: [
        {:cm_7_8_01,
         "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - БІНАРНИЙ АБО МАШИННИЙ ВИКОНУВАНИЙ КОД",
         [type: :string, default: nil]},
        {:cm_7_8_a,
  ...
  def spec(:"id-spe-cm-7-9") do
    %{
      ...
      parameters: [
        {:cm_7_9_01,
         "МІНІМАЛЬНО НЕОБХІДНА ФУНКЦІОНАЛЬНІСТЬ - ЗАБОРОНА ВИКОРИСТАННЯ НЕАВТОРИЗОВАНОГО ОБЛАДНАННЯ",
         [type: :string, default: nil]},
        {:cm_7_9_a, "Ідентифіковано апаратні компоненти", [type: :string, default: nil]},
        {:cm_7_9_b,
    ...
    %{
      ...
      parameters: [
        ...
        {:cm_8_a_05,
         ...
         [type: :string, default: nil]},
        {:cm_8_b, "Переглядається та оновлюється опис компонентів системи частота",
         [type: :string, default: "щорічно"]},
        {:cm_8_odp_01,
         "Визначено інформацію, яка вважається необхідною для досягнення ефективної підзвітності компонентів системи",
         [type: :string, default: nil]},
        {:cm_8_odp_02, "Визначено частоту перегляду та оновлення опису компонентів системи",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-8-4") do
    %{
      ...
      parameters: [
        {:cm_8_4_01, "ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ - ІНФОРМАЦІЯ ПРО ПІДЗВІТНІСТЬ",
         [type: :string, default: nil]},
        {:cm_8_4_odp,
  ...
  def spec(:"id-spe-cm-8-9") do
    %{
      ...
      parameters: [
        {:cm_8_9_01, "ІНВЕНТАРИЗАЦІЯ КОМПОНЕНТІВ СИСТЕМИ - ПРИЗНАЧЕННЯ КОМПОНЕНТІВ СИСТЕМАМ",
         [type: :string, default: nil]},
        {:cm_8_9_a, "Компоненти системи призначаються системі", [type: :string, default: nil]},
        {:cm_8_9_b, "Отримано підтвердження призначення компонента від персонал або ролі",
         [type: :list, default: ["admin", "security_officer"]]},
  ...
  def spec(:"id-spe-cm-9") do
    %{
      ...
      parameters: [
        {:cm_9_01, "Розроблено та задокументовано план управління конфігурацією системи",
         [type: :string, default: nil]},
        {:cm_9_a_01, "План управління конфігурацією описує ролі",
         [type: :list, default: ["admin", "security_officer"]]},
        {:cm_9_a_02, "План управління конфігурацією описує відповідальність",
         [type: :string, default: nil]},
        {:cm_9_a_03,
        ...
        {:cm_9_b_02,
         ...
         [type: :string, default: nil]},
        {:cm_9_c_01, "План управління конфігурацією визначає елементи конфігурації системи",
         [type: :string, default: nil]},
        {:cm_9_c_02,
        ...
        {:cm_9_d,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:cm_9_e_02, "План управління конфігурацією захищений від несанкціонованої модифікації",
         [type: :string, default: nil]},
        {:cm_9_odp,
  ...
  def spec(:"id-spe-cm-10-1") do
    %{
      ...
      parameters: [
        {:cm_10_1_01,
         "ОБМЕЖЕННЯ ВИКОРИСТАННЯ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ З ВІДКРИТИМ ВИХІДНИМ КОДОМ",
         [type: :string, default: nil]},
        {:cm_10_1_odp,
    ...
    %{
      ...
      parameters: [
        ...
        {:cm_11_b,
         ...
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cm_11_c, "Дотримання політик контролюється частота",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cm_11_odp_01,
  ...
  def spec(:"id-spe-cm-11-2") do
    %{
      ...
      parameters: [
        {:cm_11_2_01,
         "ВСТАНОВЛЕНЕ КОРИСТУВАЧЕМ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ ВСТАНОВЛЕННЯ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ З ПРИВІЛЕЙОВАНИМ СТАТУСОМ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cm-12") do
    %{
      ...
      parameters: [
        {:cm_12_a_01, "Місцезнаходження інформація визначено та задокументовано",
         [type: :string, default: nil]},
        {:cm_12_a_02,
    ...
    %{
      ...
      parameters: [
        {:cm_12_1_01,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:cm_12_1_odp_01, "Інформація визначена за типом", [type: :string, default: nil]},
        {:cm_12_1_odp_02, "Визначено компоненти системи, де знаходиться інформація",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cp-1") do
    %{
      ...
      parameters: [
        {:cp_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ПЛАНУВАННЯ БЕЗПЕРЕРВНОЇ РОБОТИ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cp_1_a_01,
        ...
        {:cp_1_odp_04,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:cp_1_odp_05, "Визначено частоту, з якою переглядається та оновлюється поточна політика",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:cp_1_odp_06,
  ...
  def spec(:"id-spe-cp-2") do
    %{
      ...
      parameters: [
        {:cp_2_01, "ПЛАН ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ",
         [type: :string, default: nil]},
        {:cp_2_a_01,
  ...
  def spec(:"id-spe-cp-4") do
    %{
      ...
      parameters: [
        {:cp_4_01,
         "ТЕСТУВАННЯ ПЛАНУ ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ",
         [type: :string, default: nil]},
        {:cp_4_a_01,
         "Тестується план забезпечення безперервної роботи у надзвичайних ситуаціях для системи частота",
         [type: :string, default: "щорічно"]},
        {:cp_4_a_02, "Тести використовуються для визначення ефективності плану",
         [type: :string, default: nil]},
        {:cp_4_a_03, "Тести використовуються для визначення готовності до виконання плану",
         [type: :string, default: nil]},
        {:cp_4_b,
         "Переглядаються результати тестування плану забезпечення безперервної роботи у надзвичайних ситуаціях",
         [type: :string, default: nil]},
        {:cp_4_c, "За необхідності ініціюються коригувальні дії",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:cp_4_odp_01,
  ...
  def spec(:"id-spe-cp-4-2") do
    %{
      ...
      parameters: [
        {:cp_4_2_01,
         "ТЕСТУВАННЯ ПЛАНУ ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ - АЛЬТЕРНАТИВНА ПЛАТФОРМА ТЕСТУВАННЯ",
         [type: :string, default: nil]},
        {:cp_4_2_a,
  ...
  def spec(:"id-spe-cp-4-5") do
    %{
      ...
      description: "",
      title:
        "<CP-04(05)_ODP[01] механізми> застосовуються для порушення та негативного впливу на <CP-04(05)_ODP[02] систему або компонент системи>. (CP-4(5))",
      parameters: [
        {:cp_4_5_01,
  ...
  def spec(:"id-spe-cp-5") do
    %{
      ...
      description: "",
      title:
        "ОНОВЛЕННЯ ПЛАНУ ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ТА ВІДНОВЛЕННЯ ФУНКЦІОНУВАННЯ (CP-5)",
      parameters: [
        {:cp_5_01,
  ...
  def spec(:"id-spe-cp-6") do
    %{
      ...
      parameters: [
        {:cp_6_01, "АЛЬТЕРНАТИВНЕ МІСЦЕ ЗБЕРІГАННЯ МЕТА ОЦІНКИ: Визначити, чи:",
         [type: :string, default: nil]},
        {:cp_6_a_01, "Створено альтернативне місце зберігання", [type: :string, default: nil]},
        {:cp_6_a_02,
    ...
    %{
      ...
      parameters: [
        {:cp_6_3_01,
         ...
         [type: :string, default: nil]},
        {:cp_6_3_02, "В загальних рисах окреслено дії щодо пом'якшення наслідків",
         [type: :list, default: ["login", "logout", "failed_attempt"]]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:cp_7_c,
         ...
         [type: :string, default: nil]},
        {:cp_7_odp_01, "Визначені операції системи для основних завдань і функцій",
         [type: :string, default: nil]},
        {:cp_7_odp_02,
    ...
    %{
      ...
      parameters: [
        {:cp_7_2_01,
         ...
         [type: :string, default: nil]},
        {:cp_7_2_02, "Окреслено чіткі заходи щодо пом'якшення наслідків",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-cp-7-6") do
    %{
      ...
      parameters: [
        {:cp_7_6_01,
         "АЛЬТЕРНАТИВНИЙ МАЙДАНЧИК ДЛЯ РОБОТИ - НЕЗДАТНІСТЬ ПОВЕРНУТИСЯ НА ОСНОВНИЙ МАЙДАНЧИК",
         [type: :string, default: nil]},
        {:cp_7_6_02,
  ...
  def spec(:"id-spe-cp-8-4") do
    %{
      ...
      parameters: [
        {:cp_8_4_01,
         "КОМУНІКАЦІЙНІ ПОСЛУГИ - ПЛАН ЗАБЕЗПЕЧЕННЯ БЕЗПЕРЕРВНОЇ РОБОТИ ПОСТАЧАЛЬНИКА КОМУНІКАЦІЙНИХ ПОСЛУГ",
         [type: :string, default: nil]},
        {:cp_8_4_a_01,
  ...
  def spec(:"id-spe-cp-8-5") do
    %{
      ...
      parameters: [
        {:cp_8_5_01, "КОМУНІКАЦІЙНІ ПОСЛУГИ - ТЕСТУВАННЯ АЛЬТЕРНАТИВНИХ КОМУНІКАЦІЙНИХ ПОСЛУГ",
         [type: :string, default: nil]},
        {:cp_8_5_odp,
  ...
  def spec(:"id-spe-cp-9") do
    %{
      ...
      parameters: [
        {:cp_9_01, "РЕЗЕРВНЕ КОПІЮВАННЯ МЕТА ОЦІНКИ: Визначити, чи:",
         [type: :string, default: nil]},
        {:cp_9_a,
        ...
        {:cp_9_b,
         ...
         [type: :string, default: "щорічно"]},
        {:cp_9_d_01, "Конфіденційність резервних копій інформації захищена",
         [type: :string, default: nil]},
        {:cp_9_d_02, "Цілісність резервних копій інформації захищена",
         [type: :string, default: nil]},
        {:cp_9_d_03, "Доступність резервних копій інформації захищена",
         [type: :string, default: nil]},
        {:cp_9_odp_01,
  ...
  def spec(:"id-spe-cp-12") do
    %{
      ...
      parameters: [
        {:cp_12_01, "При виявлені умови, вводиться безпечний режим роботи з обмеженням",
         [type: :list, default: []]},
        {:cp_12_odp_01, "Визначено умови, за яких організація вводить безпечний режим роботи",
         [type: :list, default: []]},
        {:cp_12_odp_02, "Визначено обмеження в безпечному режимі роботи",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        {:cp_13_01,
         ...
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:cp_13_odp_01, "Визначені альтернативні або додаткові механізми безпеки",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:cp_13_odp_02, "Визначені функції безпеки", [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-1") do
    %{
      ...
      parameters: [
        {:ia_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ІДЕНТИФІКАЦІЇ ТА АВТЕНТИФІКАЦІЇ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ia_1_a_01, "Розроблено та задокументовано політику ідентифікації та автентифікації",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ia_1_a_02, "Політика ідентифікації та автентифікації поширюється на персонал або ролі",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_1_a_03,
  ...
  def spec(:"id-spe-ia-2-1") do
    %{
      ...
      parameters: [
        {:ia_2_1_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - БАГАТОФАКТОРНА АВТЕНТИФІКАЦІЯ ПРИВІЛЕЙОВАНИХ ОБЛІКОВИХ ЗАПИСІВ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-2-2") do
    %{
      ...
      parameters: [
        {:ia_2_2_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - БАГАТОФАКТОРНА АВТЕНТИФІКАЦІЯ НЕПРИВІЛЕЙОВАНИХ ОБЛІКОВИХ ЗАПИСІВ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-2-3") do
    %{
      ...
      description: "",
      title:
        "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - ЛОКАЛЬНИЙ ДОСТУП ДО ПРИВІЛЕЙОВАНИХ ОБЛІКОВИХ ЗАПИСІВ (IA-2(3))",
      parameters: [
        {:ia_2_3_01,
  ...
  def spec(:"id-spe-ia-2-4") do
    %{
      ...
      description: "",
      title:
        "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - ЛОКАЛЬНИЙ ДОСТУП ДО НЕПРИВІЛЕЙОВАНИХ ОБЛІКОВИХ ЗАПИСІВ (IA-2(4))",
      parameters: [
        {:ia_2_4_01,
  ...
  def spec(:"id-spe-ia-2-7") do
    %{
      ...
      description: "",
      title:
        "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - МЕРЕЖЕВИЙ ДОСТУП ДО НЕПРИВІЛЕЙОВАНИХ ОБЛІКОВИХ ЗАПИСІВ – ОКРЕМИЙ ПРИСТРІЙ (IA-2(7))",
      parameters: [
        {:ia_2_7_01,
  ...
  def spec(:"id-spe-ia-2-8") do
    %{
      ...
      parameters: [
        {:ia_2_8_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - ДОСТУП ДО ОБЛІКОВИХ ЗАПИСІВ – СТІЙКІСТЬ ДО ВІДТВОРЕННЯ",
         [type: :string, default: nil]},
        {:ia_2_8_odp,
  ...
  def spec(:"id-spe-ia-2-9") do
    %{
      ...
      description: "",
      title:
        "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - ДОСТУП ДО НЕПРИВІЛЕЙОВАНИХ ОБЛІКОВИХ ЗАПИСІВ – СТІЙКІСТЬ ДО ВІДТВОРЕННЯ (IA-2(9))",
      parameters: [
        {:ia_2_9_01,
  ...
  def spec(:"id-spe-ia-2-11") do
    %{
      ...
      description: "",
      title:
        "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - ВІДДАЛЕНИЙ ДОСТУП - ОКРЕМИЙ ПРИСТРІЙ (IA-2(11))",
      parameters: [
        {:ia_2_11_01,
  ...
  def spec(:"id-spe-ia-2-12") do
    %{
      ...
      parameters: [
        {:ia_2_12_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - ПРИЙНЯТТЯ ПОВНОВАЖЕНЬ ДЛЯ ВЕРИФІКАЦІЇ ОСОБИСТОЇ ІНФОРМАЦІЇ (PIV CREDENTIALS)",
         [type: :list, default: ["admin", "security_officer"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-2-13") do
    %{
      ...
      parameters: [
        {:ia_2_13_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІВ ОРГАНІЗАЦІЇ) - АВТЕНТИФІКАЦІЯ ПО ЗОВНІШНЬОМУ КАНАЛУ",
         [type: :string, default: nil]},
        {:ia_2_13_odp_01, "Визначено механізми зовнішньої автентифікації",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:ia_2_13_odp_02, "Визначено умови, за яких має бути реалізована зовнішня автентифікація",
         [type: :list, default: []]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-3-1") do
    %{
      ...
      parameters: [
        {:ia_3_1_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ ПРИСТРОЇВ - КРИПТОГРАФІЧНА ДВОБІЧНА АВТЕНТИФІКАЦІЯ",
         [type: :string, default: "AES-256-GCM"]},
        {:ia_3_1_odp_01,
  ...
  def spec(:"id-spe-ia-3-3") do
    %{
      ...
      parameters: [
        {:ia_3_3_01, "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ ПРИСТРОЇВ - ДИНАМІЧНИЙ РОЗПОДІЛ АДРЕСИ",
         [type: :string, default: nil]},
        {:ia_3_3_a_01,
        ...
        {:ia_3_3_a_02,
         ...
         [type: :string, default: nil]},
        {:ia_3_3_b, "Інформація про оренду перевіряється, коли її призначено пристрою",
         [type: :string, default: nil]},
        {:ia_3_3_odp_01,
  ...
  def spec(:"id-spe-ia-3-4") do
    %{
      ...
      description: "",
      title:
        "ідентифікація та автентифікація пристрою виконується на основі атестації за допомогою <IA-03(04)_ODP процес управління конфігурацією>. (IA-3(4))",
      parameters: [
        {:ia_3_4_01,
    ...
    %{
      ...
      parameters: [
        {:ia_4_4_01,
         ...
         [type: :string, default: nil]},
        {:ia_4_4_odp, "Визначено ознаку, що ідентифікує індивідуальний статус",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        {:ia_4_5_01,
         ...
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ia_4_5_odp,
         "Визначено політику динамічних ідентифікаторів управління індивідуальними ідентифікаторами; для",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-4-6") do
    %{
      ...
      parameters: [
        {:ia_4_6_01, "УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - КРОС-ОРГАНІЗАЦІЙНЕ УПРАВЛІННЯ",
         [type: :string, default: nil]},
        {:ia_4_6_odp,
  ...
  def spec(:"id-spe-ia-4-8") do
    %{
      ...
      parameters: [
        {:ia_4_8_01, "УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - ПОПАРНІ ПСЕВДОНІМНІ ІДЕНТИФІКАТОРИ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-4-9") do
    %{
      ...
      parameters: [
        {:ia_4_9_01, "УПРАВЛІННЯ ІДЕНТИФІКАЦІЄЮ - ПОПАРНІ ПСЕВДОНІМНІ ІДЕНТИФІКАТОРИ",
         [type: :string, default: nil]},
        {:ia_4_9_odp,
  ...
  def spec(:"id-spe-ia-5-1") do
    %{
      ...
      parameters: [
        {:ia_5_1_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ ПАРОЛЯ",
         [type: :string, default: nil]},
        {:ia_5_1_a,
        ...
        {:ia_5_1_odp_01,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_5_1_odp_02, "Визначено склад та правила складності автентифікатора",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-5-2") do
    %{
      ...
      parameters: [
        {:ia_5_2_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ ВІДКРИТОГО КЛЮЧА",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-5-9") do
    %{
      ...
      parameters: [
        {:ia_5_9_01, "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - УПРАВЛІННЯ ОБ’ЄДНАННЯМ АВТЕНТИФІКАТОРІВ",
         [type: :string, default: nil]},
        {:ia_5_9_odp,
  ...
  def spec(:"id-spe-ia-5-11") do
    %{
      ...
      description: "",
      title:
        "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - АВТЕНТИФІКАЦІЯ НА ОСНОВІ АПАРАТНИХ ТОКЕНІВ (IA-5(11))",
      parameters: [
        {:ia_5_11_01,
  ...
  def spec(:"id-spe-ia-5-13") do
    %{
      ...
      parameters: [
        {:ia_5_13_01,
         "УПРАВЛІННЯ АВТЕНТИФІКАТОРОМ - ЗАКІНЧЕННЯ ТЕРМІНУ ШУВАННЯ АВТЕНТИФІКАТОРІВ КЕ-",
         [type: :string, default: nil]},
        {:ia_5_13_odp,
    ...
    %{
      ...
      parameters: [
        ...
        {:ia_5_16_odp_02,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_5_16_odp_03, "Визначено зареєстрований орган, який приймає автентифікатори",
         [type: :string, default: nil]},
        {:ia_5_16_odp_04,
  ...
  def spec(:"id-spe-ia-5-18") do
    %{
      ...
      parameters: [
        {:ia_5_18_a, "Менеджери паролів використовуються для створення та керування паролями",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_5_18_b, "Паролі захищені за допомогою елементи керування",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_5_18_odp_01,
         "Визначено менеджери паролів, які використовуються для створення та керування паролями",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_5_18_odp_02, "Визначено елементи керування для захисту паролів",
         [type: :list, default: ["admin", "security_officer"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-8-3") do
    %{
      ...
      description: "",
      title:
        "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІ, ЩО НЕ НАЛЕЖАТЬ ДО ОРГАНІЗАЦІЇ) - ВИКОРИСТАННЯ ЗАТВЕРДЖЕНИХ ПРОДУКТІВ (IA-8(3))",
      parameters: [
        {:ia_8_3_01,
  ...
  def spec(:"id-spe-ia-8-5") do
    %{
      ...
      parameters: [
        {:ia_8_5_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІ, ЩО НЕ НАЛЕЖАТЬ ДО ОРГАНІЗАЦІЇ) - ВИЗНАННЯ ПОСВІДЧЕНЬ ОСОБИ (PIV-I)",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_8_5_02, "Підтверджуються облікові дані або дані PKI, які відповідають політика",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ia_8_5_odp,
  ...
  def spec(:"id-spe-ia-8-6") do
    %{
      ...
      parameters: [
        {:ia_8_6_01,
         "ІДЕНТИФІКАЦІЯ ТА АВТЕНТИФІКАЦІЯ (КОРИСТУВАЧІ, ЩО НЕ НАЛЕЖАТЬ ДО ОРГАНІЗАЦІЇ) - РОЗМЕЖУВАННЯ",
         [type: :string, default: nil]},
        {:ia_8_6_odp,
  ...
  def spec(:"id-spe-ia-11") do
    %{
      ...
      parameters: [
        {:ia_11_01, "Користувачі повинні повторно автентифікуватися, коли обставини або ситуації",
         [type: :string, default: nil]},
        {:ia_11_odp, "Визначено обставини або ситуації, що вимагають повторної автен- тифікації",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-12") do
    %{
      ...
      parameters: [
        {:ia_12_01, "ПЕРЕВІРКА СПРАВЖНОСТІ (ІДЕНТИЧНОСТІ)", [type: :string, default: nil]},
        {:ia_12_a,
         ...
         [type: :string, default: nil]},
        {:ia_12_b, "Встановлені ідентифікатори користувачів унікальні для особи",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_12_c_01, "Збираються докази ідентичності особи",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_12_c_02, "Затверджуються докази ідентичності особи",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ia_12_c_03, "Перевіряються докази ідентичності особи",
         [type: :list, default: ["admin", "security_officer"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-12-2") do
    %{
      ...
      parameters: [
        {:ia_12_2_01, "Документи, що посвідчують особу пред’являються до реєстраційного органу",
         [type: :list, default: ["admin", "security_officer"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ia-12-6") do
    %{
      ...
      parameters: [
        {:ia_12_6_01,
         "ПЕРЕВІРКА СПРАВЖНОСТІ (ІДЕНТИЧНОСТІ) - ПРИЙНЯТТЯ ІДЕНТИФІКАЦІЙ СХВАЛЕНИХ ТРЕТЬОЮ СТОРОНОЮ",
         [type: :string, default: nil]},
        {:ia_12_6_odp,
  ...
  def spec(:"id-spe-ir-1") do
    %{
      ...
      parameters: [
        {:ir_1_a_01, "Розроблено та задокументовано політику реагування на інциденти",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ir_1_a_02, "Політика реагування на інциденти поширюється серед персоналу або ролей",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ir_1_a_03,
  ...
  def spec(:"id-spe-ir-2-1") do
    %{
      ...
      parameters: [
        {:ir_2_1_01, "НАВЧАННЯ З РЕАГУВАННЯ НА ІНЦИДЕНТИ - МОДЕЛЮВАННЯ ПОДІЙ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-3-3") do
    %{
      ...
      parameters: [
        {:ir_3_3_01, "ПЕРЕВІРКА РЕАГУВАНЬ НА ІНЦИДЕНТИ - ПОСТІЙНЕ ПОКРАЩЕННЯ",
         [type: :string, default: nil]},
        {:ir_3_3_a_01,
  ...
  def spec(:"id-spe-ir-4") do
    %{
      ...
      parameters: [
        {:ir_4_a_02, "Впроваджено можливість обробки інцидентів безпеки включно з виявленням",
         [type: :string, default: nil]},
        {:ir_4_a_03, "Впроваджено можливість обробки інцидентів безпеки включно з аналізом",
         [type: :string, default: nil]},
        {:ir_4_a_04, "Впроваджено можливість обробки інцидентів безпеки включно з локалізацією",
         [type: :string, default: nil]},
        {:ir_4_a_05, "Впроваджено можливість обробки інцидентів безпеки включно з ліквідацією",
         [type: :string, default: nil]},
        {:ir_4_a_06, "Впроваджено можливість обробки інцидентів безпеки включно з відновленням",
         [type: :string, default: nil]},
        {:ir_4_b,
        ...
        {:ir_4_c_01,
         ...
         [type: :string, default: nil]},
        {:ir_4_c_02, "Зміни, що випливають відповідним чином", [type: :string, default: nil]},
        {:ir_4_d_01,
        ...
        {:ir_4_d_03,
         ...
         [type: :string, default: nil]},
        {:ir_4_d_04,
         "Результати діяльності заходів з обробки інцидентів є порівнянною та передбачуваною в межах всієї організації; з отриманих уроків, є впроваджуються порівнянною та",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        {:ir_4_2_01,
         ...
         [type: :integer, default: 30]},
        {:ir_4_2_odp_01, "Визначено типи динамічної реконфігурації для компонентів системи",
         [type: :string, default: nil]},
        {:ir_4_2_odp_02, "Визначено компоненти системи, які потребують динамічної реконфігурації",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-4-3") do
    %{
      ...
      parameters: [
        {:ir_4_3_01, "Ідентифіковано класи інцидентів", [type: :string, default: nil]},
        {:ir_4_3_02,
  ...
  def spec(:"id-spe-ir-4-9") do
    %{
      ...
      parameters: [
        {:ir_4_9_01, "ОБРОБКА ІНЦИДЕНТУ - ЗДАТНІСТЬ ДИНАМІЧНОГО РЕАГУВАННЯ",
         [type: :string, default: nil]},
        {:ir_4_9_odp,
  ...
  def spec(:"id-spe-ir-4-11") do
    %{
      ...
      parameters: [
        {:ir_4_11_01, "Створена та підтримується інтегрована група реагування на інциденти",
         [type: :string, default: nil]},
        {:ir_4_11_02,
  ...
  def spec(:"id-spe-ir-4-12") do
    %{
      ...
      parameters: [
        {:ir_4_12_01, "Шкідливий код, що залишився в системі, аналізується після інциденту",
         [type: :string, default: nil]},
        {:ir_4_12_02,
  ...
  def spec(:"id-spe-ir-4-14") do
    %{
      ...
      parameters: [
        {:ir_4_14_01, "Створено оперативний центр безпеки", [type: :string, default: nil]},
        {:ir_4_14_02, "Підтримується оперативний центр безпеки", [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-4-15") do
    %{
      ...
      parameters: [
        {:ir_4_15_01, "ОБРОБКА ІНЦИДЕНТУ - ЗВʼЯЗКИ З ГРОМАДКІСТЮ ТА ВІДНОВЛЕННЯ РЕПУТАЦІЇ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-5") do
    %{
      ...
      parameters: [
        {:ir_5_01, "Відстежуються інциденти безпеки та приватності",
         [type: :string, default: nil]},
        {:ir_5_02,
    ...
    %{
      ...
      parameters: [
        ...
        {:ir_5_1_03,
         ...
         [type: :string, default: nil]},
        {:ir_5_1_odp_01, "Визначено автоматизовані механізми відстеження інцидентів",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:ir_5_1_odp_02, "Визначено автоматизовані механізми збору інформації про інциденти",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:ir_5_1_odp_03, "Визначено автоматизовані механізми аналізу інформації про інциденти",
         [type: :string, default: "автоматизований засіб моніторингу"]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        {:ir_6_a,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ir_6_b, "Інформацію про інцидент повідомляється органам",
         [type: :string, default: nil]},
        {:ir_6_odp_01,
         "Визначено період часу, протягом якого персонал повинен повідомляти про підозрілі інциденти до уповноваженого органу",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ir_6_odp_02, "Визначені органи, до яких слід повідомляти інформацію про інцидент",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-6-1") do
    %{
      ...
      parameters: [
        {:ir_6_1_01, "Використовуються автоматичні механізми звітування про інциденти",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:ir_6_1_odp, "Визначені автоматичні механізми звітування про інциденти",
         [type: :string, default: "автоматизований засіб моніторингу"]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-7-1") do
    %{
      ...
      parameters: [
        {:ir_7_1_01,
         "ПІДТРИМКА РЕАГУВАННЯ НА ІНЦИДЕНТИ - АВТОМАТИЗАЦІЯ ПІДТРИМКИ ДЛЯ ЗАБЕЗПЕЧЕННЯ ДОСТУПНОСТІ ІНФОРМАЦІЇ ТА ПІДТРИМКИ",
         [type: :string, default: nil]},
        {:ir_7_1_odp,
  ...
  def spec(:"id-spe-ir-7-2") do
    %{
      ...
      parameters: [
        {:ir_7_2_01,
         "ПІДТРИМКА РЕАГУВАННЯ НА ІНЦИДЕНТИ - КООРДИНАЦІЯ З ЗОВНІШНІМИ ПОСТАЧАЛЬНИКАМИ",
         [type: :string, default: nil]},
        {:ir_7_2_a,
    ...
    %{
      ...
      parameters: [
        ...
        {:ir_8_a_04,
         ...
         [type: :string, default: nil]},
        {:ir_8_a_05, "Розроблено план реагування на інциденти, який визначає підзвітні інциденти",
         [type: :string, default: nil]},
        {:ir_8_a_06,
        ...
        {:ir_8_d_02,
         ...
         [type: :string, default: nil]},
        {:ir_8_e_01, "План реагування на інциденти захищений від несанкціонованого розкриття",
         [type: :string, default: nil]},
        {:ir_8_e_02, "План реагування на інциденти захищений від несанкціонованої модифікації",
         [type: :string, default: nil]},
        {:ir_8_odp_01,
  ...
  def spec(:"id-spe-ir-8-1") do
    %{
      ...
      parameters: [
        {:ir_8_1_01, "ПЛАН РЕАГУВАННЯ НА ІНЦИДЕНТИ - ОБРОБКА ПЕРСОНАЛЬНИХ ДАНИХ",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ir_8_1_a,
    ...
    %{
      ...
      parameters: [
        ...
        {:ir_9_c,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ir_9_d, "Ізоляцюється система або компонент системи де відбувся витік інформації",
         [type: :string, default: nil]},
        {:ir_9_e,
        ...
        {:ir_9_f,
         ...
         [type: :string, default: nil]},
        {:ir_9_g, "Дії виконуються у відповідь на витік інформації",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:ir_9_odp_01,
        ...
        {:ir_9_odp_02,
         ...
         [type: :list, default: ["admin", "security_officer"]]},
        {:ir_9_odp_03, "Визначені дії, які необхідно виконати",
         [type: :list, default: ["login", "logout", "failed_attempt"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ir-9-2") do
    %{
      ...
      parameters: [
        {:ir_9_2_01, "Забезпечено навчання з реагування на витік інформації частота",
         [type: :string, default: "щорічно"]},
        {:ir_9_2_odp, "Визначено частоту навчання з реагування на витік інформації",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ma-1") do
    %{
      ...
      parameters: [
        {:ma_1_a_01, "Розроблено та задокументовано політику технічного обслуговування",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:ma_1_a_02, "Політика технічного обслуговування поширюється на персонал або ролі",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ma_1_a_03,
  ...
  def spec(:"id-spe-ma-2-1") do
    %{
      ...
      parameters: [
        {:ma_2_1_01, "КОНТРОЛЬОВАНЕ ОБСЛУГОВУВАННЯ - ЗМІСТ ЗАПИСУ [Вилучено: Включено до МА-02]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ma-2-2") do
    %{
      ...
      parameters: [
        {:ma_2_2_01, "КОНТРОЛЬОВАНЕ ОБСЛУГОВУВАННЯ - АВТОМАТИЗОВАНА ТЕХНІЧНА ДІЯЛЬНІСТЬ",
         [type: :string, default: nil]},
        {:ma_2_2_a_01,
  ...
  def spec(:"id-spe-ma-3") do
    %{
      ...
      parameters: [
        {:ma_3_a_01, "Використання засобів технічного обслуговування затверджено",
         [type: :string, default: nil]},
        {:ma_3_a_02, "Використання засобів технічного обслуговування контролюється",
         [type: :string, default: nil]},
        {:ma_3_a_03, "Використання засобів технічного обслуговування відстажуються",
         [type: :string, default: nil]},
        {:ma_3_b,
  ...
  def spec(:"id-spe-ma-3-3") do
    %{
      ...
      parameters: [
        {:ma_3_3_01, "ІНСТРУМЕНТИ ДЛЯ ОБСЛУГОВУВАННЯ - ЗАПОБІГАННЯ НЕСАНКЦІОНОВАНОМУ ПЕРЕМІЩЕННЮ",
         [type: :string, default: nil]},
        {:ma_3_3_a,
  ...
  def spec(:"id-spe-ma-4") do
    %{
      ...
      parameters: [
        {:ma_4_a_01, "Впроваджено віддалені дії з обслуговування та діагностики",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:ma_4_a_02, "Відстежуються віддалені дії з обслуговування та діагностики",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:ma_4_b_01,
        ...
        {:ma_4_c,
         ...
         [type: :string, default: nil]},
        {:ma_4_d, "Ведеться облік віддалених дій з обслуговування та діагностики",
         [type: :string, default: nil]},
        {:ma_4_e_01, "Сесія припиняється, коли завершено віддалене обслуговування",
         [type: :string, default: nil]},
        {:ma_4_e_02, "Мережеве з’єднання припиняється, коли завершено віддалене обслуговування",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ma-4-1") do
    %{
      ...
      parameters: [
        {:ma_4_1_a_01, "Події аудиту журналюються для віддалених сеансів обслуговування",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:ma_4_1_a_02, "Події аудиту журналюються для віддалених сеансів діагностики",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:ma_4_1_b_01, "Здійснюється огляд записів про сеанси віддаленого обслуговування",
         [type: :string, default: nil]},
        {:ma_4_1_b_02, "Здійснюється огляд записів про сеанси віддаленої діагностики",
         [type: :string, default: nil]},
        {:ma_4_1_odp_01,
  ...
  def spec(:"id-spe-ma-4-3") do
    %{
      ...
      parameters: [
        {:ma_4_3_01, "ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - ПОРІВНЯЛЬНА БЕЗПЕКА І ОЧИЩЕННЯ",
         [type: :string, default: nil]},
        {:ma_4_3_a_01,
  ...
  def spec(:"id-spe-ma-4-5") do
    %{
      ...
      parameters: [
        {:ma_4_5_01, "ВІДДАЛЕНЕ ОБСЛУГОВУВАННЯ - СХВАЛЕННЯ ТА ПОВІДОМЛЕННЯ",
         [type: :string, default: nil]},
        {:ma_4_5_a, "Схвалення кожного віддаленого сеансу обслуговування від персонал або ролі",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ma_4_5_b,
  ...
  def spec(:"id-spe-ma-5") do
    %{
      ...
      parameters: [
        {:ma_5_a_01, "Запроваджено процес авторизації технічного персоналу",
         [type: :list, default: ["admin", "security_officer"]]},
        {:ma_5_a_02,
  ...
  def spec(:"id-spe-mp-1") do
    %{
      ...
      parameters: [
        {:mp_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ЩОДО ЗАХИСТУ НОСІЇВ ІНФОРМАЦІЇ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:mp_1_a_01, "Розроблено та задокументовано політику захисту носіїв інформації",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:mp_1_a_02, "Політика захисту носіїв інформації поширюється на персонал або ролі",
         [type: :list, default: ["admin", "security_officer"]]},
        {:mp_1_a_03,
  ...
  def spec(:"id-spe-mp-2") do
    %{
      ...
      parameters: [
        {:mp_2_01, "Доступ до типів цифрових носіїв інформації обмежено для персоналу або ролей",
         [type: :list, default: ["admin", "security_officer"]]},
        {:mp_2_02,
         "Доступ до типів нецифрових носіїв інформації обмежено для персоналу або ролей",
         [type: :list, default: ["admin", "security_officer"]]},
        {:mp_2_odp_01, "Визначено типи цифрових носіїв інформації, доступ до яких обмежено",
         [type: :string, default: nil]},
        {:mp_2_odp_02,
         "Визначено персонал або ролі, уповноважені на доступ до цифрових носіїв інформації",
         [type: :list, default: ["admin", "security_officer"]]},
        {:mp_2_odp_03, "Визначено типи нецифрових носіїв інформації, доступ до яких обмежено",
         [type: :string, default: nil]},
        {:mp_2_odp_04,
  ...
  def spec(:"id-spe-mp-3") do
    %{
      ...
      parameters: [
        {:mp_3_01, "МАРКУВАННЯ НОСІЇВ ІНФОРМАЦІЇ МЕТА ОЦІНКИ: Визначити, чи:",
         [type: :string, default: nil]},
        {:mp_3_a,
         ...
         [type: :string, default: nil]},
        {:mp_3_b, "Типи носіїв інформації залишаються в межах контрольованих зон",
         [type: :string, default: nil]},
        {:mp_3_odp_01,
  ...
  def spec(:"id-spe-mp-4") do
    %{
      ...
      parameters: [
        {:mp_4_a_01, "Типи цифрових носіїв контролюються фізично", [type: :string, default: nil]},
        {:mp_4_a_02, "Типи нецифрових носіїв контролюються фізично",
         [type: :string, default: nil]},
        {:mp_4_a_03, "Типи цифрових носіїв безпечно зберігаються в контрольованих зонах",
         [type: :string, default: nil]},
        {:mp_4_a_04, "Типи нецифрових носіїв безпечно зберігаються в контрольованих зонах",
         [type: :string, default: nil]},
        {:mp_4_b,
  ...
  def spec(:"id-spe-mp-6-1") do
    %{
      ...
      parameters: [
        {:mp_6_1_01,
         "ЗНИЩЕННЯ ІНФОРМАЦІЇ НА НОСІЯХ ІНФОРМАЦІЇ - ПЕРЕГЛЯДАТИ, ЗАТВЕРДЖЕННЯ, ВІДСТЕЖЕННЯ, ДОКУМЕНТУВАННЯ ТА ПЕРЕВІРКА",
         [type: :string, default: nil]},
        {:mp_6_1_02, "Затверджуються заходи з очищення та утилізації носіїв інформації",
         [type: :string, default: nil]},
        {:mp_6_1_03, "Відстежуються заходи з очищення та утилізації носіїв інформації",
         [type: :string, default: nil]},
        {:mp_6_1_04, "Документуються заходи з очищення та утилізації носіїв інформації",
         [type: :string, default: nil]},
        {:mp_6_1_05, "Перевіряються заходи з очищення та утилізації носіїв інформації",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:mp_6_2_odp_01,
         ...
         [type: :string, default: "щорічно"]},
        {:mp_6_2_odp_02, "Визначено частоту, з якою потрібно перевіряти процедури очищення",
         [type: :integer, default: 30]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        {:mp_6_3_01,
         ...
         [type: :string, default: nil]},
        {:mp_6_3_odp, "Визначено умови, які вимагають очищення зовнішніх носіїв інформації",
         [type: :list, default: []]}
      ]
    }
  end
  ...
  def spec(:"id-spe-mp-6-4") do
    %{
      ...
      description: "",
      title:
        "ЗНИЩЕННЯ ІНФОРМАЦІЇ НА НОСІЯХ ІНФОРМАЦІЇ - КЕРОВАНА НЕСЕКРЕТНА ІНФОРМАЦІЯ (MP-6(4))",
      parameters: [
        {:mp_6_4_01,
  ...
  def spec(:"id-spe-mp-6-7") do
    %{
      ...
      parameters: [
        {:mp_6_7_01, "ЗНИЩЕННЯ ІНФОРМАЦІЇ НА НОСІЯХ ІНФОРМАЦІЇ - ПОДВІЙНА АВТОРИЗАЦІЯ",
         [type: :string, default: nil]},
        {:mp_6_7_odp,
  ...
  def spec(:"id-spe-mp-6-8") do
    %{
      ...
      parameters: [
        {:mp_6_8_01,
         "ЗНИЩЕННЯ ІНФОРМАЦІЇ НА НОСІЯХ ІНФОРМАЦІЇ - ВІДДАЛЕНЕ ОЧИЩЕННЯ АБО СТИРАННЯ ІНФОРМАЦІЇ",
         [type: :string, default: nil]},
        {:mp_6_8_odp_01,
         "Визначено системи або компоненти системи для очищення або стирання інформації віддалено або за певних умов",
         [type: :string, default: nil]},
        {:mp_6_8_odp_02, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРІВ: {віддалено; за умов }",
         [type: :string, default: nil]},
        {:mp_6_8_odp_03,
  ...
  def spec(:"id-spe-mp-7") do
    %{
      ...
      parameters: [
        {:mp_7_01, "ВИКОРИСТАННЯ НОСІЇВ ІНФОРМАЦІЇ МЕТА ОЦІНКИ: Визначити, чи:",
         [type: :string, default: nil]},
        {:mp_7_b,
        ...
        {:mp_7_odp_01,
         ...
         [type: :string, default: nil]},
        {:mp_7_odp_02, "Вибрано одне з наступних ЗНАЧЕНЬ ПАРАМЕТРА: {обмежити; заборонити}",
         [type: :string, default: nil]},
        {:mp_7_odp_03,
  ...
  def spec(:"id-spe-mp-7-1") do
    %{
      ...
      description: "",
      title:
        "ВИКОРИСТАННЯ НОСІЇВ ІНФОРМАЦІЇ - ЗАБОРОНА ВИКОРИСТАННЯ БЕЗ ВИЗНАЧЕНОГО ВЛАСНИКА (MP-7(1))",
      parameters: [
        {:mp_7_1_01,
  ...
  def spec(:"id-spe-mp-7-2") do
    %{
      ...
      parameters: [
        {:mp_7_2_01,
         "ВИКОРИСТАННЯ НОСІЇВ ІНФОРМАЦІЇ - ЗАБОРОНА ВИКОРИСТАННЯ СТІЙКИХ ДО ОЧИЩЕННЯ НОСІЇВ ІНФОРМАЦІЇ",
         [type: :string, default: nil]},
        {:mp_7_2_02,
  ...
  def spec(:"id-spe-mp-8") do
    %{
      id: :"id-spe-mp-8",
      description:
        "a. сплануйте розташування або ділянку об’єкта, де знаходиться система, враховуючи фізичні та екологічні ризики; b. для існуючих об’єктів врахуйте фізичні та екологічні ризики в організаційній стратегії управління ризиками.",
      title: "ЗНИЖЕННЯ КАТЕГОРІЇ БЕЗПЕКИ НОСІЇВ ІНФОРМАЦІЇ (MP-8)",
      parameters: [
        {:mp_8_a_01, "Встановлено безпеки носіїв інформаці; процес зниження категорії",
         [type: :string, default: nil]},
        {:mp_8_a_02,
        ...
        {:mp_8_d,
         ...
         [type: :string, default: nil]},
        {:mp_8_odp_01, "Визначено процес зниження категорії безпеки носіїв інформації",
         [type: :string, default: nil]},
        {:mp_8_odp_02,
  ...
  def spec(:"id-spe-mp-8-1") do
    %{
      ...
      parameters: [
        {:mp_8_1_01, "ЗНИЖЕННЯ КАТЕГОРІЇ БЕЗПЕКИ НОСІЇВ ІНФОРМАЦІЇ - ДОКУМЕНТУВАННЯ ПРОЦЕСУ",
         [type: :string, default: nil]}
      ]
    }
  end
    ...
    %{
      ...
      parameters: [
        ...
        {:pe_2_a_03,
         ...
         [type: :list, default: []]},
        {:pe_2_b, "Для доступу до об'єкта надаються повноваження", [type: :string, default: nil]},
        {:pe_2_c,
  ...
  def spec(:"id-spe-pe-3-5") do
    %{
      ...
      parameters: [
        {:pe_3_5_odp_01, "Визначено заходи захисту від фізичної підробки або підміни",
         [type: :string, default: nil]},
        {:pe_3_5_odp_02,
  ...
  def spec(:"id-spe-pe-6-2") do
    %{
      ...
      parameters: [
        {:pe_6_2_01, "Розпізнаються класи або типи вторгнень", [type: :string, default: nil]},
        {:pe_6_2_02, "Реакції ініціюються за допомогою автоматизованих механізмів",
         [type: :string, default: nil]},
        {:pe_6_2_odp_01,
  ...
  def spec(:"id-spe-pe-8-3") do
    %{
      ...
      description: "",
      title:
        "інформація, що ідентифікує особу, яка міститься в реєстрах доступу відвідувачів, обмежується <PE-08(03)_ODP елементи>, визначеними в оцінці ризиків для конфіденційності. (PE-8(3))",
      parameters: [
        {:pe_8_3_01,
  ...
  def spec(:"id-spe-pe-12") do
    %{
      ...
      description: "",
      title:
        "РЕ-13 Протипожежний захист Контроль температури та РЕ-14 вологості Захист від пошкодження РЕ-15 водою РЕ-16 Доставлення та видалення (PE-12)",
      parameters: [
        {:pe_12_01,
  ...
  def spec(:"id-spe-pe-17") do
    %{
      ...
      description: "",
      title:
        "РЕ-17 Альтернативне робоче місце Розташування компонентів РЕ-18 системи РЕ-19 Витік інформації Моніторинг і відстеження РЕ-20 активів Захист від електромагнітного РЕ-21 імпульсу РЕ-22 Маркування компонентів (PE-17)",
      parameters: [
        {:pe_17_odp_01,
  ...
  def spec(:"id-spe-pe-18") do
    %{
      id: :"id-spe-pe-18",
      description: "",
      title: "РЕ-23 Розташування об’єкта (PE-18)",
      parameters: [
        {:pe_18_01,
  ...
  def spec(:"id-spe-pe-20") do
    %{
      ...
      description: "",
      title:
        "<PE-20_ODP[01] технології> використовуються для відстеження та моніторингу місцезнаходження і переміщення <PE- (PE-20)",
      parameters: [
        {:pe_20_01,
  ...
  def spec(:"id-spe-pe-21") do
    %{
      ...
      description: "",
      title:
        "<PE-21_ODP[01] заходи захисту> застосовуються проти пошкодження електромагнітними імпульсами для <PE-21_ODP[02] системи та компонентів системи>. (PE-21)",
      parameters: [
        {:pe_21_01,
         "Заходи захисту застосовуються проти пошкодження електромагнітними імпульсами для системи та компонентів системи",
         [type: :string, default: nil]},
        {:pe_21_odp_01, "Визначено заходи захисту від пошкодження електромагнітними імпульсами",
         [type: :string, default: nil]},
        {:pe_21_odp_02,
  ...
  def spec(:"id-spe-pe-22") do
    %{
      ...
      description: "",
      title:
        "<PE-22_ODP апаратні компоненти системи> позначаються із зазначенням рівня впливу або класифікації інформації, яку дозволено обробляти, зберігати або передавати за допомогою апаратного компонента. (PE-22)",
      parameters: [
        {:pe_22_01,
  ...
  def spec(:"id-spe-pl-4") do
    %{
      ...
      parameters: [
        {:pl_4_01, "ПРАВИЛА ПОВЕДІНКИ ТА ПОСТАЧАННЯ ПЕРСОНАЛЬНИХ ДАНИХ - -",
         [type: :list, default: ["admin", "security_officer"]]},
  ...
  def spec(:"id-spe-pl-4-1") do
    %{
      ...
      parameters: [
        {:pl_4_1_01, "ПРАВИЛА ПОВЕДІНКИ - ОБМЕЖЕННЯ НА СОЦІАЛЬНІ МЕДІА ТА МЕРЕЖУ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:pl_4_1_a,
  ...
  def spec(:"id-spe-pl-5") do
    %{
      ...
      parameters: [
        {:pl_5_01, "ОЦІНКА ВПЛИВУ НА ПРИВАТНІСТЬ [Вилучено: включено до RА-8]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-pl-6") do
    %{
      ...
      parameters: [
        {:pl_6_01, "ПЛАНУВАННЯ ДІЯЛЬНОСТІ, ПОВ'ЯЗАНОЇ З БЕЗПЕКОЮ [Вилучено: включено до PL-2]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-pl-7") do
    %{
      id: :"id-spe-pl-7",
      description:
        "a. Розробити концепцію експлуатації інформаційної системи, яка описує, як організація має намір керувати системою з погляду забезпечення безпеки та приватності інформації. b. Переглядати й оновлювати концепцію експлуатації [Призначення: з визначеною організацією частотою].",
  ...
  def spec(:"id-spe-pl-8-1") do
    %{
      ...
      parameters: [
        {:pl_8_1_01, "АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ - «ГЛИБОКА ОБОРОНА»",
         [type: :string, default: nil]},
        {:pl_8_1_a_01,
  ...
  def spec(:"id-spe-pm-11") do
    %{
      id: :"id-spe-pm-11",
      description: "безпеки та приватності.",
  ...
  def spec(:"id-spe-pm-14") do
    %{
      ...
      parameters: [
        {:pm_14_01, "ТЕСТУВАННЯ, НАВЧАННЯ ТА МОНІТОРИНГ", [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-pm-15") do
    %{
      ...
      parameters: [
        {:pm_15_01,
         "КОНТАКТИ З ГРУПАМИ ТА АСОЦІАЦІЯМИ З ПИТАНЬ БЕЗПЕКИ ІНФОРМАЦІЇ ТА ПРИВАТНОСТІ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-pm-16-1") do
    %{
      ...
      description: "",
      title:
        "automated mechanisms are employed to maximize the effectiveness of sharing threat intelligence information. (PM-16(1))",
      parameters: [
        {:pm_16_1_01,
  ...
  def spec(:"id-spe-pm-17") do
    %{
      id: :"id-spe-pm-17",
      description:
        "a. Розробити політику та процедури для забезпечення того, щоб вимоги до захисту публічної (некласифікованої) інформації, яка обробляється, зберігається або передається у зовнішніх системах, здійснювалися відповідно до чинного законодавства. b. Оновлювати політику та процедури [Призначення: з визначеною організацією частотою].",
  ...
  def spec(:"id-spe-pm-20") do
    %{
      id: :"id-spe-pm-20",
      description:
        "загальнодоступному вебсайті організації, яка слугує центральним джерелом інформації про програму приватності організації та яка: a. забезпечує доступ громадськості до інформації про діяльність щодо забезпечення приватності в організації та можливість комунікації з уповноваженою посадовою особою з питань забезпечення приватності; b. оприлюднює організаційну політику забезпечення приватності на вебсайті організації або іншим чином; c. використовує публічні адреси електронної пошти та/або телефонні лінії, щоб дати можливість громадськості надавати відгуки та/або направляти запитання щодо програми приватності в організації.",
  ...
  def spec(:"id-spe-pm-21") do
    %{
      id: :"id-spe-pm-21",
      description:
        "a. Забезпечити доступ громадськості до інформації із забезпечення приватності в організації та можливість комунікації з уповноваженою посадовою особою з питань забезпечення приватності щодо: 1. дати, характеру та мети кожного розкриття запису; 2. імені та адреси особи або організації, щодо яких було зроблено розкриття даних. b. Обліковувати та зберігати випадки розкриття персональних даних протягом терміну дії запису або п’яти років після розкриття інформації. c. Здійснювати облік випадків розкриття персональних даних, доступних особі, зазначеній у записі за запитом.",
  ...
  def spec(:"id-spe-pm-23") do
    %{
      id: :"id-spe-pm-23",
      description:
        "[Призначення: визначені організацією функції] та виконання [Призначення: визначені організацією обов’язки].",
  ...
  def spec(:"id-spe-pm-24") do
    %{
      id: :"id-spe-pm-24",
      description:
        "Створити орган з питань цілісності даних для здійснення: a. Розгляду пропозицій щодо проведення відповідної програми або участі у ній. b. Проведення огляду усіх поточних програм, в яких бере участь організація.",
  ...
  def spec(:"id-spe-pm-27") do
    %{
      id: :"id-spe-pm-27",
      description:
        "a. Визначити та задокументувати: 1. припущення, що впливають на оцінку ризиків, реагування на ризики та моніторинг ризиків; 2. обмеження, що впливають на оцінку ризиків, реагування на ризики та моніторинг ризиків; 3. пріоритети та компроміси, які розглядаються організацією для здійснення управління ризиками; 4. стійкість організації до ризиків. b. Поінформувати [Призначення: визначений організацією персонал] про результати визначення ризиків. c. Переглядати та оновлювати підходи щодо визначення ризиків [Призначення: з визначеною організацією частотою].",
  ...
  def spec(:"id-spe-pt-2") do
    %{
      id: :"id-spe-pt-2",
      description:
        "a. визначити та задокументувати [Призначення: повноваження, визначені організацією], які дозволяють [Призначення: обробку, визначену організацією] персональної інформації; b. обмежити [Призначення: обробку, визначену організацією] персональної інформації лише таким чином, яким дозволено (тільки до того, що дозволено)",
  ...
  def spec(:"id-spe-pt-4") do
    %{
      id: :"id-spe-pt-4",
      description:
        "організацією], щоб окремі особи давали згоду на обробку їх персональних даних до її збору, що полегшить прийняття обґрунтованих рішень особами.",
  ...
  def spec(:"id-spe-pt-4-1") do
    %{
      ...
      parameters: [
        {:pt_4_1_01,
         "ЗГОДА НА ОБРОБКУ ПЕРСОНАЛЬНИХ ДАНИХ - ІНДИВІДУАЛЬНА ЗГОДА НА ОБРОБКУ ПЕРСОНАЛЬНИХ ДАНИХ",
         [type: :list, default: ["admin", "security_officer"]]},
        {:pt_4_1_odp,
  ...
  def spec(:"id-spe-pt-5") do
    %{
      id: :"id-spe-pt-5",
      description:
        "персональні дані обробляються в системі, які: a. доступні окремим особам під час першої взаємодії з організацією, та згодом [Призначення: частота, визначена організацією]; b. виражені простою мовою; c. визначають орган, який надає дозвіл на обробку персональних даних; d. визначають цілі, для яких мають оброблятися персональні дані; e. включають [Призначення: інформація, визначена організацією].",
  ...
  def spec(:"id-spe-pt-7") do
    %{
      id: :"id-spe-pt-7",
      description: "для певних категорій персональних даних.",
  ...
  def spec(:"id-spe-pt-7-1") do
    %{
      ...
      parameters: [
        {:pt_7_1_01, "СПЕЦІАЛЬНІ КАТЕГОРІЇ ПЕРСОНАЛЬНИХ СОЦІАЛЬНОГО СТРАХУВАННЯ ДАНИХ - НОМЕРИ",
         [type: :list, default: ["admin", "security_officer"]]},
        {:pt_7_1_a_01,
  ...
  def spec(:"id-spe-ra-3-1") do
    %{
      ...
      parameters: [
        {:ra_3_1_01, "ОЦІНЮВАННЯ ПОСТАЧАННЯ РИЗИКУ - ОЦІНЮВАННЯ РИЗИКУ ЛАНЦЮГА",
         [type: :string, default: nil]},
        {:ra_3_1_a,
    ...
    %{
      ...
      parameters: [
        {:ra_3_4_01,
         ...
         [type: :string, default: nil]},
        {:ra_3_4_02,
         "Застосовуються розширені аналітичні можливості для прогнозування та виявлення ризику для систем або компонентів системи. аналітики для",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ra-4") do
    %{
      ...
      parameters: [
        {:ra_4_01, "ОНОВЛЕННЯ ОЦІНЮВАННЯ РИЗИКУ [Вилучено: включено до RA-3]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ra-5-1") do
    %{
      ...
      parameters: [
        {:ra_5_1_01, "СКАНУВАННЯ ВРАЗЛИВОСТЕЙ ІНСТРУМЕНТІВ [Вилучено: включено до RA-5]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ra-5-2") do
    %{
      ...
      parameters: [
        {:ra_5_2_01,
         "СКАНУВАННЯ ВРАЗЛИВОСТЕЙ - ОНОВЛЕННЯ ЗА ЧАСТОТОЮ, ПЕРЕД НОВИМ СКАНУВАННЯМ АБО ПРИ ІДЕНТИФІКАЦІЇ - МОЖЛИВІСТЬ ОНОВЛЕННЯ",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ra-5-7") do
    %{
      ...
      description: "",
      title:
        "СКАНУВАННЯ ВРАЗЛИВОСТЕЙ - АВТОМАТИЗОВАНЕ ВИЯВЛЕННЯ ТА СПОВІЩЕННЯ ПРО НЕАВТОРИЗОВАНІ КОМПОНЕНТИ (RA-5(7))",
      parameters: [
        {:ra_5_7_01,
  ...
  def spec(:"id-spe-ra-5-8") do
    %{
      ...
      parameters: [
        {:ra_5_8_01, "СКАНУВАННЯ ВРАЗЛИВОСТЕЙ - ОГЛЯД ЖУРНАЛІВ АУДИТУ ЗА МИНУЛІ ПЕРІОДИ",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-ra-10") do
    %{
      id: :"id-spe-ra-10",
      description:
        "a. Створити та підтримувати можливості активного пошуку кіберзагроз: 1. пошук індикаторів компроментації в системах організації; 2. виявлення, відстеження та знищення загроз, які можуть обходити існуючі засоби контролю безпеки. b. використовуйте можливості активного пошуку загроз [Призначення: частота, визначена організацією].",
  ...
  def spec(:"id-spe-sa-3-2") do
    %{
      ...
      parameters: [
        {:sa_3_2_01, "ЖИТТЄВИЙ ЦИКЛ РЕАЛЬНИХ ДАНИХ РОЗРОБКИ СИСТЕМИ - ВИКОРИСТАННЯ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-4-2") do
    %{
      ...
      parameters: [
        {:sa_4_2_01, "ПРОЦЕС ЗАКУПІВЕЛЬ - РОЗРОБКА ТА ВПРОВАДЖЕННЯ ІНФОРМАЦІЇ ДЛЯ ЗАХОДІВ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-4-3") do
    %{
      ...
      parameters: [
        {:sa_4_3_01, "ПРОЦЕС ЗАКУПІВЕЛЬ РОЗРОБКИ - МЕТОДИ, ТЕХНІКИ ТА ПРАКТИКИ",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:sa_4_3_a,
  ...
  def spec(:"id-spe-sa-4-5") do
    %{
      ...
      parameters: [
        {:sa_4_5_01, "ПРОЦЕС ЗАКУПІВЕЛЬ - КОНФІГУРАЦІЇ СИСТЕМИ, КОМПОНЕНТА ТА СИСТЕМНОЇ СЛУЖБИ",
         [type: :string, default: nil]},
        {:sa_4_5_a,
  ...
  def spec(:"id-spe-sa-4-6") do
    %{
      ...
      parameters: [
        {:sa_4_6_01, "ПРОЦЕС ЗАКУПІВЕЛЬ ІНФОРМАЦІЇ - ВИКОРИСТАННЯ ЗАСОБІВ ЗАХИСТУ",
         [type: :string, default: nil]},
        {:sa_4_6_a,
  ...
  def spec(:"id-spe-sa-4-7") do
    %{
      ...
      parameters: [
        {:sa_4_7_01, "ПРОЦЕС ЗАКУПІВЕЛЬ - ЗАТВЕРДЖЕНІ ПРОФІЛІ ЗАХИЩЕНОСТІ",
         [type: :string, default: nil]},
        {:sa_4_7_a,
  ...
  def spec(:"id-spe-sa-5-5") do
    %{
      ...
      parameters: [
        {:sa_5_5_01, "СИСТЕМНА ДОКУМЕНТАЦІЯ - ВИХІДНИЙ КОД [Вилучено: включено до SA-4(2)]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-8-1") do
    %{
      ...
      parameters: [
        {:sa_8_1_01, "БЕЗПЕКА ТА ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ - ЧІТКА АБСТРАКЦІЯ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-8-10") do
    %{
      ...
      description: "",
      title:
        "<SA-08(09)_ODP системи або компоненти системи> реалізують принцип ієрархічної довіри в дизайні безпеки. (SA-8(10))",
      parameters: [
        {:sa_8_10_01,
  ...
  def spec(:"id-spe-sa-8-11") do
    %{
      ...
      description: "",
      title:
        "<SA-08(11)_ODP системи або компоненти системи> реалізують принцип проектування безпеки зворотного порогу модифікації. (SA-8(11))",
      parameters: [
        {:sa_8_11_01,
  ...
  def spec(:"id-spe-sa-8-12") do
    %{
      ...
      description: "",
      title:
        "<SA-08(12)_ODP системи або компоненти системи> реалізують принцип побудови ієрархічного захисту. (SA-8(12))",
      parameters: [
        {:sa_8_12_01,
  ...
  def spec(:"id-spe-sa-8-13") do
    %{
      ...
      description: "",
      title:
        "<SA-08(13)_ODP системи або компоненти системи> реалізують принцип проектування безпеки з мінімізацією елементів безпеки. (SA-8(13))",
      parameters: [
        {:sa_8_13_01,
  ...
  def spec(:"id-spe-sa-8-14") do
    %{
      ...
      description: "",
      title:
        "<SA-08(14)_ODP системи або компоненти системи> реалізують принцип побудови безпеки за принципом найменших привілеїв. (SA-8(14))",
      parameters: [
        {:sa_8_14_01,
  ...
  def spec(:"id-spe-sa-8-15") do
    %{
      ...
      description: "",
      title:
        "<SA-08(15)_ODP системи або компоненти системи> реалізують принцип проектування безпеки попереднього дозволу. (SA-8(15))",
      parameters: [
        {:sa_8_15_01,
  ...
  def spec(:"id-spe-sa-8-16") do
    %{
      ...
      description: "",
      title:
        "<SA-08(16)_ODP системи або компоненти системи> реалізують принцип проектування безпеки самодостатньої надійності. (SA-8(16))",
      parameters: [
        {:sa_8_16_01,
  ...
  def spec(:"id-spe-sa-8-17") do
    %{
      ...
      description: "",
      title:
        "<SA-08(17)_ODP системи або компоненти системи> реалізують принцип проектування безпеки захищеного розподіленого вмісту. (SA-8(17))",
      parameters: [
        {:sa_8_17_01,
  ...
  def spec(:"id-spe-sa-8-18") do
    %{
      ...
      description: "",
      title:
        "<SA-08(18)_ODP системи або компоненти системи> реалізують принцип побудови безпеки довірених каналів зв'язку. (SA-8(18))",
      parameters: [
        {:sa_8_18_01,
  ...
  def spec(:"id-spe-sa-8-19") do
    %{
      ...
      description: "",
      title:
        "<SA-08(19)_ODP системи або компоненти системи> реалізують принцип проектування безпеки довготривалого (SA-8(19))",
      parameters: [
        {:sa_8_19_01,
  ...
  def spec(:"id-spe-sa-8-20") do
    %{
      ...
      description: "",
      title:
        "<SA-08(20)_ODP системи або компоненти системи> реалізують принцип безпечного управління метаданими. (SA-8(20))",
      parameters: [
        {:sa_8_20_01,
  ...
  def spec(:"id-spe-sa-8-21") do
    %{
      ...
      description: "",
      title:
        "<SA-08(21)_ODP системи або компоненти системи> реалізують принцип проектування безпеки на основі самоаналізу. (SA-8(21))",
      parameters: [
        {:sa_8_21_01,
  ...
  def spec(:"id-spe-sa-8-23") do
    %{
      ...
      description: "",
      title:
        "<SA-08(23)_ODP системи або компоненти системи> реалізують принцип проектування безпечних налаштувань за замовчуванням. (SA-8(23))",
      parameters: [
        {:sa_8_23_01,
         "БЕЗПЕКА ТА ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ - БЕЗПЕЧНІ ПАРАМЕТРИ ЗА ЗАМОВЧУВАННЯМ",
         [type: :string, default: nil]},
        {:sa_8_23_odp,
  ...
  def spec(:"id-spe-sa-8-27") do
    %{
      ...
      description: "",
      title:
        "<SA-08(27)_ODP системи або компоненти системи> реалізують принцип безпеки з урахуванням людського фактору. (SA-8(27))",
      parameters: [
        {:sa_8_27_01,
  ...
  def spec(:"id-spe-sa-8-31") do
    %{
      ...
      description: "",
      title:
        "<SA-08(31)_ODP системи або компоненти системи> реалізують принцип безпечної модифікації систем. (SA-8(31))",
      parameters: [
        {:sa_8_31_01,
  ...
  def spec(:"id-spe-sa-8-32") do
    %{
      ...
      description: "",
      title:
        "<SA-08(32)_ODP системи або компоненти системи> реалізують принцип достатньої допускної документації. (SA-8(32))",
      parameters: [
        {:sa_8_32_01,
  ...
  def spec(:"id-spe-sa-8-33") do
    %{
      ...
      parameters: [
        {:sa_8_33_01, "БЕЗПЕКА ТА МІНІМІЗАЦІЯ ПРИВАТНІСТЬ ПРИНЦИПІВ ІНЖИНІРИНГУ -",
         [type: :string, default: nil]},
        {:sa_8_33_odp,
  ...
  def spec(:"id-spe-sa-9-1") do
    %{
      ...
      parameters: [
        {:sa_9_1_01,
         "ЗОВНІШНІ ПОСЛУГИ ДЛЯ СИСТЕМИ- ОЦІНЮВАННЯ РИЗИКІВ ТА ОРГАНІЗАЦІЙНІ ПОГОДЖЕННЯ",
         [type: :string, default: nil]},
        {:sa_9_1_a,
  ...
  def spec(:"id-spe-sa-9-5") do
    %{
      ...
      parameters: [
        {:sa_9_5_01, "ЗОВНІШНІ ПОСЛУГИ ДЛЯ СИСТЕМИ- МІСЦЕ ОБРОБКИ, ЗБЕРІГАННЯ ТА ОБСЛУГОВУВАННЯ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-9-6") do
    %{
      id: :"id-spe-sa-9-6",
      description:
        "КЛЮЧІ, Зберігати контроль над криптографічними ключами для зашифрованої інформації, яка зберігається або передається через зовнішню систему.",
      title:
  ...
  def spec(:"id-spe-sa-11") do
    %{
      ...
      parameters: [
        {:sa_11_01, "УПРАВЛІННЯ КОНФІГУРАЦІЄЮ РОЗРОБНИКА - ПРЕДСТАВНИКИ БЕЗПЕКИ ТА ПРИВАТНОСТІ",
         [type: :string, default: nil]},
        {:sa_11_odp_01,
  ...
  def spec(:"id-spe-sa-11-2") do
    %{
      ...
      parameters: [
        {:sa_11_2_01,
         "ТЕСТУВАННЯ ТА ОЦІНЮВАННЯ РОЗРОБНИКА - МОДЕЛЮВАННЯ ЗАГРОЗ ТА АНАЛІЗ ВРАЗЛИВОСТЕЙ",
         [type: :string, default: nil]},
        {:sa_11_2_a_01,
  ...
  def spec(:"id-spe-sa-11-3") do
    %{
      ...
      parameters: [
        {:sa_11_3_01,
         "ТЕСТУВАННЯ ТА ОЦІНЮВАННЯ РОЗРОБНИКА ПЕРЕВІРКА ПЛАНІВ ОЦІНЮВАННЯ ТА ДОКАЗІВ - НЕЗАЛЕЖНА",
         [type: :string, default: nil]},
        {:sa_11_3_a_01,
  ...
  def spec(:"id-spe-sa-13") do
    %{
      ...
      parameters: [
        {:sa_13_01, "ДОВІРЧІСТЬ [Вилучено: включено до SA-8]", [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-15-7") do
    %{
      ...
      description: "",
      title:
        "Співбесіда: [ВИБІР: Персонал організації, який відповідає за придбання систем та послуг; персонал організації, який відповідає за інформаційну ПРОЦЕС, СТАНДАРТИ ТА ІНСТРУМЕНТИ РОЗРОБКИ безпеку; розробник системи]. АНАЛІЗ ВРАЗЛИВОСТЕЙ АВТОМАТИЗОВАНИЙ (SA-15(7))",
      parameters: [
        {:sa_15_7_a,
        ...
        {:sa_15_7_c,
         ...
         [type: :string, default: "щорічно"]},
        {:sa_15_7_d,
         "Повинен розробник системи, системного компонента або системної послуги надавати вихідні дані інструментів і результати аналізу частота персоналу або ролям. для",
         [type: :list, default: ["admin", "security_officer"]]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sa-17") do
    %{
      ...
      parameters: [
        {:sa_17_01, "ПРОЄКТ ТА АРХІТЕКТУРА РОЗРОБНИКА БЕЗПЕКИ ТА ПРИВАТНОСТІ ДЛЯ",
         [type: :string, default: nil]},
        {:sa_17_a_01,
  ...
  def spec(:"id-spe-sa-17-1") do
    %{
      ...
      parameters: [
        {:sa_17_1_01,
         "ПРОЄКТ ТА АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ РОЗРОБНИКА - ФОРМАЛЬНА МОДЕЛЬ ПОЛІТИКИ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:sa_17_1_a_02,
  ...
  def spec(:"id-spe-sa-17-2") do
    %{
      ...
      parameters: [
        {:sa_17_2_01,
         "ПРОЄКТ ТА АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ РОЗРОБНИКА - КОМПОНЕНТИ, ЩО НЕОБХІДНІ ДЛЯ ЗАБЕЗПЕЧЕННЯ БЕЗПЕКИ",
         [type: :string, default: nil]},
        {:sa_17_2_a_01,
  ...
  def spec(:"id-spe-sa-17-3") do
    %{
      ...
      parameters: [
        {:sa_17_3_01,
         "ПРОЄКТ ТА АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ РОЗРОБНИКА - ФОРМАЛЬНА ВІДПОВІДНІСТЬ",
         [type: :string, default: nil]},
        {:sa_17_3_a_01,
         "Зобов'язаний розробник системи, системного компонента або системної служби визначати апаратне забезпечення, що має відношення до безпеки",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-sa-17-4") do
    %{
      ...
      parameters: [
        {:sa_17_4_01,
         "ПРОЄКТ ТА АРХІТЕКТУРА БЕЗПЕКИ ТА ПРИВАТНОСТІ РОЗРОБНИКА - НЕФОРМАЛЬНА ВІДПОВІДНІСТЬ",
         [type: :string, default: nil]},
        {:sa_17_4_a_01,
  ...
  def spec(:"id-spe-sa-22") do
    %{
      ...
      parameters: [
        {:sa_22_01, "КОМПОНЕНТИ СИСТЕМИ, ЩО НЕ ПІДТРИМУЮТЬСЯ", [type: :string, default: nil]},
        {:sa_22_odp_01,
  ...
  def spec(:"id-spe-sa-23") do
    %{
      id: :"id-spe-sa-23",
      description:
        "збільшення; реконфігурація] на [Призначення: системи або системні компоненти, визначені організацією], які підтримують важливі служби або функції для підвищення надійності цих систем або компонентів.",
  ...
  def spec(:"id-spe-sc-1") do
    %{
      ...
      parameters: [
        {:sc_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ ЗАХИСТУ СИСТЕМИ ТА КОМУНІКАЦІЙ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:sc_1_odp_01,
  ...
  def spec(:"id-spe-sc-3-4") do
    %{
      ...
      parameters: [
        {:sc_3_4_01, "ІЗОЛЯЦІЯ ФУНКЦІЙ ЗВ’ЯЗНІСТЬ БЕЗПЕКИ - З’ЄДНАННЯ МОДУЛІВ ТА",
         [type: :string, default: nil]},
        {:sc_3_4_02,
  ...
  def spec(:"id-spe-sc-5") do
    %{
      ...
      parameters: [
        {:sc_5_01, "ЗАХИСТ ВІД АТАК «ВІДМОВА В ОБСЛУГОВУВАННІ»", [type: :string, default: nil]},
        {:sc_5_odp_01,
  ...
  def spec(:"id-spe-sc-5-3") do
    %{
      ...
      parameters: [
        {:sc_5_3_01, "ЗАХИСТ ВІД АТАК «ВІДМОВА В ОБСЛУГОВУВАННІ» - ВИЯВЛЕННЯ ТА МОНІТОРИНГ",
         [type: :string, default: nil]},
        {:sc_5_3_a,
  ...
  def spec(:"id-spe-sc-7-2") do
    %{
      ...
      parameters: [
        {:sc_7_2_01, "ЗАХИСТ ПЕРИМЕТРА - ПУБЛІЧНИЙ ДОСТУП [Вилучено: включено до SC-7]]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sc-7-5") do
    %{
      ...
      parameters: [
        {:sc_7_5_01, "ЗАХИСТ ПЕРИМЕТРА - ВІДМОВА ЗА ЗАМОВЧУВАННЯМ - ДОЗВІЛ ЗА ВИНЯТКОМ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sc-7-9") do
    %{
      ...
      title: "ЗАХИСТ (SC-7(9))",
      parameters: [
        {:sc_7_9_01, "ЗАХИСТ ПЕРИМЕТРА - ОБМЕЖЕННЯ ТРАФІКУ ВИХІДНИХ ПОВІДОМЛЕНЬ",
         [type: :string, default: nil]},
        {:sc_7_9_a_01,
  ...
  def spec(:"id-spe-sc-7-13") do
    %{
      ...
      description: "",
      title:
        "ізольовані <SC-07(13)_ODP засоби, механізми та компоненти підтримки інформаційної безпеки> від інших внутрішніх компонентів системи шляхом впровадження фізично відокремлених підмереж з керованими інтерфейсами до інших компонентів системи. (SC-7(13))",
      parameters: [
        {:sc_7_13_01,
  ...
  def spec(:"id-spe-sc-8-1") do
    %{
      ...
      parameters: [
        {:sc_8_1_01, "КОНФІДЕНЦІЙНІСТЬ ТА КРИПТОГРАФІЧНИЙ ЗАХИСТ ЦІЛІСНІСТЬ ПЕРЕДАЧІ -",
         [type: :string, default: "AES-256-GCM"]},
        {:sc_8_1_odp,
  ...
  def spec(:"id-spe-sc-8-5") do
    %{
      ...
      parameters: [
        {:sc_8_5_01, "КОНФІДЕНЦІЙНІСТЬ ТА СИСТЕМА РОЗПОДІЛУ ЦІЛІСНІСТЬ ПЕРЕДАЧІ - ЗАХИЩЕНА",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sc-9") do
    %{
      ...
      parameters: [
        {:sc_9_01, "КОНФІДЕНЦІЙНІСТЬ ПЕРЕДАЧІ [Вилучено: включено до SC-8]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sc-17") do
    %{
      id: :"id-spe-sc-17",
      description:
        "a. Випускати сертифікати відкритого ключа відповідно до [Призначення: визначеної організацією політики сертифікації]; b. Отримувати сертифікати відкритого ключа від затвердженого постачальника послуг.",
  ...
  def spec(:"id-spe-sc-31") do
    %{
      id: :"id-spe-sc-31",
      description:
        "a. Проводити аналіз прихованого каналу, щоб визначити ті аспекти комунікацій у системі, які володіють потенційними можливостями для реалізації прихованих каналів [Вибір (один або кілька): зберігання; синхронізації]. b. Оцінювати максимальну пропускну здатність цих каналів.",
  ...
  def spec(:"id-spe-sc-33") do
    %{
      ...
      parameters: [
        {:sc_33_01, "ПІДГОТОВКА ЦІЛІСНОСТІ ПЕРЕДАЧІ [Вилучено: включено до SC-8]",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sc-34") do
    %{
      id: :"id-spe-sc-34",
      description:
        "У [Призначення: визначені організацією системні компоненти]: a. Завантажити та виконати операційне середовище з апаратного носія, що працює в режимі лише для зчитування. b. Завантажити та виконати [Призначення: визначені організацією застосунки] з апаратного носія, що працює в режимі лише для зчитування.",
  ...
  def spec(:"id-spe-sc-41") do
    %{
      ...
      parameters: [
        {:sc_41_01, "ДОСТУП ДО ПОРТІВ ТА ПРИСТРОЇВ ВВЕДЕННЯ, ВИВЕДЕННЯ",
         [type: :string, default: nil]},
        {:sc_41_odp_01,
  ...
  def spec(:"id-spe-sc-42") do
    %{
      id: :"id-spe-sc-42",
      description:
        "a. Заборонити дистанційну активацію можливостей зондування навколишнього середовища в системах організації або компонентах системи за такими виключеннями: [Призначення: визначені організацією виключення, в яких допускається дистанційна активація датчиків]. b. Забезпечити явну вказівку використання датчика для [Призначення: визначений організацією клас користувачів].",
      title:
  ...
  def spec(:"id-spe-sc-43") do
    %{
      id: :"id-spe-sc-43",
      description:
        "a. Встановити обмеження на використання та рекомендації щодо впровадження для [Призначення: визначених організацією компонентів системи]. b. Проводити авторизацію, спостереження та контроль використання таких компонентів у системі.",
  ...
  def spec(:"id-spe-sc-45") do
    %{
      id: :"id-spe-sc-45",
      description: "системи і між ними.",
  ...
  def spec(:"id-spe-sc-48-1") do
    %{
      ...
      description: "",
      title:
        "<SC-48(01)_ODP[01] датчики та засоби моніторингу> динамічно переміщуються до <SC-48(01)_ODP[02] місць розташування> за <SC-48(01)_ODP[03] умов або обставин>. (SC-48(1))",
      parameters: [
        {:sc_48_1_01,
  ...
  def spec(:"id-spe-si-2-3") do
    %{
      ...
      parameters: [
        {:si_2_3_01,
         "ВИПРАВЛЕННЯ ДЕФЕКТІВ - ЧАС ДЛЯ УСУНЕННЯ ДЕФЕКТІВ ТА ОРІЄНТИРИ ДЛЯ КОРИГУВАЛЬНИХ ДІЙ",
         [type: :integer, default: 30]},
        {:si_2_3_a,
  ...
  def spec(:"id-spe-si-2-4") do
    %{
      ...
      parameters: [
        {:si_2_4_01, "ВИПРАВЛЕННЯ ДЕФЕКТІВ - АВТОМАТИЧНІ ЗАСОБИ УПРАВЛІННЯ ВИПРАВЛЕННЯМИ",
         [type: :string, default: "автоматизований засіб моніторингу"]},
        {:si_2_4_odp,
  ...
  def spec(:"id-spe-si-2-6") do
    %{
      ...
      parameters: [
        {:si_2_6_01,
         "ВИПРАВЛЕННЯ ДЕФЕКТІВ - ВИДАЛЕННЯ ПОПЕРЕДНІХ ВЕРСІЙ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ",
         [type: :string, default: nil]},
        {:si_2_6_odp,
  ...
  def spec(:"id-spe-si-3-5") do
    %{
      ...
      parameters: [
        {:si_3_5_01, "ЗАХИСТ ВІД ШКІДЛИВОГО ЗБЕРІГАННЯ ДАНИХ [Вилучено: включено до MP-7]. КОДУ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-3-6") do
    %{
      ...
      parameters: [
        {:si_3_6_01,
         "ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - ТЕСТУВАННЯ ТА ВЕРИФІКАЦІЯ - ПОРТАТИВНІ ПРИСТРОЇ",
         [type: :string, default: nil]},
        {:si_3_6_a,
  ...
  def spec(:"id-spe-si-3-8") do
    %{
      ...
      parameters: [
        {:si_3_8_01, "ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - ВИЯВЛЕННЯ НЕАВТОРИЗОВАНИХ КОМАНД",
         [type: :string, default: nil]},
        {:si_3_8_a,
  ...
  def spec(:"id-spe-si-3-10") do
    %{
      ...
      parameters: [
        {:si_3_10_01, "ЗАХИСТ ВІД ШКІДЛИВОГО КОДУ - АНАЛІЗ ШКІДЛИВОГО КОДУ",
         [type: :string, default: nil]},
        {:si_3_10_a,
  ...
  def spec(:"id-spe-si-4-2") do
    %{
      ...
      parameters: [
        {:si_4_2_01,
         "МОНІТОРИНГ СИСТЕМИ - АВТОМАТИЗОВАНІ МЕХАНІЗМИ АНАЛІЗУ В РЕАЛЬНОМУ ЧАСІ ЗАСОБИ ТА",
         [type: :integer, default: 30]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-4-4") do
    %{
      ...
      parameters: [
        {:si_4_4_01, "МОНІТОРИНГ СИСТЕМИ КОМУНІКАЦІЙ - ТРАФІК ВХІДНИХ І ВИХІДНИХ",
         [type: :string, default: nil]},
        {:si_4_4_a_01,
  ...
  def spec(:"id-spe-si-4-7") do
    %{
      ...
      parameters: [
        {:si_4_7_01, "МОНІТОРИНГ СИСТЕМИ ПІДОЗРІЛІ ПОДІЇ - АВТОМАТИЧНЕ РЕАГУВАННЯ НА",
         [type: :list, default: ["login", "logout", "failed_attempt"]]},
        {:si_4_7_a,
  ...
  def spec(:"id-spe-si-4-13") do
    %{
      ...
      parameters: [
        {:si_4_13_01, "МОНІТОРИНГ СИСТЕМИ - АНАЛІЗ ТРАФІКУ ТА ШАБЛОНІВ ПОДІЙ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-si-4-15") do
    %{
      ...
      parameters: [
        {:si_4_15_01, "МОНІТОРИНГ СИСТЕМИ - ПЕРЕХІД ВІД БЕЗДРОТОВОГО ЗВ’ЯЗКУ ДО ПРОВІДНИХ МЕРЕЖ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-4-22") do
    %{
      ...
      parameters: [
        {:si_4_22_01, "МОНІТОРИНГ СИСТЕМИ - НЕСАНКЦІОНОВАНІ ПОСЛУГИ МЕРЕЖІ",
         [type: :string, default: nil]},
        {:si_4_22_a,
  ...
  def spec(:"id-spe-si-5") do
    %{
      ...
      parameters: [
        {:si_5_01, "ПОПЕРЕДЖЕННЯ, РЕКОМЕНДАЦІЇ ТА ДИРЕКТИВИ З БЕЗПЕКИ",
         [type: :string, default: nil]},
        {:si_5_odp_01,
  ...
  def spec(:"id-spe-si-6-1") do
    %{
      ...
      description: "",
      title:
        "ПЕРЕВІРКА БЕЗПЕКИ ТА ФУНКЦІЙ ПРИВАТНОСТІ - СПОВІЩЕННЯ ПРО НЕУСПІШНЕ ПРОХОДЖЕННЯ ТЕСТІВ З БЕЗПЕКИ (SI-6(1))",
      parameters: [
        {:si_6_1_01,
  ...
  def spec(:"id-spe-si-7") do
    %{
      id: :"id-spe-si-7",
      description:
        "a. Впровадити механізми захисту від спаму в точках входу та виходу системи, щоб виявляти та протидіяти небажаним повідомленням. b. Оновлювати механізми захисту від спаму, коли доступні нові механізми відповідно до організаційної політики та процедур управління конфігурацією.",
      title: "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ (SI-7)",
      parameters: [
        {:si_7_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ ВБУДОВАНОГО",
         [type: :string, default: nil]},
        {:si_7_odp_01,
  ...
  def spec(:"id-spe-si-7-1") do
    %{
      ...
      parameters: [
        {:si_7_1_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ПЕРЕВІРКА ЦІЛІСНОСТІ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-7-3") do
    %{
      ...
      parameters: [
        {:si_7_3_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ІНСТРУМЕНТИ ЦІЛІСНОСТІ З ЦЕНТРАЛІЗОВАНИМ УПРАВЛІННЯМ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-7-4") do
    %{
      ...
      description: "",
      title:
        "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ – ПАКУВАННЯ З ІНДИКАЦІЄЮ ОЗНАК ЇЇ НЕСАНКЦІОНОВАНОГО РОЗКРИТТЯ (SI-7(4))",
      parameters: [
        {:si_7_4_01,
  ...
  def spec(:"id-spe-si-7-5") do
    %{
      ...
      parameters: [
        {:si_7_5_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - АВТОМАТИЧНІ ВІДПОВІДІ ПРО ПОРУШЕННЯ ЦІЛІСНОСТІ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-7-6") do
    %{
      ...
      parameters: [
        {:si_7_6_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ КРИПТОГРАФІЧНИЙ ЗАХИСТ",
         [type: :string, default: "AES-256-GCM"]},
        {:si_7_6_02,
  ...
  def spec(:"id-spe-si-7-7") do
    %{
      ...
      parameters: [
        {:si_7_7_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ІНТЕГРАЦІЯ ВИЯВЛЕННЯ І РЕАГУВАННЯ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-si-7-8") do
    %{
      ...
      parameters: [
        {:si_7_8_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - АУДИТ ВАЖЛИВИХ ПОДІЙ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-7-9") do
    %{
      ...
      parameters: [
        {:si_7_9_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ПЕРЕВІРКА ПРОЦЕСУ ЗАВАНТАЖЕННЯ",
         [type: :string, default: nil]},
        {:si_7_9_odp,
  ...
  def spec(:"id-spe-si-7-11") do
    %{
      ...
      description: "",
      title:
        "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ОБМЕЖЕНЕ СЕРЕДОВИЩЕ З ОБМЕЖЕНИМИ ПРИВІЛЕЯМИ (SI-7(11))",
      parameters: [
        {:si_7_11_01,
  ...
  def spec(:"id-spe-si-7-13") do
    %{
      ...
      description: "",
      title:
        "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ВИКОНАННЯ КОДУ В ЗАХИЩЕНИХ СЕРЕДОВИЩАХ (SI-7(13))",
      parameters: [
        {:si_7_13_01,
  ...
  def spec(:"id-spe-si-7-14") do
    %{
      ...
      description: "",
      title:
        "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ДВІЙКОВИЙ АБО МАШИННО-ВИКОНУВАНИЙ КОД (SI-7(14))",
      parameters: [
        {:si_7_14_01,
  ...
  def spec(:"id-spe-si-7-16") do
    %{
      ...
      parameters: [
        {:si_7_16_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ - ТЕРМІН ВИКОНАННЯ ПРОЦЕСУ БЕЗ НАГЛЯДУ",
         [type: :string, default: nil]},
        {:si_7_16_odp,
  ...
  def spec(:"id-spe-si-7-17") do
    %{
      ...
      parameters: [
        {:si_7_17_01,
         "ЦІЛІСНІСТЬ ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ, ВБУДОВАНОГО ПРОГРАМНОГО ЗАБЕЗПЕЧЕННЯ ТА ІНФОРМАЦІЇ – САМОЗАХИСТ ПРОГРАМ ВІД САМОВІЛЬНОГО ВИКОНАННЯ",
         [type: :string, default: nil]},
        {:si_7_17_odp,
  ...
  def spec(:"id-spe-si-10-1") do
    %{
      ...
      parameters: [
        {:si_10_1_01, "ПЕРЕВІРКА ВВОДУ ПЕРЕВИЗНАЧЕННЯ ІНФОРМАЦІЇ - МОЖЛИВІСТЬ РУЧНОГО",
         [type: :string, default: nil]},
        {:si_10_1_a,
  ...
  def spec(:"id-spe-si-10-3") do
    %{
      ...
      parameters: [
        {:si_10_3_01, "ПЕРЕВІРКА ВВОДУ ІНФОРМАЦІЇ - ПЕРЕДБАЧУВАНА ПОВЕДІНКА",
         [type: :string, default: nil]},
        {:si_10_3_02,
  ...
  def spec(:"id-spe-si-10-5") do
    %{
      ...
      parameters: [
        {:si_10_5_01,
         "ПЕРЕВІРКА ВВОДУ ІНФОРМАЦІЇ - ОБМЕЖЕННЯ ВХІДНИХ ДАНИХ ДОВІРЕНИМИ ДЖЕРЕЛАМИ І ЗАТВЕРДЖЕНИМИ ФОРМАТАМИ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-11") do
    %{
      id: :"id-spe-si-11",
      description:
        "a. Створити повідомлення про помилки, які надають інформацію, необхідну для реалізації виправних дій, без виявлення інформації, що може бути використана. b. Показувати повідомлення про помилки лише [Призначення: визначений організацією персонал або посадові особи].",
  ...
  def spec(:"id-spe-si-13") do
    %{
      id: :"id-spe-si-13",
      description:
        "a. Визначити середній час до збою (MTTF) для [Призначення: визначені організацією компоненти системи] в певних середовищах роботи. b. Надати замінні компоненти системи та засоби для заміни активних компонентів резервними компонентами відповідно до [Призначення: визначені організацією критерії заміни].",
  ...
  def spec(:"id-spe-si-13-5") do
    %{
      ...
      parameters: [
        {:si_13_5_01, "ЗАПОБІГАННЯ ПЕРЕДБАЧУВАНИХ АВАРІЙНОГО ПЕРЕМИКАННЯ ЗБОЇВ - МОЖЛИВІСТЬ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-18") do
    %{
      id: :"id-spe-si-18",
      description:
        "a. Перевіряти точність, актуальність, своєчасність і повноту персональної інформації протягом її життєвого циклу [Завдання: частота, визначена організацією]; b. Виправляти або видаляти неточну або застарілу персональну інформацію.",
  ...
  def spec(:"id-spe-si-18-2") do
    %{
      ...
      parameters: [
        {:si_18_2_01, "ОПЕРАЦІЇ ЗАБЕЗПЕЧЕННЯ ЯКОСТІ ДАНИХ - ТЕГУВАННЯ ДАНИХ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-19") do
    %{
      id: :"id-spe-si-19",
      description:
        "a. Видаліть такі елементи персональних даних з наборів даних: [Призначення: визначені організацією елементи персональних даних]; b. Оцініть [Призначення: деідентифікації. частота, визначена організацією] ефективність",
  ...
  def spec(:"id-spe-si-19-4") do
    %{
      ...
      parameters: [
        {:si_19_4_01,
         "ДЕІДЕНТИФІКАЦІЯ - ВИДАЛЕННЯ, МАСКУВАННЯ, ШИФРУВАННЯ, ХЕШУВАННЯ АБО ЗАМІНА ПРЯМИХ ІДЕНТИФІКАТОРІВ",
         [type: :string, default: "AES-256-GCM"]}
      ]
    }
  end
  ...
  def spec(:"id-spe-si-20") do
    %{
      id: :"id-spe-si-20",
      description:
        "щоб визначити, чи дані організації були викрадені або неналежним чином видалені з організації: [Призначення: визначені організацією системи або системні компоненти].",
  ...
  def spec(:"id-spe-si-21") do
    %{
      id: :"id-spe-si-21",
      description:
        "[Призначення: частота, визначена організацією] або згенеруйте інформацію за запитом і видаліть її, коли в ній більше не буде потреби.",
  ...
  def spec(:"id-spe-sr-1") do
    %{
      ...
      parameters: [
        {:sr_1_01, "ПОЛІТИКА ТА ПРОЦЕДУРИ УПРАВЛІННЯ РИЗИКАМИ ЛАНЦЮГА ПОСТАЧАННЯ",
         [type: :list, default: ["default_deny_rule", "abac_rule_1"]]},
        {:sr_1_odp_01,
  ...
  def spec(:"id-spe-sr-3-1") do
    %{
      ...
      parameters: [
        {:sr_3_1_01, "КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - РІЗНІ БАЗИ ПОСТАЧАННЯ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sr-3-2") do
    %{
      ...
      parameters: [
        {:sr_3_2_01, "КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - ОБМЕЖЕННЯ ШКОДИ",
         [type: :string, default: nil]},
        {:sr_3_2_odp,
  ...
  def spec(:"id-spe-sr-3-3") do
    %{
      ...
      parameters: [
        {:sr_3_3_01,
         "КОНТРОЛЬ ЛАНЦЮГА ПОСТАЧАННЯ І ПРОЦЕСІВ - ПЕРЕНЕСЕННЯ ЗАХОДІВ ЗАХИСТУ УПРАВЛІННЯ РИЗИКАМИ ЛАНЦЮГА ПОСТАЧАННЯ ДО СУБПІДРЯДНИКІВ",
         [type: :string, default: nil]}
      ]
    }
  end
  ...
  def spec(:"id-spe-sr-4") do
    %{
      id: :"id-spe-sr-4",
      description:
        "таких систем, компонентів системи і пов’язаних даних: [Призначення: системи, визначені організацією, системні компоненти та пов’язані дані].",
  ...
  def spec(:"id-spe-sr-5") do
    %{
      id: :"id-spe-sr-5",
      description:
        "та методи закупівель, щоб захистити від ризиків ланцюга постачання, визначити та пом’якшити їх: [Призначення: визначені організацією стратегії придбання, контрактні інструменти та методи закупівель].",
  ...
  def spec(:"id-spe-sr-5-2") do
    %{
      ...
      parameters: [
        {:sr_5_2_01,
         "СТРАТЕГІЇ ПРИДБАННЯ, ІНСТРУМЕНТИ І МЕТОДИ - ОЦІНКА ПЕРЕД ВІДБОРОМ, ПРИЙНЯТТЯ, МОДИФІКАЦІЯ ЧИ ОНОВЛЕННЯ",
         [type: :string, default: nil]},
  ...
  def spec(:"id-spe-sr-6") do
    %{
      id: :"id-spe-sr-6",
      description:
        "постачальниками або підрядниками, системою, системним компонентом або системною послугою, яку вони надають [Призначення: частота, визначена організацією].",
  ...
  def spec(:"id-spe-sr-7") do
    %{
      id: :"id-spe-sr-7",
      description:
        "щоб захистити інформацію, пов’язану з ланцюгом постачання для системи, системного компонента чи системної служби: [Призначення: визначені організацією заходи захисту операційної безпеки (OPSEC)].",
  ...
  def spec(:"id-spe-sr-8") do
    %{
      id: :"id-spe-sr-8",
      description:
        "постачання для системи, системного компонента або системної послуги для [Вибір (одного або кількох): повідомлення про порушення ланцюга постачання; результати оцінювання або аудитів; [Призначення: інформація, визначена організацією]].",
  ...
  def spec(:"id-spe-sr-9") do
    %{
      id: :"id-spe-sr-9",
      description: "системи, системного компонента або системної служби.",
  ...
  def spec(:"id-spe-sr-10") do
    %{
      id: :"id-spe-sr-10",
      description:
        "більше): випадковим чином обраних; на [Призначення: частота, визначена організацією], після [Призначення: визначені організацією ознаки необхідності перевірки]] для виявлення втручання: [Призначення: визначені організацією системи або компоненти системи].",
  ...
  def spec(:"id-spe-sr-11") do
    %{
      id: :"id-spe-sr-11",
      description:
        "a. Розробити та впровадити політику та процедури боротьби з підробками, які включають засоби для виявлення та запобігання потраплянню підроблених компонентів у систему; b. Повідомляти про підроблені системні компоненти [Вибір (один або кілька): джерело підробленого компонента; [Призначення: зовнішні звітні організації, визначені організацією]; [Призначення: персонал або ролі, визначені організацією]].",
  ...
  def spec(:"id-spe-sr-12") do
    %{
      id: :"id-spe-sr-12",
      description:
        "інструменти або системні компоненти] за допомогою таких прийомів і методів: [Призначення: визначені організацією прийоми та методи].",
