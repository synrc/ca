defmodule CA.Profile.Data do
  ...
  def spec(:"id-spe-ac-3-15") do
    %{
      id: :"id-spe-ac-3-15",
      description: "(a) Застосовувати [Призначення: визначену організацією політику обов’язкового контролю доступу] до набору охоплених суб’єктів і об’єктів, указаних у політиці;\n(b) Застосування [Призначення: визначена організацією дискреційна політика контролю доступу] до набору охоплених суб’єктів і об’єктів, указаних у політиці.",
      title: "id-spe-ac-3-15",
      parameters: [
        {:ac_3_15_a_01,
  ...
  def spec(:"id-spe-ac-4-5") do
    %{
      id: :"id-spe-ac-4-5",
      description: "Впровадити [Призначення: визначені організацією вбудовування типів даних в інші типи даних. обмеження] для",
      title: "id-spe-ac-4-5",
      parameters: [
        {:ac_4_5_odp,
  ...
  def spec(:"id-spe-ac-5") do
    %{
      id: :"id-spe-ac-5",
      description: "a. Розмежувати і документувати [Призначення: визначені організацією обов’язки окремих осіб].\nb. Установити правила авторизації доступу для підтримки розмежування обов’язків.",
  ...
  def spec(:"id-spe-ac-11") do
    %{
      id: :"id-spe-ac-11",
      description: "a. Заборонити подальший доступ до системи шляхом ініціювання блокування пристрою після [Призначення: визначеного організацією періоду] бездіяльності або після отримання запиту від користувача.\nb. Зберігати блокування пристрою, поки користувач не відновить доступ, використовуючи встановлені процедури ідентифікації та автентифікації.",
  ...
  def spec(:"id-spe-ac-14") do
    %{
      id: :"id-spe-ac-14",
      description: "a. Визначити [Призначення: дозволені організацією дії користувачів], які можуть виконуватися в системі без ідентифікації або автентифікації відповідно до завдань та функцій організації.\nb. Документувати та визначити відповідне обґрунтування в плані безпеки системи дій користувача, які не потребують ідентифікації або автентифікації.",
      title: "id-spe-ac-14",
      parameters: [
        {:ac_14_a,
  ...
  def spec(:"id-spe-ac-17") do
    %{
      id: :"id-spe-ac-17",
      description: "a. Встановити та задокументувати обмеження на використання, вимоги до конфігурації/підключення та рекомендації щодо здійснення кожного типу віддаленого доступу.\nb. Авторизувати віддалений доступ до системи, перш ніж будуть дозволені такі підключення.",
  ...
  def spec(:"id-spe-ac-18") do
    %{
      id: :"id-spe-ac-18",
      description: "a. Установити обмеження на використання, вимоги до конфігурації/підключення та рекомендації щодо здійснення бездротового доступу.\nb. Авторизувати бездротовий доступ до системи, перш ніж будуть дозволені такі підключення.",
  ...
  def spec(:"id-spe-ac-19") do
    %{
      id: :"id-spe-ac-19",
      description: "a. Встановити обмеження на використання, вимоги до конфігурації, вимоги до підключення і рекомендації щодо впровадження мобільних пристроїв, контрольованих організацією.\nb. Авторизувати підключення мобільних пристроїв до систем, які експлуатуються організацією.",
      title: "id-spe-ac-19",
      parameters: [
        {:ac_19_a_01,
  ...
  def spec(:"id-spe-ac-21") do
    %{
      id: :"id-spe-ac-21",
      description: "a. Спростити обмін інформацією, надаючи авторизованим користувачам змогу визначати, чи відповідають повноваження на доступ, що призначені партнерам для обміну, обмеженням доступу та повноваженням з приватності щодо інформації для [Призначення: визначених організацією обставин обміну інформацією, коли це необхідно користувачу].\nb. Використовувати [Призначення: визначені організацією автоматизовані механізми або ручні процеси], щоб допомогти користувачам в ухваленні рішень щодо обміну інформацією та співпраці.",
  ...
  def spec(:"id-spe-at-4") do
    %{
      id: :"id-spe-at-4",
      description: "a. Документувати та відстежувати індивідуальні навчальні заходи із забезпечення безпеки та приватності, включно з базовою підготовкою з питань безпеки та приватності, а також спеціальною підготовкою з питань безпеки та приватності визначених посадових осіб.\nb. Зберігати індивідуальні записи про навчання впродовж [Призначення: визначеного організацією періоду часу].",
  ...
  def spec(:"id-spe-au-5") do
    %{
      id: :"id-spe-au-5",
      description: "a. Сповіщати [Призначення: визначені організацією персонал або посади] у разі збою обробки даних аудиту в [Призначення: визначений організацією період часу].\nb. Виконати наступні додаткові дії: [Призначення: визначені організацією дії, які необхідно зробити].",
      title: "id-spe-au-5",
      parameters: [
        {:au_5_a,
  ...
  def spec(:"id-spe-au-13") do
    %{
      id: :"id-spe-au-13",
      description: "a. Моніторинг [Завдання: визначена організацією інформація з відкритих джерел та/або інформаційних сайтів] [Завдання: частота, визначена організацією] на наявність доказів неавторизованого розголошення конфіденційної інформації;\nb. Якщо виявлено розголошення інформації:\n1. Повідомити [Призначення: персонал або ролі, визначені організацією];\n2. Виконайте такі додаткові дії: [Призначення: додаткові дії, визначені організацією].",
  ...
  def spec(:"id-spe-au-14") do
    %{
      id: :"id-spe-au-14",
      description: "a. Надавати та реалізувати можливість для [Призначення: користувачів або ролей, визначених організацією] для [Вибору (одного або кількох): збору/запису або перегляду/прослуховування] вмісту сесії користувача в [Призначення: обставини, визначені організацією];\nb. Розробляти, інтегрувати та використовувати діяльність з аудиту сесії, консультуючись із юрисконсультантом щодо її відповідності до чинних законів, розпоряджень, директив, нормативних актів, політик, стандартів і вказівок.",
  ...
  def spec(:"id-spe-ca-5") do
    %{
      id: :"id-spe-ca-5",
      description: "a. Розробити для системи план усунення недоліків та контрольні показники з метою документування запланованих коригувальних дій організації для усунення недоліків і зауважень, які виявлені в ході оцінювання заходів захисту, а також для зменшення або усунення відомих вразливостей у системі.\nb. Оновлювати чинний план усунення недоліків та контрольні показники з [Призначення: визначеною організацією частотою] на основі результатів оцінювання заходів, незалежних аудитів та постійного моніторингу.",
      title: "id-spe-ca-5",
      parameters: [
        {:ca_5_a,
  ...
  def spec(:"id-spe-ca-7-4") do
    %{
      id: :"id-spe-ca-7-4",
      description: "Забезпечити моніторинг ризиків, що є невід’ємною частиною стратегії постійного моніторингу та включає:\n(a) моніторинг ефективності;\n(b) моніторинг відповідності;\n(c) моніторинг змін.",
      title: "id-spe-ca-7-4",
      parameters: [
        {:ca_7_4_01,
  ...
  def spec(:"id-spe-cm-2-7") do
    %{
      id: :"id-spe-cm-2-7",
      description: "(a) Видавати [Призначення: визначених організацією систем або компонентів систем] з [Призначенням: визначеними організацією конфігураціями] особам, що перебувають у місцях, які організація вважає місцями зі значним ризиком;\n(b) Застосувати [Призначення: визначені організацією запобіжні заходи безпеки] до компонентів, коли особи повертаються з поїздки.",
      title: "id-spe-cm-2-7",
      parameters: [
        {:cm_2_7_a,
  ...
  def spec(:"id-spe-cm-5-5") do
    %{
      id: :"id-spe-cm-5-5",
      description: "(a) обмежити повноваження для зміни компонентів системи та інформації, пов’язаної із системою, у виробничому або операційному середовищі;\n(b) переглядати та переоцінювати повноваження [Призначення: визначеною організацією з частотою].",
      title: "id-spe-cm-5-5",
      parameters: [
        {:cm_5_5_a_01,
  ...
  def spec(:"id-spe-ma-3-5") do
    %{
      id: :"id-spe-ma-3-5",
      description: "(a) вимагати схвалення кожного віддаленого сеансу технічного обслуговування [Призначення: персоналом або роллю, що визначила організація];\n(b) повідомити [Призначення: персонал або ролі, що визначила організація] про дату та час запланованого віддаленого обслуговування.",
      title: "id-spe-ma-3-5",
      parameters: [
        {:ma_3_5_01,
  ...
  def spec(:"id-spe-mp-4") do
    %{
      id: :"id-spe-mp-4",
      description: "a. Фізично контролювати та безпечно зберігати [Призначення: визначені організацією типи цифрових та/або нецифрових носіїв інформації] в межах [Призначення: визначених організацією контрольованих зон].\nb. Захищати системні носії, які визначені в МР-4 до того часу, як носії знищуються або очищаються, з використанням затвердженого обладнання, методів та процедур.",
  ...
  def spec(:"id-spe-mp-6") do
    %{
      id: :"id-spe-mp-6",
      description: "a. Очищувати [Призначення: визначені організацією системні носії] перед утилізацією, випуском за межі організаційного контролю, або перед повторним використанням [Призначення: методами та процедурами очищення, визначеними організацією].\nb. Використовувати механізми очищення зі стійкістю та цілісністю, що відповідає категорії безпеки або рівню секретності інформації.",
      title: "id-spe-mp-6",
      parameters: [
        {:mp_6_a_01,
  ...
  def spec(:"id-spe-mp-7") do
    %{
      id: :"id-spe-mp-7",
      description: "a. [Вибір: обмежити; заборонити] використання [Призначення: визначених організацією типів носіїв системи] на [Призначення: визначені організацією системи або компоненти системи], використовуючи [Призначення: визначені організацією заходи безпеки].\nb. Заборонити використання портативних пристроїв зберігання даних в системах організації, якщо такі пристрої не мають визначеного власника.",
  ...
  def spec(:"id-spe-mp-8") do
    %{
      id: :"id-spe-mp-8",
      description: "a. сплануйте розташування або ділянку об’єкта, де знаходиться система, враховуючи фізичні та екологічні ризики;\nb. для існуючих об’єктів врахуйте фізичні та екологічні ризики в організаційній стратегії управління ризиками.",
      title: "id-spe-mp-8",
      parameters: [
        {:mp_8_a_01,
  ...
  def spec(:"id-spe-pl-7") do
    %{
      id: :"id-spe-pl-7",
      description: "a. Розробити концепцію експлуатації інформаційної системи, яка описує, як організація має намір керувати системою з погляду забезпечення безпеки та приватності інформації.\nb. Переглядати й оновлювати концепцію експлуатації [Призначення: з визначеною організацією частотою].",
  ...
  def spec(:"id-spe-pm-17") do
    %{
      id: :"id-spe-pm-17",
      description: "a. Розробити політику та процедури для забезпечення того, щоб вимоги до захисту публічної (некласифікованої) інформації, яка обробляється, зберігається або передається у зовнішніх системах, здійснювалися відповідно до чинного законодавства.\nb. Оновлювати політику та процедури [Призначення: з визначеною організацією частотою].",
      title: "id-spe-pm-17",
      parameters: [
        {:pm_17_odp_01,
  ...
  def spec(:"id-spe-pt-2") do
    %{
      id: :"id-spe-pt-2",
      description: "a. визначити та задокументувати [Призначення: повноваження, визначені організацією], які дозволяють [Призначення: обробку, визначену організацією] персональної інформації;\nb. обмежити [Призначення: обробку, визначену організацією] персональної інформації лише таким чином, яким дозволено (тільки до того, що дозволено)",
      title: "id-spe-pt-2",
      parameters: [
        {:pt_2_odp_01,
  ...
  def spec(:"id-spe-sc-5") do
    %{
      id: :"id-spe-sc-5",
      description: "a. [Призначення: захистити від; Обмежити] наслідки наступних типів подій відмови в обслуговуванні (DoS): [Призначення: визначені організацією типи подій відмови в обслуговуванні];\nb. Застосувати наступні заходи захисту для досягнення мети відмови обслуговування [Призначення: заходи захисту визначені організацією, за типом події відмови в обслуговуванні].",
      title: "id-spe-sc-5",
      parameters: [
        {:sc_5_odp_01,
  ...
  def spec(:"id-spe-sc-15") do
    %{
      id: :"id-spe-sc-15",
      description: "a. Заборонити віддалену активацію спільних обчислювальних пристроїв (хмар) та застосунків з такими виключеннями: [Призначення: визначені організацією виключення, у яких дозволена віддалена активація].\nb. Надати явну вказівку щодо використання користувачами фізично присутніми пристроями.",
      title: "id-spe-sc-15",
      parameters: [
  ...
  def spec(:"id-spe-sc-17") do
    %{
      id: :"id-spe-sc-17",
      description: "a. Випускати сертифікати відкритого ключа відповідно до [Призначення: визначеної організацією політики сертифікації];\nb. Отримувати сертифікати відкритого ключа від затвердженого постачальника послуг.",
      title: "id-spe-sc-17",
      parameters: [
  ...
  def spec(:"id-spe-sc-31") do
    %{
      id: :"id-spe-sc-31",
      description: "a. Проводити аналіз прихованого каналу, щоб визначити ті аспекти комунікацій у системі, які володіють потенційними можливостями для реалізації прихованих каналів [Вибір (один або кілька): зберігання; синхронізації].\nb. Оцінювати максимальну пропускну здатність цих каналів.",
  ...
  def spec(:"id-spe-sc-42") do
    %{
      id: :"id-spe-sc-42",
      description: "a. Заборонити дистанційну активацію можливостей зондування навколишнього середовища в системах організації або компонентах системи за такими виключеннями: [Призначення: визначені організацією виключення, в яких допускається дистанційна активація датчиків].\nb. Забезпечити явну вказівку використання датчика для [Призначення: визначений організацією клас користувачів].",
      title: "id-spe-sc-42",
      parameters: [
        {:sc_42_01,
  ...
  def spec(:"id-spe-sc-43") do
    %{
      id: :"id-spe-sc-43",
      description: "a. Встановити обмеження на використання та рекомендації щодо впровадження для [Призначення: визначених організацією компонентів системи].\nb. Проводити авторизацію, спостереження та контроль використання таких компонентів у системі.",
  ...
  def spec(:"id-spe-si-11") do
    %{
      id: :"id-spe-si-11",
      description: "a. Створити повідомлення про помилки, які надають інформацію, необхідну для реалізації виправних дій, без виявлення інформації, що може бути використана.\nb. Показувати повідомлення про помилки лише [Призначення: визначений організацією персонал або посадові особи].",
  ...
  def spec(:"id-spe-si-18") do
    %{
      id: :"id-spe-si-18",
      description: "a. Перевіряти точність, актуальність, своєчасність і повноту персональної інформації протягом її життєвого циклу [Завдання: частота, визначена організацією];\nb. Виправляти або видаляти неточну або застарілу персональну інформацію.",
      title: "id-spe-si-18",
      parameters: [
        {:si_18_odp_01,
  ...
  def spec(:"id-spe-si-19") do
    %{
      id: :"id-spe-si-19",
      description: "a. Видаліть такі елементи персональних даних з наборів даних: [Призначення: визначені організацією елементи персональних даних];\nb. Оцініть [Призначення: деідентифікації. частота, визначена організацією] ефективність",
