defmodule CA.Profile.Data do
  ...
  def spec(:"id-spe-pe-8-3") do
    %{
      id: :"id-spe-pe-8-3",
      description: "",
      title: "ІНФОРМАЦІЯ, ЩО ІДЕНТИФІКУЄ ОСОБУ, ЯКА МІСТИТЬСЯ В РЕЄСТРАХ ДОСТУПУ ВІДВІДУВАЧІВ, ОБМЕЖУЄТЬСЯ , ВИЗНАЧЕНИМИ В ОЦІНЦІ РИЗИКІВ ДЛЯ КОНФІДЕНЦІЙНОСТІ (PE-8(3))",
      parameters: [
        {:pe_8_3_01,
  ...
  def spec(:"id-spe-pe-12") do
    %{
      id: :"id-spe-pe-12",
      description: "",
      title: "РЕ-13 Протипожежний захист Контроль температури та РЕ-14 вологості Захист від пошкодження РЕ-15 водою РЕ-16 Доставлення та видалення (PE-12)",
      parameters: [
        {:pe_12_01,
  ...
  def spec(:"id-spe-pe-17") do
    %{
      id: :"id-spe-pe-17",
      description: "",
      title: "РЕ-17 Альтернативне робоче місце Розташування компонентів РЕ-18 системи РЕ-19 Витік інформації Моніторинг і відстеження РЕ-20 активів Захист від електромагнітного РЕ-21 імпульсу РЕ-22 Маркування компонентів (PE-17)",
      parameters: [
        {:pe_17_odp_01,
  ...
  def spec(:"id-spe-pe-20") do
    %{
      id: :"id-spe-pe-20",
      description: "",
      title: "ВИКОРИСТОВУЮТЬСЯ ДЛЯ ВІДСТЕЖЕННЯ ТА МОНІТОРИНГУ МІСЦЕЗНАХОДЖЕННЯ І ПЕРЕМІЩЕННЯ <PE- (PE-20)",
      parameters: [
        {:pe_20_01,
  ...
  def spec(:"id-spe-pe-21") do
    %{
      id: :"id-spe-pe-21",
      description: "",
      title: "ЗАСТОСОВУЮТЬСЯ ПРОТИ ПОШКОДЖЕННЯ ЕЛЕКТРОМАГНІТНИМИ ІМПУЛЬСАМИ ДЛЯ (PE-21)",
      parameters: [
        {:pe_21_01,
  ...
  def spec(:"id-spe-pe-22") do
    %{
      id: :"id-spe-pe-22",
      description: "",
      title: "ПОЗНАЧАЮТЬСЯ ІЗ ЗАЗНАЧЕННЯМ РІВНЯ ВПЛИВУ АБО КЛАСИФІКАЦІЇ ІНФОРМАЦІЇ, ЯКУ ДОЗВОЛЕНО ОБРОБЛЯТИ, ЗБЕРІГАТИ АБО ПЕРЕДАВАТИ ЗА ДОПОМОГОЮ АПАРАТНОГО КОМПОНЕНТА (PE-22)",
      parameters: [
        {:pe_22_01,
