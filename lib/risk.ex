  ...
  def taxonomy do
    %{
      ...
      data: [
        %{
          id: "R-DAT-01",
          name: "Втрата резервних копій (Backup Loss / Corruption)",
          desc: "Пошкодження або несанкціоноване видалення резервних копій (зокрема атаками типу Ransomware), що унеможливлює відновлення судових документів та баз ЦСК.",
          controls: ["CP", "MP", "SI"]
        },
        %{
          id: "R-DAT-02",
          name: "Витік електронних судових справ",
          desc: "Несанкціонований доступ до матеріалів судових справ та ухвал через вразливості в сховищах бекапів або основній базі.",
          controls: ["AC", "SC", "PE"]
        }
      ]
    }
