defmodule CA.CRT do
  ...
  def parseCertB64(file)  do {:ok, bin} = :file.read_file file ; parseCertBin97(:base64.decode(bin)) end
  def parseCertFile(file) do {:ok, bin} = :file.read_file file ; parseCertBin97(bin) end
