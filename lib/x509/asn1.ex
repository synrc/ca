defmodule X509.ASN1 do
  ...
  Enum.each(@records, fn
    {name, :ECPoint} ->
      Record.defrecord(
        name,
        :ECPoint,
        Record.extract(:ECPoint, from_lib: "ca/include/public_key.hrl")
      )
    ...
    {name, record} ->
      Record.defrecord(
        ...
        record,
        try do
          Record.extract(record, from_lib: "ca/include/OTP-PUB-KEY.hrl")
        rescue
          ArgumentError ->
            Record.extract(record, from_lib: "ca/include/PKCS-FRAME.hrl")
        end
      )
  end)
  ...
  @oids OIDImport.from_lib("ca/include/OTP-PUB-KEY.hrl") ++
          OIDImport.from_lib("ca/include/PKCS-FRAME.hrl")
