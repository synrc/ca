...
\textbf{Перелік заходів захисту:} Політика та процедури управління доступом (AC-1); Управління обліковими записами (AC-2); Id-spe-ac-2-3; Id-spe-ac-2-5; Деактивація облікових записів осіб з високим рівнем ризику (AC-2(13)); Забезпечення доступу (AC-3); Id-spe-ac-4; Розмежування обов'язків (AC-5); Мінімізація повноважень (AC-6); Id-spe-ac-6-1; Id-spe-ac-6-2; Id-spe-ac-6-5; Id-spe-ac-6-7; Id-spe-ac-6-9; Заборона непривілейованим користувачам виконувати привілейовані функції (AC-6(10)); Невдалі спроби входу в систему (AC-7); Попередження про використання системи (AC-8); Блокування пристрою (AC-11); Id-spe-ac-11-1; Припинення сеансу (AC-12); Віддалений доступ (AC-17); Id-spe-ac-17-3; Id-spe-ac-17-4; Бездротовий доступ (AC-18); Id-spe-ac-18-1; Id-spe-ac-18-3; Контроль доступу для мобільних пристроїв (AC-19); Id-spe-ac-19-5; Використання зовнішніх систем (AC-20); Id-spe-ac-20-1; Id-spe-ac-20-2; Публічно доступний контент (AC-22).
...
\textbf{Перелік заходів захисту:} Id-spe-at-1; Навчання з підвищення обізнаності (AT-2); Id-spe-at-2-2; Id-spe-at-2-3; Рольове навчання (AT-3).
...
\textbf{Перелік заходів захисту:} Id-spe-au-1; Події аудиту (AU-2); Зміст записів аудиту (AU-3); Id-spe-au-3-1; Id-spe-au-5; Огляд, аналіз і звітність аудиту (AU-6); Id-spe-au-6-3; Id-spe-au-7; Позначка часу (AU-8); Захист інформації аудиту (AU-9); Id-spe-au-9-4; Збереження записів аудиту (AU-11); Генерація даних аудиту (AU-12).
...
\textbf{Перелік заходів захисту:} Id-spe-ca-1; Оцінювання (CA-2); Взаємодія систем (CA-3); Id-spe-ca-5; Безперервний моніторинг (CA-7).
...
\textbf{Перелік заходів захисту:} Id-spe-cm-1; Базова конфігурація (CM-2); Id-spe-cm-2-7; Управління змінами конфігурації (CM-3); Id-spe-cm-4; Id-spe-cm-4-2; Обмеження доступу до зміни (CM-5); Налаштування конфігурації (CM-6); Id-spe-cm-7; Id-spe-cm-7-1; Id-spe-cm-7-5; Інвентаризація компонентів системи (CM-8); Id-spe-cm-8-1; Розташування інформації (CM-12).
...
\textbf{Перелік заходів захисту:} Резервне копіювання (CP-9); Id-spe-cp-9-8.
...
\textbf{Перелік заходів захисту:} Id-spe-ia-1; Id-spe-ia-2; Id-spe-ia-2-1; Id-spe-ia-2-2; Id-spe-ia-2-8; Id-spe-ia-3; Управління ідентифікацією (IA-4); Id-spe-ia-4-4; АВТЕНТИФІКАТОР УПРАВЛІННЯ; Id-spe-ia-5-1; Id-spe-ia-6; Повторна автентифікація (IA-11).
...
\textbf{Перелік заходів захисту:} Id-spe-ir-1; Навчання з реагування на інциденти (IR-2); Перевірка реагувань на інциденти (IR-3); Обробка інциденту (IR-4); Моніторинг інциденту (IR-5); Звітність про інциденти (IR-6); Підтримка реагування на інциденти (IR-7); План реагування на інциденти (IR-8).
...
\textbf{Перелік заходів захисту:} Id-spe-ma-1; Інструменти для обслуговування (MA-3); Id-spe-ma-3-1; Id-spe-ma-3-2; Id-spe-ma-3-3; Віддалене обслуговування (MA-4); Технічний персонал (MA-5).
...
\textbf{Перелік заходів захисту:} Id-spe-mp-1; Доступ до носіїв інформації (MP-2); Маркування носіїв інформації (MP-3); Зберігання носіїв інформації (MP-4); Транспортування носіїв інформації (MP-5); Id-spe-mp-6; Використання носіїв інформації (MP-7).
...
\textbf{Перелік заходів захисту:} Id-spe-pe-1; Ре-2 доступу (PE-2); ФІЗИЧНИЙ ДОСТУП ДО СИСТЕМИ; Ре-4 ліній електроживлення (PE-4); Id-spe-pe-5; МОНІТОРИНГ ФІЗИЧНОГО ДОСТУПУ; Альтернативне робоче місце (PE-17).
...
\textbf{Перелік заходів захисту:} Id-spe-pl-1; Id-spe-pl-2; Правила поведінки (PL-4).
...
\textbf{Перелік заходів захисту:} Id-spe-ps-1; Перевірка персоналу (PS-3); Звільнення персоналу (PS-4); Переведення персоналу (PS-5).
...
\textbf{Перелік заходів захисту:} Id-spe-ra-1; Оцінювання ризику (RA-3); Оцінювання постачання (RA-3(1)); Сканування вразливостей (RA-5); Id-spe-ra-5-2; Реагування на ризик (RA-7).
...
\textbf{Перелік заходів захисту:} Id-spe-sa-1; Id-spe-sa-8; Зовнішні послуги для системи (SA-9); Id-spe-sa-22.
...
\textbf{Перелік заходів захисту:} Id-spe-sc-1; Id-spe-sc-4; Доступність ресурсів (SC-7); Id-spe-sc-7-5; Id-spe-sc-8; Id-spe-sc-8-1; Відключення мережі (SC-10); Встановлення ключами (SC-12); Криптографічний захист (SC-13); Id-spe-sc-15; Мобільний код (SC-18); Автентифікація сесії (SC-23); Захист інформації в стані спокою (SC-28); Id-spe-sc-28-1.
...
\textbf{Перелік заходів захисту:} Id-spe-si-1; Виправлення дефектів (SI-2); Захист від шкідливого коду (SI-3); Моніторинг системи (SI-4); Id-spe-si-4-4; Id-spe-si-5; Id-spe-si-12.
...
\textbf{Перелік заходів захисту:} Id-spe-sr-1; Id-spe-sr-2; Id-spe-sr-3; Id-spe-sr-5; Оцінка постачальників (SR-6).
