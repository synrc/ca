...
\fancyfoot[L]{\small\color{footergray} Комплексна система захисту інформації. Галузевий профіль заходів із захисту інформації (3).}
...
\begin{titlepage}
  ...
  {\HUGE  \textbf{Галузевий профіль заходів із захисту інформації (3)} \par} \vspace{2.5cm}
  \vfill
...
\textbf{Перелік заходів захисту:} Багатофакторна автентифікація привілейованих облікових записів (IA-2(1)); Багатофакторна автентифікація непривілейованих (IA-2(2)).
...
\textbf{Перелік заходів захисту:} Конфіденційність та криптографічний захист (SC-8(1)).
