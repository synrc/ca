...
\textbf{Перелік заходів захисту:} Забезпечення доступу (AC-3); Id-spe-ac-4; Управління паралельною сесією (AC-10); Атрибути безпеки та приватності (AC-16); Id-spe-ac-16-5; Диспетчер доступу (AC-25).
