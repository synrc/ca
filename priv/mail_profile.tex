...
\fancyfoot[L]{\small\color{footergray} Комплексна система захисту інформації. Галузевий профіль безпеки для військової пошти (20).}
...
\begin{titlepage}
  ...
  {\HUGE  \textbf{Галузевий профіль безпеки для військової пошти (20)} \par} \vspace{2.5cm}
  \vfill
