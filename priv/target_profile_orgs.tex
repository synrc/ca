...
\fancyfoot[L]{\small\color{footergray} Комплексна система захисту інформації. Цільовий профіль безпеки органів та установи в системі правосуддя.}
...
\begin{titlepage}
  ...
  {\HUGE  \textbf{Цільовий профіль безпеки органів та установи в системі правосуддя} \par} \vspace{2.5cm}
  \vfill
