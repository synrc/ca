...
\fancyfoot[L]{\small\color{footergray} Комплексна система захисту інформації. Цільовий профіль безпеки вищих судів.}
...
\begin{titlepage}
  ...
  {\HUGE  \textbf{Цільовий профіль безпеки вищих судів} \par} \vspace{2.5cm}
  \vfill
...
\subsubsection{ЗДАТНІСТЬ ВІДМОВОСТІЙКОСТІ (CP-10(5))}
