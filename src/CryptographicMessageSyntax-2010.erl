...
%% Purpose: Encoding and decoding of the types in CryptographicMessageSyntax-2010.

-module('CryptographicMessageSyntax-2010').
-compile(nowarn_unused_vars).
-dialyzer(no_improper_lists).
-dialyzer(no_match).
-include_lib("ca/include/CryptographicMessageSyntax-2010.hrl").
...
getenc_UnprotectedEnvAttributes/1,
getenc_UnprotectedEncAttributes/1,
...
getdec_UnprotectedEnvAttributes/1,
getdec_UnprotectedEncAttributes/1,
...
ObjcontentType = 
   'CryptographicMessageSyntax-2010':'getenc_ContentSet'(                                   Cindex1),
...
DecObjcontentTypeTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_ContentSet'(Term1),
Term2 = 
...
%%-------------------------------------------------
%% attribute encapContentInfo(3)   External CryptographicMessageSyntax-2010:EncapsulatedContentInfo
%%-------------------------------------------------
   {EncBytes3,EncLen3} = 'enc_EncapsulatedContentInfo'(Cindex3, [<<48>>]),

%%-------------------------------------------------
%% attribute certificates(4)   External CryptographicMessageSyntax-2010:CertificateSet OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute crls(5)   External CryptographicMessageSyntax-2010:RevocationInfoChoices OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute signerInfos(6)   External CryptographicMessageSyntax-2010:SignerInfos
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute sid(2)   External CryptographicMessageSyntax-2010:SignerIdentifier
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_SignerIdentifier'(Cindex2, []),

%%-------------------------------------------------
%% attribute digestAlgorithm(3)   External CryptographicMessageSyntax-2010:DigestAlgorithmIdentifier
%%-------------------------------------------------
   {EncBytes3,EncLen3} = 'enc_DigestAlgorithmIdentifier'(Cindex3, [<<48>>]),

%%-------------------------------------------------
%% attribute signedAttrs(4)   External CryptographicMessageSyntax-2010:SignedAttributes OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signatureAlgorithm(5)   External CryptographicMessageSyntax-2010:SignatureAlgorithmIdentifier
%%-------------------------------------------------
...
enc_SignerInfo_unsignedAttrs_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_9'(                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_9'(Term1),
...
enc_SignedAttributes_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_7'(                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_7'(Term1),
...
%%-------------------------------------------------
%% attribute originatorInfo(2)   External CryptographicMessageSyntax-2010:OriginatorInfo OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute recipientInfos(3)   External CryptographicMessageSyntax-2010:RecipientInfos
%%-------------------------------------------------
   {EncBytes3,EncLen3} = 'enc_RecipientInfos'(Cindex3, [<<49>>]),

%%-------------------------------------------------
%% attribute encryptedContentInfo(4)   External CryptographicMessageSyntax-2010:EncryptedContentInfo
%%-------------------------------------------------
...
enc_EnvelopedData_unprotectedAttrs_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_24'(                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_24'(Term1),
...
%%-------------------------------------------------
%% attribute certs(1)   External CryptographicMessageSyntax-2010:CertificateSet OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute crls(2)   External CryptographicMessageSyntax-2010:RevocationInfoChoices OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contentEncryptionAlgorithm(2)   External CryptographicMessageSyntax-2010:ContentEncryptionAlgorithmIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute rid(2)   External CryptographicMessageSyntax-2010:RecipientIdentifier
%%-------------------------------------------------
...
enc_KeyTransRecipientInfo_keyEncryptionAlgorithm(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_11'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_11'(Term1),
Term2 = 
   case Tmpterm1 of
...
%%-------------------------------------------------
%% attribute originator(2)   External CryptographicMessageSyntax-2010:OriginatorIdentifierOrKey
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute recipientEncryptedKeys(5)   External CryptographicMessageSyntax-2010:RecipientEncryptedKeys
%%-------------------------------------------------
...
enc_KeyAgreeRecipientInfo_keyEncryptionAlgorithm(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_15'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_15'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
enc_OriginatorPublicKey_algorithm(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_13'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_13'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
%%-------------------------------------------------
%% attribute rid(1)   External CryptographicMessageSyntax-2010:KeyAgreeRecipientIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute other(3)   External CryptographicMessageSyntax-2010:OtherKeyAttribute OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute kekid(2)   External CryptographicMessageSyntax-2010:KEKIdentifier
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_KEKIdentifier'(Cindex2, [<<48>>]),

%%-------------------------------------------------
%% attribute keyEncryptionAlgorithm(3)   External CryptographicMessageSyntax-2010:KeyEncryptionAlgorithmIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute keyDerivationAlgorithm(2)   External CryptographicMessageSyntax-2010:KeyDerivationAlgorithmIdentifier OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
{_,Cindex1,Cindex2} = Val,
ObjoriType = 
   'CryptographicMessageSyntax-2010':'getenc_SupportedOtherRecipInfo'(                                   Cindex1),
...
DecObjoriTypeTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_SupportedOtherRecipInfo'(Term1),
Term2 = 
...
%%-------------------------------------------------
%% attribute digestAlgorithm(2)   External CryptographicMessageSyntax-2010:DigestAlgorithmIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute encryptedContentInfo(2)   External CryptographicMessageSyntax-2010:EncryptedContentInfo
%%-------------------------------------------------
...
enc_EncryptedData_unprotectedAttrs_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_26'(                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_26'(Term1),
...
%%-------------------------------------------------
%% attribute macAlgorithm(4)   External CryptographicMessageSyntax-2010:MessageAuthenticationCodeAlgorithm
%%-------------------------------------------------
   {EncBytes4,EncLen4} = 'enc_MessageAuthenticationCodeAlgorithm'(Cindex4, [<<48>>]),

%%-------------------------------------------------
%% attribute digestAlgorithm(5)   External CryptographicMessageSyntax-2010:DigestAlgorithmIdentifier OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case Cindex5 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute encapContentInfo(6)   External CryptographicMessageSyntax-2010:EncapsulatedContentInfo
%%-------------------------------------------------
   {EncBytes6,EncLen6} = 'enc_EncapsulatedContentInfo'(Cindex6, [<<48>>]),

%%-------------------------------------------------
%% attribute authAttrs(7)   External CryptographicMessageSyntax-2010:AuthAttributes OPTIONAL
%%-------------------------------------------------
   {EncBytes7,EncLen7} =  case Cindex7 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute unauthAttrs(9)   External CryptographicMessageSyntax-2010:UnauthAttributes OPTIONAL
%%-------------------------------------------------
...
enc_AuthAttributes_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_29'(                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_29'(Term1),
...
enc_UnauthAttributes_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_3'(                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_3'(Term1),
...
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_2'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_2'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_5'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_5'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_17'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_17'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_22'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_22'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_28'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_28'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'CryptographicMessageSyntax-2010':'getenc_internal_object_set_argument_19'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_internal_object_set_argument_19'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
ObjotherRevInfoFormat = 
   'CryptographicMessageSyntax-2010':'getenc_SupportedOtherRevokInfo'(                                   Cindex1),
...
DecObjotherRevInfoFormatTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_SupportedOtherRevokInfo'(Term1),
Term2 = 
...
{_,Cindex1,Cindex2} = Val,
ObjotherCertFormat = 
   'CryptographicMessageSyntax-2010':'getenc_SupportedCertFormats'(                                   Cindex1),
...
DecObjotherCertFormatTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_SupportedCertFormats'(Term1),
Term2 = 
...
{_,Cindex1,Cindex2} = Val,
ObjkeyAttrId = 
   'CryptographicMessageSyntax-2010':'getenc_SupportedKeyAttributes'(                                   Cindex1),
...
DecObjkeyAttrIdTerm1 =
   'CryptographicMessageSyntax-2010':'getdec_SupportedKeyAttributes'(Term1),
Term2 = 
...
%%-------------------------------------------------
%% attribute extendedCertificateInfo(1)   External CryptographicMessageSyntax-2010:ExtendedCertificateInfo
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_ExtendedCertificateInfo'(Cindex1, [<<48>>]),

%%-------------------------------------------------
%% attribute signatureAlgorithm(2)   External CryptographicMessageSyntax-2010:SignatureAlgorithmIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute attributes(3)   External CryptographicMessageSyntax-2010:UnauthAttributes
%%-------------------------------------------------
...
%%================================
getenc_UnprotectedEnvAttributes(_) ->
  fun(_, Val, _RestPrimFieldName) ->
    case Val of
      {asn1_OPENTYPE,Bin} when is_binary(Bin) ->
        {Bin,byte_size(Bin)}
...
getdec_UnprotectedEnvAttributes(_) ->
  fun(_,Bytes, _RestPrimFieldName) ->
    case Bytes of
      Bin when is_binary(Bin) -> 
        {asn1_OPENTYPE,Bin};
...
%%================================
getenc_UnprotectedEncAttributes(_) ->
  fun(_, Val, _RestPrimFieldName) ->
    case Val of
      {asn1_OPENTYPE,Bin} when is_binary(Bin) ->
        {Bin,byte_size(Bin)}
...
getdec_UnprotectedEncAttributes(_) ->
  fun(_,Bytes, _RestPrimFieldName) ->
    case Bytes of
      Bin when is_binary(Bin) -> 
        {asn1_OPENTYPE,Bin};
...
%%================================
getenc_internal_object_set_argument_9(Id) when Id =:= {1,2,840,113549,1,9,6} ->
    fun 'enc_aa-countersignature'/3;
...
getdec_internal_object_set_argument_9(Id) when Id =:= {1,2,840,113549,1,9,6} ->
    fun 'dec_aa-countersignature'/3;
...
getenc_internal_object_set_argument_7(Id) when Id =:= {1,2,840,113549,1,9,4} ->
    fun 'enc_aa-messageDigest'/3;
getenc_internal_object_set_argument_7(Id) when Id =:= {1,2,840,113549,1,9,5} ->
    fun 'enc_aa-signingTime'/3;
...
getdec_internal_object_set_argument_7(Id) when Id =:= {1,2,840,113549,1,9,4} ->
    fun 'dec_aa-messageDigest'/3;
getdec_internal_object_set_argument_7(Id) when Id =:= {1,2,840,113549,1,9,5} ->
    fun 'dec_aa-signingTime'/3;
...
%%================================
getenc_internal_object_set_argument_6(Id) when Id =:= {1,2,840,113549,1,9,3} ->
    fun 'enc_aa-contentType'/3;
getenc_internal_object_set_argument_6(Id) when Id =:= {1,2,840,113549,1,9,4} ->
    fun 'enc_aa-messageDigest'/3;
getenc_internal_object_set_argument_6(Id) when Id =:= {1,2,840,113549,1,9,5} ->
    fun 'enc_aa-signingTime'/3;
...
getdec_internal_object_set_argument_6(Id) when Id =:= {1,2,840,113549,1,9,3} ->
    fun 'dec_aa-contentType'/3;
getdec_internal_object_set_argument_6(Id) when Id =:= {1,2,840,113549,1,9,4} ->
    fun 'dec_aa-messageDigest'/3;
getdec_internal_object_set_argument_6(Id) when Id =:= {1,2,840,113549,1,9,5} ->
    fun 'dec_aa-signingTime'/3;
...
%%================================
getenc_internal_object_set_argument_19(Id) when Id =:= {1,2,840,113549,1,5,12} ->
...
getdec_internal_object_set_argument_19(Id) when Id =:= {1,2,840,113549,1,5,12} ->
...
%%================================
getenc_internal_object_set_argument_17(Id) when Id =:= {1,2,840,113549,1,9,16,3,6} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_kwa-3DESWrap'(T,V,O) end;
getenc_internal_object_set_argument_17(Id) when Id =:= {1,2,840,113549,1,9,16,3,7} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_kwa-RC2Wrap'(T,V,O) end;
...
getdec_internal_object_set_argument_17(Id) when Id =:= {1,2,840,113549,1,9,16,3,6} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_kwa-3DESWrap'(T,V,O) end;
getdec_internal_object_set_argument_17(Id) when Id =:= {1,2,840,113549,1,9,16,3,7} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_kwa-RC2Wrap'(T,V,O) end;
...
%%================================
getenc_internal_object_set_argument_15(Id) when Id =:= {1,2,840,113549,1,9,16,3,5} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_kaa-esdh'(T,V,O) end;
getenc_internal_object_set_argument_15(Id) when Id =:= {1,2,840,113549,1,9,16,3,10} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_kaa-ssdh'(T,V,O) end;
...
getdec_internal_object_set_argument_15(Id) when Id =:= {1,2,840,113549,1,9,16,3,5} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_kaa-esdh'(T,V,O) end;
getdec_internal_object_set_argument_15(Id) when Id =:= {1,2,840,113549,1,9,16,3,10} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_kaa-ssdh'(T,V,O) end;
...
%%================================
getenc_internal_object_set_argument_13(Id) when Id =:= {1,2,840,10046,2,1} ->
   fun(T,V,O) -> 'PKIXAlgs-2009':'enc_pk-dh'(T,V,O) end;
...
getdec_internal_object_set_argument_13(Id) when Id =:= {1,2,840,10046,2,1} ->
   fun(T,V,O) -> 'PKIXAlgs-2009':'dec_pk-dh'(T,V,O) end;
...
%%================================
getenc_internal_object_set_argument_11(Id) when Id =:= {1,2,840,113549,1,1,1} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_kt-rsa'(T,V,O) end;
...
getdec_internal_object_set_argument_11(Id) when Id =:= {1,2,840,113549,1,1,1} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_kt-rsa'(T,V,O) end;
...
%%================================
getenc_internal_object_set_argument_28(Id) when Id =:= {1,3,6,1,5,5,8,1,2} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_maca-hMAC-SHA1'(T,V,O) end;
...
getdec_internal_object_set_argument_28(Id) when Id =:= {1,3,6,1,5,5,8,1,2} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_maca-hMAC-SHA1'(T,V,O) end;
...
%%================================
getenc_internal_object_set_argument_22(Id) when Id =:= {1,2,840,113549,3,2} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_cea-RC2-cbc'(T,V,O) end;
getenc_internal_object_set_argument_22(Id) when Id =:= {1,2,840,113549,3,7} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'enc_cea-3DES-cbc'(T,V,O) end;
...
getdec_internal_object_set_argument_22(Id) when Id =:= {1,2,840,113549,3,2} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_cea-RC2-cbc'(T,V,O) end;
getdec_internal_object_set_argument_22(Id) when Id =:= {1,2,840,113549,3,7} ->
   fun(T,V,O) -> 'CryptographicMessageSyntaxAlgorithms-2009':'dec_cea-3DES-cbc'(T,V,O) end;
