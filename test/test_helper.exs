...
defmodule CA.Test do
  use ExUnit.Case, async: true
    ...
    test "testKDF" do
        ...
        {:'ECC-CMS-SharedInfo', {:'KeyWrapAlgorithm',{2,16,840,1,101,3,4,1,45},:asn1_NOVALUE},ukm,<<256::32>>})
        ...
        assert "< Put input data here >\t\t\t\t\t\t\t\t\t" == CA.AES.decrypt(:aes_256_cbc, data, unwrap, iv)
    end
